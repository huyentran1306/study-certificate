...
const CERTS_CONFIG = [
  {
    ...
    description: 'Chinh phục chứng chỉ Microsoft Certified: Power BI Data Analyst Associate (PL-300). Bao quát chuẩn bị dữ liệu (Power Query), mô hình hóa dữ liệu (DAX, Star Schema), trực quan hóa dữ liệu và báo cáo nâng cao, triển khai và bảo mật tài sản trong Power BI Service.',
  ...
  },
  {
    ...
    description: 'Chinh phục chứng chỉ Microsoft Certified: Fabric Analytics Engineer Associate (DP-600). Lập kế hoạch, triển khai và quản lý giải pháp phân tích dữ liệu toàn diện với Microsoft Fabric, Lakehouse, Data Warehouse, Direct Lake và tối ưu hóa ngữ nghĩa dữ liệu.',
    difficulty: 'Nâng cao',
  ...
  },
  {
    ...
    description: 'Chinh phục chứng chỉ Microsoft Certified: Cybersecurity Architect Expert (SC-100). Thiết kế kiến trúc Zero Trust, chiến lược bảo mật danh tính, dữ liệu, ứng dụng, cơ sở hạ tầng đám mây và hoạt động phản ứng sự cố bảo mật (SecOps).',
    difficulty: 'Nâng cao',
  ...
  },
  {
    ...
    description: 'Chinh phục chứng chỉ Microsoft Certified: Security Operations Analyst Associate (SC-200). Phát hiện, điều tra và ứng phó sự cố bảo mật bằng Microsoft Defender XDR, Microsoft Sentinel, KQL (Kusto Query Language) và Microsoft Purview.',
    difficulty: 'Trung cấp',
  ...
  },
  {
    ...
    description: 'Chinh phục chứng chỉ Microsoft Azure AI Fundamentals (AI-900). Nắm vững khối lượng công việc AI cốt lõi, nguyên tắc Trí tuệ Nhân tạo Có trách nhiệm (Responsible AI), Machine Learning, Computer Vision, Natural Language Processing và Generative AI trên Azure.',
    difficulty: 'Cơ bản',
    estimatedHours: '8-12 Giờ',
    colorClass: 'bg-gradient-to-br from-teal-500 to-cyan-600 text-white',
    iconName: 'Award',
    totalQuestions: 128,
    isDisabled: false, // Active on homepage
    badge: 'verified'
  }
];
...
async function processSingleCert(certConfig) {
  ...
  const rawQuestions = await crawlExam(crawlTargetSlug, certConfig.totalQuestions, 4);
...
async function main() {
  ...
  const combinedSql = [
    ...
    `-- Includes: PL-300, DP-600, SC-100, SC-200, AI-900 (Upgraded)`,
  ...
  console.log('\n======================================================');
  console.log('ALL PHASE 3 CERTS PROCESSED SUCCESSFULLY!');
