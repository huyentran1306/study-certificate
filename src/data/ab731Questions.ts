...
export const ab731Questions: Question[] = [
  {
    ...
    options: [
      {
        key: "A",
        text: "custom Azure Machine Learning model"
      },
      {
        key: "B",
        text: "the Researcher agent in Microsoft 365 Copilot"
      },
      {
        key: "C",
        text: "an interactive AI agent"
      },
      {
        key: "D",
        text: "a fine-tuned large language model (LLM)"
      }
    ],
    correctAnswers: [
      "C"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "creating product descriptions based on product specifications"
      },
      {
        key: "B",
        text: "designing a new product based on customer requirements"
      },
      {
        key: "C",
        text: "translating product descriptions into a different language"
      },
      {
        key: "D",
        text: "analyzing product sales to identify patterns and trends"
      }
    ],
    correctAnswers: [
      "A"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Allow each department to tailor governance processes for its own AI initiatives."
      },
      {
        key: "B",
        text: "Define accountability norms for AI decisions across business and technical teams."
      },
      {
        key: "C",
        text: "Create a process to review AI initiatives for responsible AI alignment."
      },
      {
        key: "D",
        "text": "Assign governance ownership primarily to the AI engineering and data science teams."
      },
      {
        key: "E",
        text: "Focus governance efforts on AI systems that handle regulated or sensitive data."
      }
    ],
    correctAnswers: [
      "B",
  ...
  },
  {
    ...
    questionNumber: 4,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Using incomplete or poor-quality data during generative AI model training can increase costs.\n2. AI models rely on training data to learn patterns and identify relationships to produce outputs.\n3. Generative AI models trained on non-representative datasets can produce inaccurate or unbalanced results.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "an information barrier (IB) policy"
      },
      {
        key: "B",
  ...
  },
  {
    ...
    options: [
      ...
      {
        key: "B",
        text: "Provisioned (PTUs)"
      },
      {
        key: "C",
        text: "Standard (On-Demand)"
      }
    ],
    correctAnswers: [
      "B"
  ...
  },
  {
    ...
    questionNumber: 9,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Microsoft Copilot in Outlook can automatically send follow-up replies to emails.\n2. Microsoft Copilot in Outlook can identify and surface tasks mentioned in your emails.\n3. Microsoft Copilot in Outlook can summarize long email threads and highlight action items and deadlines.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    questionNumber: 12,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Retrieval Augmented Generation (RAG) architectures require that a large language model (LLM) be retrained on proprietary data.\n2. Retrieval-Augmented Generation (RAG) grounds a language model to produce more factual and context-relevant responses.\n3. Retrieval Augmented Generation (RAG) retrieves information from external knowledge sources at runtime instead of relying solely on the knowledge of a generative AI model.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "a Microsoft 365 Copilot per-user add-on license"
      },
      {
        key: "B",
        text: "pay-as-you-go"
      ...
      {
        key: "C",
        text: "a Microsoft 365 subscription entitlement"
      },
      {
        key: "D",
        text: "ausage-based consumption license in Azure"
      }
    ],
    correctAnswers: [
      "A"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "creates visual dashboards from structured data in Microsoft Excel and Power BI."
      },
      {
        key: "B",
        text: "generates a pivot table and performs time series forecasting."
      },
      {
        key: "C",
        text: "performs complex, multi-step, data analysis and code execution tasks over arbitrary datasets."
      },
      {
        key: "D",
        text: "uses reasoning capabilities to generate deep insights based on organizational data and the web."
      }
    ],
    correctAnswers: [
      "D"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Generative AI is designed to generate responses based on a user’s natural language prompts."
      },
      {
        key: "B",
        text: "Generative AI is designed to translate documents into other languages."
      },
      {
        key: "C",
        text: "Generative AI is designed to predict future trends based on historical data."
      },
      {
        key: "D",
        text: "Generative AI is designed to recommend products based on user behavior."
      }
    ],
    correctAnswers: [
      "A"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "storage capacity required for AI data."
      },
      {
        key: "B",
        text: "training time required for generative AI models."
      },
      {
        key: "C",
        text: "accuracy and relevance of AI-generated responses."
      }
    ],
    correctAnswers: [
      "C"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "references a diverse set of people, disciplines, and perspectives"
      },
      {
        key: "B",
        text: "explains how and why AI models generate content"
      },
      {
        key: "C",
        text: "anchors the responses in specific data sources"
      },
      {
        key: "D",
        text: "specifies the strengths and weaknesses of the AI model"
      }
    ],
    correctAnswers: [
      "C"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Create an agent by using Microsoft Foundry."
      },
      {
        key: "B",
        text: "Deploy a Copilot connector."
      },
      {
        key: "C",
        text: "Build a custom agent by using the full experience of Microsoft Copilot Studio."
      },
      {
        key: "D",
        text: "Build a declarative agent by using the lite experience of Microsoft Copilot Studio."
      }
    ],
    correctAnswers: [
      "D"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "compiles background research for a new market or initiative."
      },
      {
        key: "B",
        text: "enables you to generate audio summaries of select references."
      },
      {
        key: "C",
        text: "uses a conversational agent to answer employee FAQs."
      },
      {
        key: "D",
        text: "uses structured data and provides insights by using text, charts, tables, and other visuals."
      }
    ],
    correctAnswers: [
      "D"
  ...
  },
  {
    ...
    questionNumber: 20,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. A manufacturer can use Azure Vision in Foundry Tools to identify product defects on an assembly line.\n2. A logistics company can use Azure Vision in Foundry Tools to recognize package shipping labels.\n3. The HR department at your company can only use Azure Vision in Foundry Tools to extract written content from Microsoft Word files.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    questionNumber: 22,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Microsoft 365 Copilot can help users compose professional emails and summarize conversations.\n2. When prompted, Microsoft 365 Copilot can autonomously update a spreadsheet that contains sales data.\n3. Microsoft 365 Copilot can summarize recent updates in business documents, spreadsheets, and presentations.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    questionNumber: 24,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Generative AI can be used in the automation of complex workflows.\n2. Generative AI can be used to generate new content, such as text, images, and music.\n3. Generative AI is best suited to perform mathematical calculations and solve equations.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "ensure that AI models deliver consistent and equitable results."
      },
      {
        key: "B",
        text: "help organizations increase trust in fully autonomous AI systems."
      },
      {
        key: "C",
        text: "promote the ethical and accountable use of AI."
      },
      {
        key: "D",
        text: "standardize model development practices across AI teams."
      }
    ],
    correctAnswers: [
      "C"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "a Microsoft 365 Copilot add-on license"
      },
      {
        key: "B",
        text: "Microsoft Copilot Studio user license"
      },
      {
        key: "C",
        text: "a Copilot Chat pay-as-you-go plan"
      }
    ],
    correctAnswers: [
      "A"
  ...
  },
  {
    ...
    questionNumber: 27,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Microsoft Foundry helps organizations securely build and manage generative AI solutions in a governed environment.\n2. Microsoft Foundry provides built-in scalability to enable organizations to expand AI workloads as usage increases.\n3. Microsoft Foundry can be used for image recognition and computer vision tasks.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "integrating AI-powered tools into business workflows."
      },
      {
        key: "B",
        text: "identifying and fixing errors in AI-generated content."
      },
      {
        key: "C",
        text: "designing, developing, and training generative AI models to produce contextually relevant content."
      },
      {
        key: "D",
        text: "crafting clear instructions to guide generative AI solutions in generating context-appropriate content."
      }
    ],
    correctAnswers: [
      "D"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Provides a scalable platform for developing and deploying generative AI solutions."
      },
      {
        key: "B",
        text: "Removes the need to select or configure the underlying AI model."
      },
      {
        key: "C",
        text: "Enables business users to build generative AI solutions."
      },
      {
        key: "D",
        text: "Offers a low-code platform for developing generative AI solutions."
      }
    ],
    correctAnswers: [
      "A"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "to analyze trends and classify data sources."
      },
      {
        key: "B",
        text: "to create new content, such as text, images, or code."
      },
      {
        key: "C",
        text: "to make predictions based on historical data."
      }
    ],
    correctAnswers: [
      "B"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "predicting customer retention"
      },
      {
        key: "B",
        text: "creating product descriptions from images"
      },
      {
        key: "C",
        text: "generating marketing campaigns"
      },
      {
        key: "D",
        text: "summarizing customer service transcripts"
      }
    ],
    correctAnswers: [
      "A"
  ...
  },
  {
    ...
    questionNumber: 32,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Lack of trust in the security and accuracy of AI solutions is a common barrier to AI adoption.\n2. AI adoption efforts often fail when organizations overlook the importance of high-quality data.\n3. AI adoption is most successful when implemented with business and compliance stakeholders.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Delete all the feedback data immediately after analysis."
      },
      {
        key: "B",
        text: "Ensure that feedback is attributable to the customer so that it can be deleted upon request."
      },
      {
        key: "C",
        text: "Limit privacy reviews to the final stage of the AI project lifecycle."
      },
      {
        key: "D",
        text: "Anonymize the source data to remove customer Personally Identifiable Information (PII) from the feedback."
      }
    ],
    correctAnswers: [
      "D"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "The model requires additional compute resources."
      },
      {
        key: "B",
        text: "The input data changed over time."
      },
      {
        key: "C",
        text: "The model was trained incorrectly."
      }
    ],
    correctAnswers: [
      "B"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Provide the prompts with extensive examples of the expected output."
      },
      {
        key: "B",
        text: "Add the context, sources, and expectations to the prompts."
      },
      {
        key: "C",
        text: "Use technical terms in the prompts to enhance AI comprehension."
      },
      {
        key: "D",
        text: "Add only a single concise requirement to the prompts."
      }
    ],
    correctAnswers: [
      "B"
  ...
  },
  {
    ...
    questionNumber: 38,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Microsoft Copilot provides a single AI app that has identical features and experiences across all Microsoft products.\n2. Microsoft 365 Copilot delivers AI capabilities for business users that use Microsoft 365 apps.\n3. Microsoft Security Copilot helps companies understand risks and the organizational security posture.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Allow each department to deploy its own AI tools and workflows."
      },
      {
        key: "B",
        text: "Delegate AI decision-making to the company’s IT department."
      },
      {
        key: "C",
        text: "Outsource AI development to an external vendor."
      },
      {
        key: "D",
        text: "Establish an AI council to provide guidance, oversight, and coordination."
      }
    ],
    correctAnswers: [
      "D"
  ...
  },
  {
    ...
    questionNumber: 43,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Azure Vision in Foundry Tools can extract and analyze key phrases from PDF files.\n2. Azure Vision in Foundry Tools can generate images based on natural language descriptions.\n3. Azure Document Intelligence in Foundry Tools can be used to automate the processing of invoices and credit notes.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    questionNumber: 45,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Microsoft 365 Copilot enables users to search across emails, files, chats, meetings, and connected apps, by using natural language queries.\n2. Microsoft 365 Copilot provides data protection, and helps ensure that user prompts and chat data are secure.\n3. Microsoft 365 Copilot is included in all Microsoft 365 subscriptions.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      ...
      {
        key: "D",
        text: "Microsoft Copilot in Azure"
      }
    ],
    correctAnswers: [
      "B"
  ...
  },
  {
    ...
    questionNumber: 47,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Larger datasets can increase the cost of a generative AI solution that uses an Azure Machine Learning workspace.\n2. The cost of consuming Azure OpenAI models is primarily identified by the number of input and output tokens processed.\n3. The cost of custom generative AI solutions always remains the same regardless of the model version or capability used.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Apply a newer version of the generative AI model."
      },
      {
        key: "B",
        text: "Apply a content-moderation filter."
      },
      {
        key: "C",
        text: "Create a new version of the solution that is trained on only inclusive and representative content."
      },
      {
        key: "D",
        text: "Create a new version of the solution that is trained on only exclusionary content."
      }
    ],
    correctAnswers: [
      "B"
  ...
  },
  {
    ...
    questionNumber: 50,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. A generative AI model guarantees factually accurate responses if the model is trained on a large dataset.\n2. Content filtering and responsible AI safeguards help a generative AI model generate safe and inoffensive content.\n3. A generative AI model always produces fair and unbiased results when the training data has been properly prepared and reviewed for fairness.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Include primarily IT and project management staff initially to streamline deployment, adding governance and compliance roles later."
      },
      {
        key: "B",
        text: "Include procurement and vendor management specialists early to evaluate AI tools, involving business teams once a platform is selected."
      },
      {
        key: "C",
        text: "Include representatives from legal, leadership, and business units to align AI initiatives with organizational priorities."
      },
      {
        key: "D",
        text: "Include only data scientists and engineers at first to validate technical feasibility, then add other stakeholders later."
      }
    ],
    correctAnswers: [
      "C"
  ...
  },
  {
    ...
    questionNumber: 52,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. You can use Azure Language in Foundry Tools to analyze the sentiment of customer reviews.\n2. You can use Azure Language in Foundry Tools to translate internal reports into multiple languages.\n3. You can use Azure Language in Foundry Tools to extract text from scanned documents.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "emails, files, meetings, and chats in Microsoft 365"
      },
      {
        key: "B",
        text: "data stored in a file share"
      },
      {
        key: "C",
      ...
      {
        key: "D",
        text: "content from public websites"
      }
    ],
    correctAnswers: [
      "A"
  ...
  },
  {
    ...
    questionNumber: 55,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. A barrier to AI adoption can include data limitations and a lack of AI readiness and skills.\n2. Organizations often struggle with AI adoption because they prioritize technology selection before defining clear business use cases.\n3. A lack of cross-functional collaboration is a common barrier to AI adoption.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "reduces the need for executive oversight in AI decision-making"
      },
      {
        key: "B",
        text: "enhances stakeholder trust and fosters sustainable AI adoption throughout the organization"
      },
      {
        key: "C",
        text: "guarantees that AI models provide accurate and relevant responses"
      },
      {
        key: "D",
        text: "reduces the need for data protection policies and governance"
      }
    ],
    correctAnswers: [
      "B"
  ...
  },
  {
    ...
    questionNumber: 57,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. To use Microsoft 365 Copilot Chat, you must have a Microsoft 365 Copilot license.\n2. Microsoft 365 Copilot Chat provides context-aware assistance in Microsoft 365 apps.\n3. Microsoft 365 Copilot Chat can only access information in open files and read emails.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "A pretrained model requires labeled data, while a fine-tuned model does not."
      },
      {
        key: "B",
        text: "A pretrained model is faster to train than a fine-tuned model because the pretrained model uses fewer parameters."
      },
      {
        key: "C",
        text: "A pretrained model is trained on broad datasets, while a fine-tuned model is adapted to perform well on a narrower, domain-specific dataset."
      },
      {
        key: "D",
        text: "A pretrained model is optimized for a specific task, while a fine-tuned model is designed for general-purpose use."
      }
    ],
    correctAnswers: [
      "C"
  ...
  },
  {
    ...
    questionNumber: 59,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Microsoft Foundry provides a unified platform for developers and data professionals to create custom end-to-end AI solutions.\n2. Microsoft Foundry provides a unified platform for low-code developers and business users to create custom end-to-end AI solutions.\n3. You need a Microsoft 365 Copilot license to access Microsoft Foundry services.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Retain all customer conversations."
      },
      {
        key: "B",
        text: "Test the agent to ensure that responses are inclusive and culturally sensitive."
      },
      {
        key: "C",
        text: "Enable the agent to operate independently."
      },
      {
        key: "D",
        text: "Ensure that the agent can be used for multiple purposes."
      },
      {
        key: "E",
        text: "Provide a clear disclaimer that users are interacting with an AI solution."
      }
    ],
    correctAnswers: [
      "B",
  ...
  },
  {
    ...
    questionNumber: 62,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. A generative AI solution is well-suited to predict next-quarter sales trends.\n2. A generative AI solution can summarize lengthy policy documents.\n3. A generative AI solution can create product descriptions from product specifications.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "technical teams responsible for designing advanced analytics solutions to track adoption."
      },
      {
        key: "B",
        text: "users who advocate for the value of AI by learning, sharing, and identifying use cases."
      },
      {
        key: "C",
        text: "users who are dedicated to building the infrastructure required to support AI across the organization."
      },
      {
        key: "D",
        text: "users who come together and define the organization's overall AI strategy."
      }
    ],
    correctAnswers: [
      "B"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "launch an internal campaign to promote AI awareness."
      },
      {
        key: "B",
        text: "offer a self-paced online training course for employees."
      },
      {
        key: "C",
        text: "define performance metrics for AI tool usage."
      },
      {
        key: "D",
        text: "establish a champions program for your company."
      }
    ],
    correctAnswers: [
      "D"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "to monitor user behavior and enforce compliance with internal IT policies"
      },
      {
        key: "B",
        text: "to train employees on how to use Copilot features effectively"
      },
      {
        key: "C",
        text: "to oversee implementation, manage technical performance, and ensure successful AI deployment"
      },
      {
        key: "D",
        text: "to guide strategy, provide oversight, and ensure cross-functional alignment for responsible AI adoption"
      }
    ],
    correctAnswers: [
      "D"
  ...
  },
  {
    ...
    questionNumber: 69,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Users that want to reason over work data by using a natural language prompt in Microsoft 365 Copilot must have a Copilot add-on license.\n2. Microsoft 365 Copilot is included in Microsoft 365 E3 and Microsoft 365 ES licenses.\n3. Some Microsoft 365 Copilot services are available through a pay-as-you-go plan.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Build with Azure Machine Learning"
      },
      {
        key: "B",
        text: "Build with Microsoft Copilot Studio"
      },
      {
        key: "C",
        text: "Extend with Microsoft 365 Copilot connectors"
      },
      {
        key: "D",
        text: "Use Microsoft 365 Copilot"
      }
    ],
    correctAnswers: [
      "1=D",
  ...
  },
  {
    ...
    questionNumber: 72,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Prompt engineering involves specifying guidelines that help a generative AI model generate useful and accurate responses.\n2. The instruction is the part of the prompt that includes examples to show the AI what its response should look like.\n3. The context is the part of the prompt that helps a generative AI model understand which information to use when generating a response.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "configure and deploy AI models in the organization's Azure environment."
      },
      {
        key: "B",
        text: "guide AI strategy, ensure responsible AI oversight, and promote alignment across business units."
      },
      {
        key: "C",
        text: "manage day-to-day model training and labeling tasks for AI development teams."
      }
    ],
    correctAnswers: [
      "B"
  ...
  },
  {
    ...
    questionNumber: 74,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Allowing AI models to make autonomous decisions supports the Microsoft responsible AI principle of accountability.\n2. Regularly testing AI models for fairness and inclusiveness helps ensure they align with Microsoft's Responsible AI principles.\n3. Protecting user data and limiting access to personal information supports the Microsoft responsible AI principles of privacy and security.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    questionNumber: 76,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Prompt engineering changes how a generative AI model was trained.\n2. Prompt engineering focuses on designing clear, concise, and context-rich instructions.\n3. Effective prompt engineering involves maximizing the number of tokens used in each request.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Prepare the training data."
      },
      {
        key: "B",
  ...
  },
  {
    ...
    questionNumber: 78,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. A text-to-image generator can be used to translate content into other languages.\n2. A predictive analytics model can generate new marketing content for a company’s online ads.\n3. A generative AI chatbot can engage customers in personalized conversations and recommend products.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Automatically approves AI-generated content for company-wide publishing."
      },
      {
        key: "B",
        text: "Removes the need for a human to review AI-generated outputs."
      },
      {
        key: "C",
        text: "Provides grounded, verifiable responses based on organizational data."
      },
      {
        key: "D",
        text: "Enables users to select from an authorized catalog of AI models."
      }
    ],
    correctAnswers: [
      "C"
  ...
  },
  {
    ...
    questionNumber: 80,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. For a user to access organizational data from a mobile device, the user needs a Microsoft 365 Copilot license.\n2. To reason over your organizational data by using Microsoft Graph, you need a Microsoft 365 Copilot license.\n3. To use the Analyst agent, you need a Microsoft 365 Copilot license.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Copilot in Power Automate"
      },
      {
        key: "B",
        text: "GitHub Copilot"
  ...
  },
  {
    ...
    questionNumber: 82,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Microsoft 365 Copilot can amplify existing data governance challenges.\n2. Implementing Microsoft 365 Copilot reduces data management costs.\n3. Microsoft 365 Copilot can help IT teams manage data risks.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "monitor network traffic and alerts in real time."
      },
      {
        key: "B",
        text: "create a Microsoft Word document."
      },
      {
        key: "C",
        text: "create a list in Microsoft SharePoint."
      },
      {
        key: "D",
        text: "modify administrative permissions for Microsoft SharePoint files."
      }
    ],
    correctAnswers: [
      "B"
  ...
  },
  {
    ...
    options: [
      ...
      {
        key: "B",
        text: "measuring the number of user interactions per day"
      },
      {
        key: "C",
        text: "enabling users to interact by using natural language queries"
      },
      {
        key: "D",
        text: "ensuring that verified company data sources are used for response generation"
      }
    ],
    correctAnswers: [
      "D"
  ...
  },
  {
    ...
    questionNumber: 86,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Microsoft 365 Copilot helps users create and analyze content in Microsoft 365 apps.\n2. Microsoft Copilot Studio can only be used to customize Microsoft 365 Copilot.\n3. Microsoft Security Copilot uses AI to assign sensitivity labels to documents.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "generates responses to customer questions without referencing the existing data"
      },
      {
        key: "B",
        text: "queries and retrieves information from large collections of data by using natural language"
      },
      {
        key: "C",
        text: "automates document workflows based on the document content"
      },
      {
        key: "D",
        text: "improves model accuracy by fine-tuning organizational data"
      }
    ],
    correctAnswers: [
      "B"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "uses a smaller dataset."
      },
      {
        key: "B",
        text: "produces more accurate results."
      },
      {
        key: "C",
        text: "can produce new and original content."
      }
    ],
    correctAnswers: [
      "C"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "a multi-modal solution"
      },
      {
        key: "B",
        text: "an optical character recognition (OCR) solution"
      },
      {
        key: "C",
        text: "a text completion solution"
      },
      {
        key: "D",
        text: "a document summarization solution"
      }
    ],
    correctAnswers: [
      "A"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "analyzing and producing reports based on complex data"
      },
      {
        key: "B",
        text: "generating ideas and solving issues"
      },
      {
        key: "C",
        text: "drafting documents, emails, presentations, and marketing materials"
      },
      {
        key: "D",
        text: "accessing internal data in accordance with existing Microsoft 365 policies"
      }
    ],
    correctAnswers: [
      "D"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "drafting and summarizing files in Microsoft Word and PowerPoint"
      },
      {
        key: "B",
        text: "customizing agent behavior and responses"
      },
      {
        key: "C",
        text: "using agents to identify and respond to security incidents"
      },
      {
        key: "D",
        text: "building agents that connect to business data and automate user interactions"
      },
      {
        key: "E",
        text: "configuring document security"
      }
    ],
    correctAnswers: [
      "B",
  ...
  },
  {
    ...
    questionNumber: 93,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Microsoft 365 Copilot connectors enable you to index data from multiple sources to make the data available in Copilot.\n2. You can build a custom Microsoft 365 Copilot connector when the available connectors do NOT meet your data integration requirements.\n3. To use Microsoft 365 Copilot connectors, you need a Microsoft Copilot Studio license.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "ensures that all responses are factually accurate."
      },
      {
        key: "B",
        text: "increases performance of an AI model."
      },
      {
        key: "C",
        text: "improves the accuracy and reliability of the predictions and outputs of AI."
      },
      {
        key: "D",
        text: "increases the amount of storage required to host an AI model."
      }
    ],
    correctAnswers: [
      "C"
  ...
  },
  {
    ...
    options: [
      ...
      {
        key: "B",
        text: "an on-premises file share"
      },
      {
        key: "C",
        text: "Microsoft SharePoint"
      ...
      {
        key: "E",
        text: "acustom customer relationship management (CRM) system"
      }
    ],
    correctAnswers: [
      "A",
  ...
  },
  {
    ...
    questionNumber: 96,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Content filtering controls can prevent AI-generated responses from exposing confidential and sensitive information.\n2. AI-generated content can unintentionally reveal sensitive information if the generative AI model has access to unsecured data sources.\n3. To prevent data exposure, only the prompts used by users must be protected by using policies.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Design the AI solution to automatically approve or reject customer loan applications."
      },
      {
        key: "B",
        text: "Test the AI solution to identify and mitigate potential unfair or inconsistent outcomes in its outputs."
      },
      {
        key: "C",
        text: "Prioritize model performance when tuning the AI solution."
      },
      {
        key: "D",
        text: "Enable the AI solution to collect and store personal data."
      }
    ],
    correctAnswers: [
      "B"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Switch to an alternate model."
      },
      {
        key: "B",
        text: "Apply content moderation."
      },
      {
        key: "C",
        text: "Optimize the prompts."
      },
      {
        key: "D",
        text: "Decrease the number of hosting hours for the model."
      },
      {
        key: "E",
        text: "Fine-tune the existing model."
      }
    ],
    correctAnswers: [
      "A",
  ...
  },
  {
    ...
    questionNumber: 99,
    text: "For each statement, select Yes if it is true; otherwise, select No.\n1. Retrieval Augmented Generation (RAG) requires model fine-tuning.\n2. Retrieval Augmented Generation (RAG) is helpful when you need a generative AI solution that can access current, verifiable information.\n3. Retrieval Augmented Generation (RAG) enables you to get more relevant responses based on your organization’s documents without retraining the base model.",
    options: [
      {
        key: "A",
        text: "Yes"
  ...
  },
  {
    ...
    options: [
      {
        key: "A",
        text: "Using historical sales data to forecast demand across product categories."
      },
      {
        key: "B",
        text: "Digitizing a paper-based process to reduce errors."
      },
      {
        key: "C",
        text: "Entering customer feedback into a spreadsheet to understand sentiment."
      },
      {
        key: "D",
        text: "Sending personalized emails to customers based on the customer location."
      }
    ],
    correctAnswers: [
      "A"
