...
export const dp600Questions: Question[] = [
  {
    "id": "dp600-1",
    "questionNumber": 1,
    "text": "You have an Azure Data Lake Storage Gen2 account named storage1 that contains a Parquet file named sales.parquet.  \n  \nYou have a Fabric tenant containing a workspace named Workspace1.  \n  \nUsing a notebook in Workspace1, you need to load the file’s content into the default lakehouse. The solution must ensure the content automatically appears as a table named Sales in Lakehouse explorer.  \n  \nHow should you complete the code?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Các bảng được quản lý lakehouse của Fabric là các bảng Delta. Viết DataFrame ở định dạng Delta bằng `saveAsTable(\"sales\")` sẽ đăng ký nó dưới dạng bảng trong lakehouse mặc định, để nó xuất hiện trong Lakehouse explorer.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "C",
        "text": "TRUNCATE TABLE and INSERT"
      },
      {
        "key": "D",
    ...
    "explanation": "MERGE cho phép bạn chèn các hàng thứ nguyên mới và cập nhật/hết hạn các hàng đã thay đổi trong một câu lệnh dựa trên tập hợp duy nhất, đây chính xác là mẫu mà tải SCD Loại 2 cần và tránh việc quét bảng bổ sung cũng như chi phí ghi nhật ký khi chạy các câu lệnh CẬP NHẬT và CHÈN riêng biệt. BẢNG TRUNCATE VÀ CHÈN sẽ hủy các hàng lịch sử mà SCD Loại 2 được thiết kế để bảo tồn và TẠO BẢNG NHƯ CHỌN sẽ xây dựng lại toàn bộ bảng thay vì hợp nhất dần dần các thay đổi vào đó.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-3",
    "questionNumber": 3,
    "text": "You have a KQL database containing a table named Readings.  \n  \nYou need to query Readings and return the results shown in the following table.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784206734677-i0lqs4di.png)  \n  \nHow should you complete the query?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Sau khi sắp xếp, `prev()` trả về một giá trị từ hàng trước trong tập kết quả được tuần tự hóa. `extend` tạo các cột đọc trước và cột ngày giờ trước đó và `project` trả về các cột được chỉ định theo thứ tự được yêu cầu.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-4",
    "questionNumber": 4,
    "text": "HOTSPOT  \n  \nYou have a Fabric tenant containing a workspace named Enterprise. Enterprise contains a semantic model named Model1, which has a Power Query date parameter named Date1.  \n  \nYou build a deployment pipeline named Enterprise Data with two stages: Development and Test. You assign the Enterprise workspace to Development.  \n  \nYou need to perform these actions:  \n  \n- Create a workspace named Enterprise [Test] and assign it to the Test stage.  \n- Configure a rule that modifies Date1’s value when changes deploy to the Test stage.  \n  \nWhich two settings should you use?\n\n![Question Image](https://cdn.examcademy.com/images/questions/1785601675376-cdz3ctlm.png)",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Sử dụng **Chỉ định không gian làm việc** trong giai đoạn Thử nghiệm để tạo hoặc liên kết Doanh nghiệp [Thử nghiệm] với giai đoạn đó. Sử dụng **Quy tắc triển khai** trong giai đoạn Thử nghiệm để tạo quy tắc tham số cho Date1 và đặt giá trị có hiệu lực sau mỗi lần triển khai.\n\n**Tài liệu tham khảo:**\n[Assign a workspace to a Microsoft Fabric deployment pipeline](https://learn.microsoft.com/en-us/fabric/cicd/deployment-pipelines/assign-pipeline) · [Create deployment rules for Fabric's ALM](https://learn.microsoft.com/en-us/fabric/cicd/deployment-pipelines/create-rules)",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-5",
    "questionNumber": 5,
    "text": "You have a Fabric tenant that includes a semantic model named Model1. Model1 includes a fact table named FactSales. FactSales has a relationship with a dimension table named DimDate through a column named OrderDate.  \n  \nYou add a second relationship to FactSales between FactSales and DimDate, based on a column named ShippedDate.  \n  \nYou need to filter by using ShippedDate in a new report. The solution must **not** affect how existing reports function.  \n  \nWhich two actions should you take? Each correct answer presents part of the solution.  \n  \n**NOTE:** Each correct answer is worth one point.",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Enable the ShippedDate relationship."
      },
      {
        "key": "B",
        "text": "Use a RELATEDTABLE DAX function."
      },
      {
        "key": "C",
        "text": "Use a CROSSFILTER DAX function."
      },
      {
        "key": "D",
        "text": "Use a USERELATIONSHIP DAX function."
      },
      {
        "key": "E",
        "text": "Disable the ShippedDate relationship between the tables."
      }
    ],
    "correctAnswers": [
      "D",
    ...
    "explanation": "Giữ mối quan hệ Ngày đặt hàng ở trạng thái hoạt động để duy trì hoạt động của báo cáo hiện có và giữ mối quan hệ Ngày giao hàng ở trạng thái không hoạt động. Một biện pháp có thể sử dụng `USERELATIONSHIP` trong chức năng lấy bộ lọc, chẳng hạn như `CALCULATE` để chỉ kích hoạt mối quan hệ ShippedDate cho phép tính đó mà không thay đổi mối quan hệ hoạt động mặc định của mô hình.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-6",
    "questionNumber": 6,
    "text": "You have a Fabric tenant containing four workspaces named Development, Test, QA, and Production. All the workspaces use Premium Per User (PPU) license mode.  \n  \nYou plan to use a release pipeline to support the development lifecycle from Development to Production.  \n  \nWhich three actions should you perform, in sequence?",
    ...
    "options": [
      {
        "key": "A",
        "text": "Move each workspace to Pro license mode."
      },
      {
        "key": "B",
      ...
      {
        "key": "C",
        "text": "Create a deployment rule."
      },
      {
        "key": "D",
        "text": "Assign workspaces."
      },
      {
        "key": "E",
        "text": "Create the QA stage."
      }
    ],
    "choices": [
      {
  ...
  },
  {
    ...
    "explanation": "Chế độ xem Mô hình máy tính để bàn Power BI có thể tạo một sơ đồ riêng chỉ chứa một tập hợp con các bảng của mô hình ngữ nghĩa. Sơ đồ có thể bắt đầu bằng bảng Bán hàng và sử dụng **Thêm bảng liên quan** để bao gồm các bảng liên quan đến bảng đó.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "Delete any unused semantic models from Workspace1."
      },
      {
        "key": "B",
        "text": "Select Large semantic model storage format for Workspace1."
      },
      {
        "key": "C",
        "text": "Configure Model 1 to use the Direct Lake storage format."
      },
      {
        "key": "D",
        "text": "Delete any unused columns from Model1."
      }
    ],
    "correctAnswers": [
      "B"
    ],
    "explanation": "Việc chọn định dạng lưu trữ mô hình ngữ nghĩa lớn sẽ tối ưu hóa cụ thể các hoạt động ghi để triển khai điểm cuối XMLA. Định dạng này cho phép cải thiện hiệu suất và khả năng nén cao hơn cho các hoạt động ghi siêu dữ liệu. Việc xóa các mô hình hoặc cột có thể giải phóng tài nguyên nhưng không trực tiếp nâng cao hiệu suất ghi XMLA và bộ lưu trữ Direct Lake giải quyết hiệu suất truy vấn chứ không phải tối ưu hóa ghi.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-9",
    "questionNumber": 9,
    "text": "You have a Fabric tenant that contains the workspaces shown in the following table.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1783712966688-w8j1we3g.png)  \n  \nYou have a deployment pipeline named Pipeline1 that deploys items from Workspace_DEV to Workspace_TEST. In Pipeline1, all items that have matching names are paired.  \n  \nYou deploy the contents of Workspace_DEV to Workspace_TEST by using Pipeline1.  \n  \nWhat will the contents of Workspace_TEST be once the deployment is complete?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Lakehouse2 -Notebook2 -SemanticModel1 -"
      },
      {
        "key": "B",
        "text": "Lakehouse1 -Notebook1 -Pipeline1 -SemanticModel1 -"
      },
      {
        "key": "C",
        "text": "Lakehouse1 -Lakehouse2 -Notebook1 -Notebook2 -Pipeline1 -SemanticModel1 -"
      },
      {
        "key": "D",
        "text": "Lakehouse2 -Notebook2 -Pipeline1 -SemanticModel1"
      }
    ],
    "correctAnswers": [
      "C"
    ],
    "explanation": "Khi quy trình triển khai triển khai từ Workspace_DEV đến Workspace_TEST có tên mục trùng khớp, tất cả các mục nhà phát triển có tên trùng khớp trong không gian làm việc mục tiêu sẽ được thay thế hoặc ghép nối. Kết quả bao gồm tất cả các mục từ cả hai không gian làm việc phù hợp với tiêu chí ghép nối.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Các nhóm tính toán không thể được thiết kế nguyên bản trong giao diện người dùng của Máy tính để bàn Power BI dành cho Direct Lake, mô hình ngữ nghĩa lakehouse được hỗ trợ bởi XMLA; phương pháp được hỗ trợ là kết nối một công cụ bên ngoài như Trình soạn thảo dạng bảng (2 hoặc 3) qua điểm cuối XMLA và thêm nhóm tính toán vào đó. Điều này cũng đáp ứng yêu cầu giảm thiểu nỗ lực triển khai và bảo trì, vì Tabular Editor được xây dựng nhằm mục đích tạo và triển khai các đối tượng mô hình dạng bảng này.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "statements": [
      {
        "id": "1",
        "text": "Query1 will return multiple rows for a single customer if the customer has placed more than one online sales order.",
        "correctAnswer": "Yes"
      },
      {
        "id": "2",
        "text": "If a customer record in DimCustomer has a GeographyKey value that does NOT exist in DimGeography, the customer’s sales data will still appear in the Query1 results.",
        "correctAnswer": "No"
      },
      {
        "id": "3",
        "text": "Adding the clause GROUP BY g.EnglishCountryRegionName to Query1 will calculate the total sales amount by country.",
        "correctAnswer": "No"
      }
    ],
    "options": [
  ...
  },
  {
    "id": "dp600-17",
    "questionNumber": 17,
    "text": "You have a Fabric tenant that contains a workspace named Workspace1. Workspace1 is assigned to a Fabric capacity.  \n\nYou need to recommend a solution to provide users with the ability to create and publish custom Direct Lake semantic models by using external tools. The solution must follow the principle of least privilege.  \n\nWhich three actions in the Fabric Admin portal should you include in the recommendation? Each correct answer presents part of the solution.  \n\nNOTE: Each correct answer is worth one point.",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "From the Tenant settings, set Allow XMLA Endpoints and Analyze in Excel with on-premises datasets to Enabled."
      },
      {
        "key": "B",
        "text": "From the Tenant settings, set Allow Azure Active Directory guest users to access Microsoft Fabric to Enabled."
      },
      {
        "key": "C",
        "text": "From the Tenant settings, select Users can edit data model in the Power BI service."
      },
      {
        "key": "D",
        "text": "From the Capacity settings, set XMLA Endpoint to Read Write."
      },
      {
        "key": "E",
        "text": "From the Tenant settings, set Users can create Fabric items to Enabled."
      },
      {
        "key": "F",
        "text": "From the Tenant settings, enable Publish to Web."
      }
    ],
    "correctAnswers": [
      "A",
    ...
    "explanation": "Cần có ba cài đặt để tạo Direct Lake cho công cụ bên ngoài: Bật điểm cuối XMLA ở cấp độ đối tượng thuê (A) để cho phép các công cụ bên ngoài kết nối, đặt Điểm cuối XMLA thành Đọc ghi ở cấp độ dung lượng (D) để cho phép các mô hình xuất bản và kích hoạt Người dùng có thể tạo các mục Fabric ở cấp độ đối tượng thuê (E) để cấp quyền. Quyền truy cập của người dùng khách (B), chỉnh sửa mô hình dịch vụ (C) và Xuất bản lên Web (F) là không cần thiết cho yêu cầu này.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-18",
    "questionNumber": 18,
    "text": "You have the following KQL query.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784206607019-6vqhr3nd.png)  \n  \nFor each statement, select **Yes** if it is true. Otherwise, select **No**.",
    "questionType": "statement_matrix",
    "statements": [
      {
        "id": "1",
        "text": "The query excludes sales that have a Status of Cancelled.",
        "correctAnswer": "Yes"
      },
      {
        "id": "2",
        "text": "The query calculates the total sales of each product category for the last 30 days.",
        "correctAnswer": "Yes"
      },
      {
        "id": "3",
        "text": "The query includes product categories that have had zero sales during the last 30 days.",
        "correctAnswer": "No"
      }
    ],
    "options": [
    ...
    "explanation": "Toán tử `where` đầu tiên loại trừ các bản ghi có `Status == \"Cancelled\"`. Bộ lọc ngày giới hạn các bản ghi đầu vào trong 30 ngày trước đó và `summarize sum(SalesAmount) by ProductCategory` tính toán tổng danh mục. `where TotalSales > 0` cuối cùng sẽ loại bỏ các danh mục có tổng số được tính bằng 0.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-20",
    "questionNumber": 20,
    "text": "You have a semantic model named Model1 that contains data that relates to customers and their bank account balances.  \n  \nModel1 has the following tables and columns.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1783713076063-5lup1f2o.png)  \n  \nA customer can have one or more accounts. Each account can be associated to multiple customers.  \n  \nYou need to ensure that users can query Model1 to identify the total transaction amounts by customer.  \n  \nWhat should you add to Model1?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "a many-to-many relationship between FactTransaction and Dim Customer"
      },
      {
        "key": "B",
        "text": "a bridge table with relationships to DimCustomer and DimAccount"
      },
      {
        "key": "C",
        "text": "a bridge table with relationships to FactTransaction and DimCustomer"
      },
      {
        "key": "D",
        "text": "the CustomerKey column in FactTransaction and a relationship to DimCustomer"
      }
    ],
    "correctAnswers": [
      "B"
    ],
    "explanation": "Mối quan hệ nhiều-nhiều giữa khách hàng và tài khoản yêu cầu bảng cầu nối kết nối cả hai bảng thứ nguyên (DimCustomer và DimAccount). Điều này cho phép các hàng FactTransaction được khách hàng tổng hợp chính xác thông qua ánh xạ cầu nối.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Khi bạn chọn cột VendorID và cần bỏ xoay các cột khác để chuyển đổi chúng thành các cặp thuộc tính-giá trị, bạn sử dụng 'Bỏ xoay các cột khác.' Phép chuyển đổi này giữ cột đã chọn (VendorID) làm khóa trong khi chuyển đổi tất cả các cột khác thành hàng. 'Bỏ xoay cột' sẽ chỉ hủy xoay các cột đã chọn, điều này trái ngược với những gì cần thiết.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-22",
    "questionNumber": 22,
    "text": "You need to create a DAX measure that calculates the average overall satisfaction score.  \n  \nHow should you complete the DAX code?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Việc lọc theo câu hỏi Mức độ hài lòng chung sẽ để lại các giá trị phản hồi khảo sát đại diện cho điểm số, do đó AVERAGE tính điểm trung bình được yêu cầu. DATESINPERIOD tạo bảng ngày tháng 12 kết thúc vào ngày đã chọn; chuyển bảng Chu kỳ sang TÍNH TOÁN sẽ áp dụng bộ lọc ngày cuộn đó.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-23",
    "questionNumber": 23,
    "text": "You need to resolve the pricing-group classification issue.  \n  \nHow should you complete the T-SQL statement?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Một khung nhìn tập trung vào việc tính toán nhóm giá, có thể được truy vấn thông qua T-SQL và có thể đóng vai trò là nguồn mô hình ngữ nghĩa. CASE đánh giá các dải giá theo thứ tự. Vì điều kiện trước phân loại các giá trị nhỏ hơn hoặc bằng 50 là thấp, nên điều kiện GIỮA cung cấp dải trung bình cho đến 1.000; giá trên 1.000 là cao.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-26",
    "questionNumber": 26,
    "text": "You need to implement the date dimension in the data store. The solution must satisfy the technical requirements.  \n  \nWhich two methods can achieve the goal? Each correct answer provides a complete solution.  \n  \n**NOTE:** Each correct selection is worth one point.",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Populate the date dimension table by using a dataflow."
      },
      {
        "key": "B",
        "text": "Populate the date dimension table by using a Copy activity in a pipeline."
      },
      {
        "key": "C",
        "text": "Populate the date dimension view by using T-SQL."
      },
      {
        "key": "D",
        "text": "Populate the date dimension table by using a Stored procedure activity in a pipeline."
      }
    ],
    "correctAnswers": [
      "A",
  ...
  },
  {
    "id": "dp600-27",
    "questionNumber": 27,
    "text": "You need to recommend a solution for preparing the tenant for the PoC.  \n  \nWhich two actions should you recommend performing in the Fabric Admin portal? Each correct answer represents part of the solution.  \n  \nNOTE: Each correct answer is worth one point.",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Enable the Users can try Microsoft Fabric paid features option for the entire organization."
      },
      {
        "key": "B",
        "text": "Enable the Users can try Microsoft Fabric paid features option for specific security groups."
      },
      {
        "key": "C",
        "text": "Enable the Allow Azure Active Directory guest users to access Microsoft Fabric option for specific security groups."
      },
      {
        "key": "D",
        "text": "Enable the Users can create Fabric items option and exclude specific security groups."
      },
      {
        "key": "E",
        "text": "Enable the Users can create Fabric items option for specific security groups."
      }
    ],
    "correctAnswers": [
      "B",
    ...
    "explanation": "Chỉ có thể bắt đầu khả năng dùng thử Fabric khi **Người dùng có thể dùng thử các tính năng trả phí của Microsoft Fabric** được bật và người dùng cần kích hoạt **Người dùng có thể tạo các mục Fabric** để tạo và làm việc với các mục Fabric. Việc đưa cả hai cài đặt đối tượng thuê vào các nhóm bảo mật thích hợp sẽ giới hạn PoC ở những người dùng được ủy quyền thay vì bật Fabric rộng rãi trên toàn bộ đối tượng thuê.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-28",
    "questionNumber": 28,
    "text": "You need to ensure that the data-loading activities in the AnalyticsPOC workspace run in the required sequence. The solution must satisfy the technical requirements.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Create a dataflow that has multiple steps and schedule the dataflow."
      },
      {
        "key": "B",
        "text": "Create and schedule a Spark notebook."
      },
      {
        "key": "C",
        "text": "Create and schedule a Spark job definition."
      },
      {
        "key": "D",
        "text": "Create a pipeline that has dependencies between activities and schedule the pipeline."
      }
    ],
    "correctAnswers": [
      "D"
    ],
    "explanation": "Đường dẫn dữ liệu Microsoft Fabric điều phối nhiều hoạt động chuyển đổi và di chuyển dữ liệu. Các phần phụ thuộc thành công đảm bảo rằng các bước tải và làm sạch dữ liệu thô hoàn tất trước khi mô hình thứ nguyên được điền và bản thân quy trình có thể được lên lịch để thực hiện định kỳ.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Đường dẫn có điều kiện 'Sau khi hoàn thành' cho phép hoạt động thứ hai thực thi bất kể hoạt động đầu tiên thành công hay thất bại. Đây là lựa chọn chính xác khi bạn cần đảm bảo lỗi không cản trở các hoạt động tiếp theo. 'Khi bị lỗi' chỉ thực thi nếu hoạt động đầu tiên không thành công, trong khi 'Khi bỏ qua' áp dụng cho các hoạt động bị bỏ qua chứ không phải lỗi.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-30",
    "questionNumber": 30,
    "text": "You have a Microsoft Power BI semantic model that contains a measure named TotalSalesAmount. TotalSalesAmount returns a sales revenue amount that is translated into a selected currency.  \n  \nYou need to ensure that the value returned by TotalSalesAmount is formatted to use the correct currency symbol.  \n  \nWhat should you include in the solution?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
      ...
      {
        "key": "D",
        "text": "the WINDOW DAX function"
      }
    ],
    "correctAnswers": [
      "C"
    ],
    "explanation": "Chuỗi định dạng động trong Power BI cho phép các thước đo được định dạng có điều kiện dựa trên ngữ cảnh hoặc lựa chọn của người dùng. Tính năng này cho phép một biểu thức đo duy nhất hiển thị các giá trị với các ký hiệu tiền tệ, định dạng số hoặc quy tắc định dạng khác dựa trên ngữ cảnh đánh giá. Đây là cách tiếp cận tiêu chuẩn cho định dạng đa tiền tệ hoặc theo ngữ cảnh trong các mô hình ngữ nghĩa.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Direct Lake tải dữ liệu trực tiếp từ các bảng Delta OneLake và xử lý các truy vấn DAX bằng công cụ VertiPaq, mang lại hiệu suất báo cáo tương tác giống như Nhập mà không có độ trễ truy vấn nguồn của DirectQuery. Đây là chế độ lưu trữ Fabric dành cho truy vấn mô hình ngữ nghĩa nhanh, độ trễ thấp.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-32",
    "questionNumber": 32,
    "text": "You have a Fabric tenant that contains a lakehouse named Lakehouse1. Lakehouse1 contains a Delta table that has one million Parquet files.  \n  \nYou need to remove files that were NOT referenced by the table during the past 30 days. The solution must ensure that the transaction log remains consistent, and the ACID properties of the table are maintained.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "From OneLake file explorer, delete the files."
      },
      {
        "key": "B",
        "text": "Run the OPTIMIZE command and specify the Z-order parameter."
      },
      {
        "key": "C",
        "text": "Run the OPTIMIZE command and specify the V-order parameter."
      },
      {
        "key": "D",
  ...
  },
  {
    "id": "dp600-33",
    "questionNumber": 33,
    "text": "You have a semantic model named Model1. Model1 contains five tables that all use Import mode. Model1 contains a dynamic row-level security (RLS) role named HR. The HR role filters employee data so that HR managers only see the data of the department to which they are assigned.  \n  \nYou publish Model1 to a Fabric tenant and configure RLS role membership. You share the model and related reports to users.  \n  \nAn HR manager reports that the data they see in a report is incomplete.  \n  \nWhat should you do to validate the data seen by the HR Manager?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Select Test as role to view the data as the HR role."
      },
      {
        "key": "B",
        "text": "Filter the data in the report to match the intended logic of the filter for the HR department."
      },
      {
        "key": "C",
        "text": "Select Test as role to view the report as the HR manager."
      },
      {
        "key": "D",
        "text": "Ask the HR manager to open the report in Microsoft Power BI Desktop."
      }
    ],
    "correctAnswers": [
      "C"
    ],
    "explanation": "Vì vai trò RLS là động nên nó lọc dữ liệu bằng cách sử dụng danh tính của người dùng đã đăng nhập (thông qua tra cứu USERPRINCIPALNAME()), không chỉ là tư cách thành viên của vai trò, nên việc chỉ kích hoạt vai trò nhân sự một cách riêng biệt sẽ không tái tạo những gì một người quản lý cụ thể nhìn thấy. Việc xác thực sự cố yêu cầu sử dụng \"Kiểm tra với vai trò\" cùng với việc nhập người dùng/UPN của chính người quản lý nhân sự đó, xem báo cáo một cách hiệu quả với tư cách là người cụ thể đó để logic bộ lọc động được đánh giá chính xác như đối với phiên thực sự của họ.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "Connect Workspace1 to a Git provider."
      },
      {
        "key": "B",
        "text": "Sync Workspace1 with the repository."
      },
      {
        "key": "C",
        "text": "Configure branch policies in Azure DevOps."
      },
      {
        "key": "D",
        "text": "Create a deployment pipeline."
      ...
      {
        "key": "E",
        "text": "Assign Workspace1 to a Fabric capacity."
      }
    ],
    "choices": [
      {
    ...
    "explanation": "Việc chỉ định không gian làm việc cho dung lượng Fabric sẽ kích hoạt các khả năng cần thiết của không gian làm việc Fabric. Sau khi quản trị viên kết nối không gian làm việc với kho lưu trữ Azure DevOps, quá trình đồng bộ hóa sẽ xuất nội dung không gian làm việc được hỗ trợ sang Git; do đó, Model1 được thêm vào kho lưu trữ. Quy trình triển khai và chính sách chi nhánh Azure DevOps là các tính năng quản trị phát hành riêng biệt, không phải là điều kiện tiên quyết để kiểm soát nguồn.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-35",
    "questionNumber": 35,
    "text": "You have a Fabric tenant that contains two workspaces named Workspace1 and Workspace2. Workspace1 contains a lakehouse named Lakehouse1. Workspace2 contains a lakehouse named Lakehouse2. Lakehouse1 contains a table named dbo.Sales. Lakehouse2 contains a table named dbo.Customers.  \n  \nYou need to ensure that you can write queries that reference both dbo.Sales and dbo.Customers in the same SQL query without making additional copies of the tables.  \n  \nWhat should you use?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
  ...
  },
  {
    "id": "dp600-36",
    "questionNumber": 36,
    "text": "You have a Fabric tenant that contains a workspace named Workspace1.  \n  \nYou plan to deploy a semantic model named Model1 by using the XMLA endpoint.  \n  \nYou need to optimize the deployment of Model1. The solution must minimize how long it takes to deploy Model1.  \n  \nWhat should you do in Workspace1?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Select Small semantic model storage format."
      },
      {
        "key": "B",
        "text": "Select Users can edit data models in the Power BI service."
      },
      {
        "key": "C",
        "text": "Set Enable Cache for Shortcuts to On."
      },
      {
        "key": "D",
        "text": "Select Large semantic model storage format."
      }
    ],
    "correctAnswers": [
      "D"
    ],
    "explanation": "Tài liệu của Microsoft nêu rõ rằng việc bật định dạng lưu trữ mô hình ngữ nghĩa lớn sẽ cải thiện hiệu suất hoạt động ghi XMLA. Định dạng này bao gồm khả năng nén cao hơn và tối ưu hóa được thiết kế đặc biệt để nâng cao hiệu suất cho các hoạt động ghi nặng như triển khai điểm cuối XMLA. Định dạng nhỏ hoặc các cài đặt khác không mang lại lợi ích tối ưu hóa việc ghi này.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Các tập hợp do người dùng xác định và các tập hợp tự động đều là dữ liệu tổng hợp trước để giảm số lượt quét truy vấn trên 500 triệu hàng. Bộ nhớ đệm truy vấn không hoạt động với chế độ DirectQuery (nó chỉ áp dụng cho dữ liệu đã nhập khi tải trang đầu tiên). Tích hợp OneLake không phải là cách tối ưu hóa hiệu suất cho thời gian thực hiện truy vấn trên các nguồn dữ liệu bên ngoài. Cả A và B đều là giải pháp kiến ​​trúc hợp lệ để giảm thời gian thực hiện.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "D",
        "text": "A pipeline with a Copy activity"
      },
      {
        "key": "E",
        "text": "An eventstream"
    ...
    "explanation": "Một quy trình có Copy activity hỗ trợ Azure SQL Managed Instance làm nguồn và sử dụng bản sao song song được phân vùng tích hợp sẵn, giúp nó phù hợp với tải lớn hàng ngày. CDC giảm thiểu dữ liệu được sao chép để thay đổi; Đầu nối Azure SQL Managed Instance của Fabric hỗ trợ các khả năng Copy activity và CDC. Luồng sự kiện là lựa chọn gốc Fabric cho dữ liệu Azure Event Hubs thời gian thực và có thể ghi luồng sự kiện vào các bảng Delta Lakehouse.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "`withColumn` thêm một cột mới hoặc thay thế cột hiện có trong khi vẫn giữ lại các cột khác. `col(\"age\")` tham chiếu cột hiện có và `cast(\"int\")` thay đổi kiểu dữ liệu của nó thành số nguyên.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-40",
    "questionNumber": 40,
    "text": "You have a Fabric tenant containing a semantic model with data about retail stores.  \n  \nYou need to write a DAX query that will run through the XMLA endpoint. The query must return the total sales amount for the same period last year.  \n  \nHow should you complete the DAX expression?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "TÍNH TOÁN sửa đổi ngữ cảnh bộ lọc của [Tổng doanh số] bằng cách sử dụng SAMEPERIODLASTYEAR, trả về ngày được dịch chuyển về một năm. _LYSales là vô hướng; ĐÁNH GIÁ yêu cầu biểu thức bảng và {_LYSales} là hàm tạo bảng một hàng chứa đại lượng vô hướng đó.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-42",
    "questionNumber": 42,
    "text": "You have a Fabric tenant that includes a PySpark notebook named Notebook1.  \n  \nYou define `sas_token` as a variable in the first cell of Notebook1 and store a shared access signature (SAS) token in it. In the second cell, you run the following code.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784206725797-bbj3odfv.png)  \n  \nFor each of the following statements, select Yes if the statement is true. Otherwise, select No.",
    "questionType": "statement_matrix",
    "statements": [
      {
        "id": "1",
        "text": "customers is a pandas DataFrame.",
        "correctAnswer": "No"
      },
      {
        "id": "2",
        "text": "If a delta table named Customers does NOT exist, an error will be generated.",
        "correctAnswer": "No"
      },
      {
        "id": "3",
        "text": "The source data is located in the customers folder in a container named contacts.",
        "correctAnswer": "Yes"
      }
    ],
    "options": [
    ...
    "explanation": "`spark.read.parquet` trả về Khung dữ liệu PySpark. `saveAsTable` ở chế độ ghi đè sẽ tạo một bảng bị thiếu và ghi đè lên bảng hiện có. Trong địa chỉ Azure Blob Storage, `contacts` xác định vùng chứa và `customers` là đường dẫn bên trong nó.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Trong Power Query, Duration.Days() trích xuất số ngày từ giá trị thời lượng. Để tính số ngày giữa hai cột ngày, hãy trừ chúng (tạo ra khoảng thời gian), sau đó chuyển kết quả cho Duration.Days(). Mẫu là: Duration.Days([Ngày_vận_chuyển] - [Ngày_đặt_hàng]). Các hàm khác xử lý số học ngày hoặc thời gian hệ thống nhưng không trích xuất số ngày từ khoảng thời gian.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "B",
        "text": "Model explorer in Microsoft Power BI Desktop"
      },
      {
        "key": "C",
        "text": "Model view in Microsoft Power BI Desktop"
      },
      {
        "key": "D",
        "text": "DAX Formatter in DAX Studio"
      }
    ],
    "correctAnswers": [
      "B"
    ],
    "explanation": "**Tóm tắt theo** là thuộc tính cột kiểm soát tập hợp mặc định được khách hàng báo cáo sử dụng. Trình khám phá mô hình trình bày các mục mô hình ngữ nghĩa theo một hệ thống phân cấp có thể tìm kiếm duy nhất, cho phép tìm thấy các cột và các thuộc tính của chúng được xem xét một cách hiệu quả trên một mô hình phức tạp. [Microsoft Learn: Work with Model explorer](https://learn.microsoft.com/en-us/power-bi/transform-model/model-explorer) [Microsoft Learn: Column properties](https://learn.microsoft.com/en-us/analysis-services/tabular-models/column-properties-ssas-tabular?view=sql-analysis-services-2025)",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-47",
    "questionNumber": 47,
    "text": "You need to ensure that Contoso can use version control to satisfy the data analytics requirements and the general requirements.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Store at the semantic models and reports in Data Lake Gen2 storage."
      },
      {
        "key": "B",
        "text": "Modify the settings of the Research workspaces to use a GitHub repository."
      },
      {
        "key": "C",
        "text": "Modify the settings of the Research division workspaces to use an Azure Repos repository."
      },
      {
        "key": "D",
        "text": "Store all the semantic models and reports in Microsoft OneDrive."
      }
    ],
    "correctAnswers": [
      "C"
    ],
    "explanation": "Tích hợp Microsoft Fabric Git kết nối không gian làm việc với kho lưu trữ Azure Repos để các mục không gian làm việc, bao gồm các mô hình và báo cáo ngữ nghĩa, có thể được tạo phiên bản và quản lý thông qua các nhánh Git. Do đó, việc định cấu hình không gian làm việc của bộ phận Nghiên cứu để sử dụng Azure Repos sẽ cung cấp khả năng kiểm soát phiên bản dựa trên phân nhánh cần thiết với nỗ lực quản trị thấp.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-48",
    "questionNumber": 48,
    "text": "You need to refresh the Online Sales department's **Orders** table. The solution must satisfy the semantic model requirements.  \n  \nWhat should you include in the solution?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "an Azure Data Factory pipeline that executes a Stored procedure activity to retrieve the maximum value of the OrderID column in the destination lakehouse"
      },
      {
        "key": "B",
        "text": "an Azure Data Factory pipeline that executes a Stored procedure activity to retrieve the minimum value of the OrderID column in the destination lakehouse"
      },
      {
        "key": "C",
        "text": "an Azure Data Factory pipeline that executes a dataflow to retrieve the minimum value of the OrderID column in the destination lakehouse"
      },
      {
        "key": "D",
        "text": "an Azure Data Factory pipeline that executes a dataflow to retrieve the maximum value of the OrderID column in the destination lakehouse"
      }
    ],
    "correctAnswers": [
      "D"
    ],
    "explanation": "Vì `OrderID` phản ánh trình tự tạo đơn hàng nên `OrderID` tối đa đã có ở đích là mốc nước cao thích hợp cho tải tăng dần. Việc sử dụng giá trị đó cho phép quá trình làm mới chỉ truy xuất các đơn hàng mới được tạo, giảm thiểu các hàng được thêm vào trong quá trình làm mới. Hướng dẫn tải tăng dần của Microsoft sử dụng giá trị hình mờ tối đa để xác định ranh giới mới và hoạt động Luồng dữ liệu có thể chạy luồng dữ liệu từ một đường dẫn.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-49",
    "questionNumber": 49,
    "text": "You need to recommend a solution for grouping the Research division workspaces.  \n  \nWhat should the recommendation include?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Miền Fabric nhóm một cách hợp lý các không gian làm việc và dữ liệu có liên quan theo khu vực tổ chức, chẳng hạn như bộ phận và hỗ trợ lọc trong trung tâm dữ liệu OneLake. Quản trị viên Fabric tạo và quản lý miền trong cổng quản trị Fabric.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-50",
    "questionNumber": 50,
    "text": "You need to migrate the Research division data for Productline1 while meeting the data-preparation requirements.  \n  \nComplete the code.",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Productline1 được lưu trữ dưới dạng dữ liệu Delta, do đó người đọc phải sử dụng định dạng Delta. Fabric Lakehouse Explorer nhận dạng các bảng Delta được quản lý trong khu vực `Tables` cấp cao nhất; việc lưu đầu ra Delta vào `Tables/productline1` sẽ làm cho nó có sẵn ở đó dưới dạng bảng Productline1.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-52",
    "questionNumber": 52,
    "text": "You need to migrate the Research division data for Productline2. The solution must meet the data-preparation requirements.  \n  \nHow should you complete the code?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Bảng được quản lý Fabric lakehouse là bảng Delta được lưu trữ trong khu vực Bảng của nó. Việc ghi DataFrame có nguồn gốc từ CSV ở định dạng Delta vào `Tables/productline2` sẽ làm cho nó có sẵn dưới dạng bảng được quản lý trong Lakehouse explorer.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Phân tích mô tả trả lời câu hỏi 'Chuyện gì đang xảy ra?' bằng cách sử dụng số liệu thống kê tóm tắt, tổng hợp và trực quan hóa để mô tả dữ liệu hiện tại hoặc lịch sử. Dựa trên sự đồng thuận nhất trí và bản chất của đầu ra phân tích Python điển hình được hiển thị trong các câu hỏi như vậy, mã có thể hiển thị số liệu thống kê tóm tắt hoặc phân tích phân phối điển hình của phân tích mô tả.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Tệp PBIT (Mẫu Power BI) được thiết kế riêng cho trường hợp sử dụng này: nó bao gồm các kết nối nguồn dữ liệu được xác định trước, cấu trúc báo cáo, định dạng và bố cục trực quan nhưng chứa dữ liệu thực tế no. PBIX bao gồm dữ liệu (báo cáo đầy đủ), PBIDS là tệp định nghĩa nguồn dữ liệu và PBIP là định dạng dự án. PBIT là định dạng mẫu chuẩn để chia sẻ cấu trúc báo cáo có thể sử dụng lại.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Phân tích mô tả mô tả dữ liệu lịch sử thông qua các con số và hình ảnh trực quan mà không giải thích nguyên nhân hoặc đưa ra dự đoán. Việc tạo biểu đồ hiển thị sự phân bổ khách hàng được giữ lại và khách hàng bị mất theo địa lý, số lần mua sản phẩm, độ tuổi và nhiệm kỳ là mô tả những gì đã xảy ra trong quá khứ. Phân tích chẩn đoán sẽ giải thích lý do xảy ra hiện tượng gián đoạn; dự đoán sẽ dự báo kết quả trong tương lai; quy định sẽ khuyến nghị hành động. Kịch bản này hoàn toàn mang tính mô tả.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-56",
    "questionNumber": 56,
    "text": "You have a Fabric tenant that contains a workspace named Workspace1 and a user named User1. User1 is assigned the Contributor role for Workspace1.  \n  \nYou plan to configure Workspace1 to use an Azure DevOps repository for version control.  \n  \nYou need to ensure that User1 can commit items to the repository.  \n  \nWhich two settings should you enable for User1? Each correct answer presents part of the solution.  \n  \nNOTE: Each correct selection is worth one point.",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Users can sync workspace items with GitHub repositories"
      },
      {
        "key": "B",
        "text": "Users can create and use Data workflows"
      },
      {
        "key": "C",
      ...
      {
        "key": "D",
        "text": "Users can synchronize workspace items with their Git repositories"
      }
    ],
    "correctAnswers": [
      "C",
    ...
    "explanation": "Để cam kết các mục vào kho lưu trữ Azure DevOps, Người dùng1 phải có cả: (C) quyền tạo các mục Fabric—các đối tượng được cam kết—và (D) quyền đồng bộ hóa các mục trong không gian làm việc với kho Git—cho phép đồng bộ hóa và quy trình làm việc cam kết. Option A đề cập cụ thể đến GitHub, không phải Azure DevOps và B liên quan đến quy trình làm việc dữ liệu chứ không phải kiểm soát phiên bản.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-57",
    "questionNumber": 57,
    "text": "You have a Fabric tenant containing a semantic model with retail-store data. You need to write a DAX query to run by using the XMLA endpoint. The query must return stores that opened since December 1, 2023. Complete the DAX expression. Values may be used once, more than once, or not at all.",
    "questionType": "matching_drag_drop",
    "statements": [
      {
        "id": "blank1",
    ...
    "explanation": "Truy vấn DAX sử dụng DEFINE cho các định nghĩa trong phạm vi truy vấn và EVALUATE để trả về biểu thức bảng. TÓM TẮT xây dựng bảng cửa hàng được chỉ định, sau đó LỌC sẽ giới hạn ở các cửa hàng có Ngày mở vào hoặc sau ngày 1 tháng 12 năm 2023.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Tạo miền mới trong Microsoft Fabric yêu cầu vai trò quản trị viên Fabric, có quyền cấp độ đối tượng thuê. Mặc dù quản trị viên miền có thể quản lý các miền hiện có nhưng chỉ quản trị viên Fabric mới có thể tạo miền mới ở cấp độ đối tượng thuê. Mặc dù điều này cấp các đặc quyền rộng hơn mức cần thiết lý tưởng theo nguyên tắc đặc quyền tối thiểu, nhưng đó là khả năng tiên quyết cho yêu cầu tạo miền.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-59",
    "questionNumber": 59,
    "text": "You have a Fabric workspace named Workspace1 and a warehouse named Warehouse1. Workspace1 includes a user named User1. User1 has the Viewer role for Workspace1.  \n  \nYou need to ensure that User1 can share Warehouse1 with other users. The solution must adhere to the principle of least privilege.  \n  \nWhich role should be assigned to User1?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Member for Workspace1"
      },
      {
        "key": "B",
        "text": "db_owner for Warehouse1"
      },
      {
        "key": "C",
        "text": "Contributor for Workspace1"
      },
      {
        "key": "D",
        "text": "Admin for Workspace1"
      }
    ],
    "correctAnswers": [
      "A"
    ],
    "explanation": "Microsoft Fabric yêu cầu người dùng giữ vai trò không gian làm việc của Quản trị viên hoặc Thành viên để chia sẻ mục Warehouse. Thành viên có thể chia sẻ nội dung không gian làm việc, trong khi Cộng tác viên có thể sửa đổi nội dung nhưng không thể chia sẻ nội dung đó; Do đó, thành viên là vai trò có ít đặc quyền nhất đáp ứng được yêu cầu.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-61",
    "questionNumber": 61,
    "text": "You have a Fabric warehouse containing a table named `Sales.Orders`. `Sales.Orders` contains the following columns.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784205245088-uly4gi5j.png)  \n  \nYou must write a T-SQL query that returns the following columns.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784205247375-hfw8yc3t.png)  \n  \nHow should you complete the code?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "`COALESCE(Weight, Quantity, 1)` trả về giá trị không NULL đầu tiên theo thứ tự đó. `LEAST(ListPrice, SalePrice)` trả về giá không phải NULL thấp hơn; do đó, khi `SalePrice` là NULL, nó trả về `ListPrice`.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Hướng dẫn giám sát của Fabric Warehouse hướng đến sys.dm_exec_requests DMV tương thích với SQL Server tiêu chuẩn để kiểm tra các yêu cầu hiện đang thực thi, trạng thái của chúng, loại chờ và thông tin chặn. Đây là những gì bạn cần tìm hiểu lý do tại sao một truy vấn bị kẹt trong 45 phút. sys.dm_pdw_exec_requests dành riêng cho kiến ​​trúc nút tính toán/điều khiển MPP của nhóm SQL chuyên dụng Azure Synapse Analytics và không phải là DMV hiển thị để giám sát Fabric Warehouse.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-64",
    "questionNumber": 64,
    "text": "You have a Fabric tenant that contains a lakehouse named LH1.  \n  \nYou create new tables in LH1.  \n  \nYou need to ensure that the tables are added automatically to the default semantic model.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Disable Query Caching for the default semantic model."
      },
      {
        "key": "B",
        "text": "From the settings pane of LH1, enable Sync the default Power BI semantic model."
      },
      {
        "key": "C",
        "text": "Enable Refresh for the default semantic model."
      },
      {
        "key": "D",
        "text": "From the Endorsement and discovery settings of LH1, select Make discoverable."
      }
    ],
    "correctAnswers": [
      "B"
    ],
    "explanation": "Cài đặt 'Đồng bộ hóa mô hình ngữ nghĩa Power BI mặc định' trong ngăn cài đặt lakehouse cho phép tự động thêm các bảng mới vào mô hình ngữ nghĩa mặc định. Việc tắt Bộ nhớ đệm truy vấn không thêm bảng vào mô hình; bật Làm mới duy trì các kết nối hiện có nhưng không tự động thêm bảng mới; cài đặt có thể khám phá sẽ kiểm soát khả năng hiển thị mục nhưng không kiểm soát việc đồng bộ hóa mô hình ngữ nghĩa. B là cài đặt chính xác để bật đồng bộ hóa tự động.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-65",
    "questionNumber": 65,
    "text": "You need to create a data loading pattern for a Type 1 slowly changing dimension (SCD).  \n\nWhich two actions should you include in the process? Each correct answer presents part of the solution.  \n\nNOTE: Each correct answer is worth one point.",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Update rows when the non-key attributes have changed."
      },
      {
        "key": "B",
        "text": "Insert new rows when the natural key exists in the dimension table, and the non-key attribute values have changed."
      },
      {
        "key": "C",
        "text": "Update the effective end date of rows when the non-key attribute values have changed."
      },
      {
        "key": "D",
        "text": "Insert new records when the natural key is a new value in the table."
      }
    ],
    "correctAnswers": [
      "A",
    ...
    "explanation": "SCD Loại 1 (Kích thước thay đổi chậm) không lưu giữ lịch sử; nó ghi đè dữ liệu. Hai hành động bắt buộc là cập nhật các hàng hiện có khi thuộc tính không khóa thay đổi (A) và chèn bản ghi mới cho các giá trị khóa tự nhiên mới (D). Tùy chọn B và C liên quan đến việc theo dõi ngày tháng và lưu giữ lịch sử hiệu quả, đó là các đặc điểm của SCD Loại 2. Kích thước loại 1 chỉ duy trì trạng thái hiện tại.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "C",
        "text": "an effective end date and time"
      },
      {
        "key": "D",
      ...
      {
        "key": "E",
        "text": "an effective start date and time"
      }
    ],
    "correctAnswers": [
      "C",
    ...
    "explanation": "Thứ nguyên thay đổi chậm của Loại 2 yêu cầu ba cột mới không có trong nguồn: khóa thay thế (D) để nhận dạng duy nhất từng phiên bản hàng do khóa doanh nghiệp bị trùng lặp, ngày bắt đầu có hiệu lực (E) cho biết thời điểm hàng trở nên hợp lệ và ngày kết thúc có hiệu lực (C) cho biết thời điểm hàng hết hạn. Khóa ngoại và khóa tự nhiên đã tồn tại trong dữ liệu nguồn nên đây không phải là các cột mới được thêm vào. Ba cột này là bắt buộc để triển khai logic SCD Loại 2.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-68",
    "questionNumber": 68,
    "text": "You have a Microsoft Power BI report and a semantic model that uses Direct Lake mode. In Power BI Desktop, you open Performance analyzer as shown in the following exhibit.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784205114480-3s9h9oem.png)  \n  \nUse the drop-down menus to complete each statement based on the information shown.",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Tự động cung cấp dự phòng DirectQuery thích ứng cho Direct Lake trên các điểm cuối SQL. DirectLakeOnly vô hiệu hóa dự phòng, trong khi DirectQueryOnly sử dụng DirectQuery vô điều kiện. Thời lượng truy vấn Trực tiếp được ghi lại cho thấy hình ảnh này đang sử dụng DirectQuery; mục trực quan khác không có truy vấn Trực tiếp sẽ thiết lập hành vi đó không phải là DirectQueryOnly.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Hoạt động Tra cứu trong Fabric Data Factory được thiết kế đặc biệt để thực hiện các quy trình hoặc truy vấn được lưu trữ và thu thập kết quả của chúng để sử dụng cho các hoạt động tiếp theo. Nó truy xuất một tập hợp nhỏ các giá trị (chẳng hạn như số lượng và giá trị trung bình từ thủ tục được lưu trữ của bạn) và cung cấp chúng dưới dạng các biến đầu ra của hoạt động mà các hoạt động tiếp theo có thể tham chiếu và hành động theo.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-70",
    "questionNumber": 70,
    "text": "You have a Fabric tenant that contains a warehouse named Warehouse1. Warehouse1 contains two schemas name schema1 and schema2 and a table named schema1.city.  \n  \nYou need to make a copy of schema1.city in schema2. The solution must minimize the copying of data.  \n  \nWhich T-SQL statement should you run?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "TẠO BẢNG. NHƯ CLONE OF tạo một bản sao gần như tức thời, chỉ siêu dữ liệu của bảng Fabric Warehouse chia sẻ bộ nhớ cơ bản cho đến khi một trong hai bản sao được sửa đổi, do đó, về cơ bản, dữ liệu no được sao chép vật lý. CHÈN VÀO. CHỌN và CHỌN VÀO đều thực hiện sao chép dữ liệu theo từng hàng đầy đủ và TẠO BẢNG NHƯ CHỌN (CTAS) cũng tạo ra một bản sao hoàn toàn mới, tất cả đều tiêu tốn nhiều điện toán và lưu trữ hơn so với bản sao.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "statements": [
      {
        "id": "1",
        "text": "The Spark engine will read only the 'SalesOrderNumber', 'OrderDate','CustomerName', 'UnitPrice' columns from Sales_raw.csv.",
        "correctAnswer": "Yes"
      },
      {
        "id": "2",
        "text": "The Year column replaces the OrderDate column in the table.",
        "correctAnswer": "No"
      },
      {
        "id": "3",
        "text": "Adding inferSchema='true' to the options will increase the execution time of the query.",
        "correctAnswer": "Yes"
      }
    ],
    "options": [
    ...
    "explanation": "Spark có thể áp dụng tính năng cắt bớt cột để quét CSV khi chỉ chiếu một tập hợp con các trường. `withColumn(\"Year\", year(\"OrderDate\"))` thêm `Year` và giữ nguyên `OrderDate`. Suy luận lược đồ CSV yêu cầu kiểm tra bổ sung dữ liệu để xác định loại, tăng cường công việc được thực hiện.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-74",
    "questionNumber": 74,
    "text": "You have a Fabric eventhouse that contains a KQL database. The database contains a table named TaxiData that stores the following data.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784213061866-vb6hebxu.png)  \n  \nYou need to create a column named FirstPickupDateTime that contains the first value of each hour from tpep_pickup_datetime, partitioned by payment_type.  \n  \nHow should you complete the query?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "`row_window_session` gán giá trị bắt đầu phiên cho các hàng trong cùng một phiên. Khoảng cách tối đa `1h` tính từ dấu thời gian đầu tiên làm cho giá trị phiên trở thành thời gian lấy hàng đầu tiên trong giờ đó. Biểu thức khởi động lại `payment_type!= prev(payment_type)` bắt đầu một phiên mới khi loại thanh toán thay đổi, phân chia phép tính theo loại thanh toán sau khi sắp xếp.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [],
    "correctAnswers": [],
    "explanation": "`withColumn` tạo cột `pickupDate` và truyền giá trị dấu thời gian tới `date` tạo ra thành phần ngày của nó. Vị từ `fareAmount > 0 AND fareAmount < 100` giữ lại chính xác giá vé dương dưới 100.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Không thể tạo bảo mật cấp đối tượng (OLS) nguyên bản trong Máy tính để bàn Power BI. Tài liệu của Microsoft khuyến nghị rõ ràng việc sử dụng các công cụ bên ngoài như Trình soạn thảo dạng bảng để xác định các quy tắc OLS trên các mô hình ngữ nghĩa. Các công cụ này kết nối thông qua các điểm cuối XMLA để sửa đổi các định nghĩa vai trò và chỉ định các hạn chế ở cấp độ cột hoặc bảng để bảo mật ở cấp độ đối tượng.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "SCD Loại 2 lưu giữ lịch sử bằng cách thêm phiên bản mới khi giá trị thứ nguyên thay đổi, đáp ứng yêu cầu của Khách hàng. SCD Loại 1 ghi đè bản ghi hiện có và chỉ giữ lại giá trị hiện tại đáp ứng yêu cầu của Sản phẩm.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-78",
    "questionNumber": 78,
    "text": "You have a Fabric workspace named Workspace1 that includes these items:  \n  \n- A warehouse named Warehouse1  \n- A semantic model named Model1  \n- An interactive report named Report1  \n  \nYou need to grant a user named User1 access to one table in Warehouse1. The solution must adhere to the principle of least privilege.  \n  \nWhat should you do first?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Assign the Viewer role to User1 for Workspace1."
      },
      {
        "key": "B",
        "text": "Share Warehouse1 with User1."
      },
      {
        "key": "C",
        "text": "Assign object-level permissions to User1 for Warehouse1."
      },
      {
        "key": "D",
        "text": "Assign the db_datareader role to User1 for Warehouse1."
      }
    ],
    "correctAnswers": [
      "C"
    ],
    "explanation": "Fabric Warehouse sử dụng các quyền T-SQL cấp đối tượng như GRANT để hạn chế quyền truy cập vào một bảng cụ thể. Để truy cập chi tiết, trước tiên hãy xác định quyền SQL; sau đó cấp cho người dùng quyền Đọc cấp mục tối thiểu cần thiết để kết nối. Quyền tương đương với db_datareader cho phép đọc tất cả các bảng và dạng xem, do đó nó không đáp ứng đặc quyền tối thiểu.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "PBIP (Dự án Power BI) là định dạng tệp hiện đại được thiết kế để tích hợp kiểm soát phiên bản. Nó lưu các định nghĩa báo cáo và mô hình ngữ nghĩa dưới dạng các tệp văn bản đơn giản riêng lẻ trong hệ thống phân cấp thư mục, cho phép các hoạt động git hiệu quả như tìm khác biệt và hợp nhất. PBIX là định dạng nhị phân không phù hợp để kiểm soát phiên bản, trong khi PBIDS là mẫu nguồn dữ liệu và PBIT là mẫu báo cáo.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Tham số trường có thể chứa cả Tên sản phẩm và Ngày đặt hàng và được đặt trong trường trục của biểu đồ. Bộ cắt tham số của nó cho phép người dùng báo cáo tự động thay đổi thứ nguyên được phân tích bằng hình ảnh, trong khi Số lượng vẫn giữ nguyên giá trị.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Table.Profile() trả về số liệu thống kê lược tả cho từng cột trong bảng, bao gồm số lượng tối thiểu, tối đa, số lượng khác biệt, số lượng null và loại dữ liệu. Table.Range và Table.MaxN không cung cấp chức năng lập hồ sơ toàn diện này.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-84",
    "questionNumber": 84,
    "text": "You have a Fabric warehouse named Warehouse1 that contains a table named TaxiTrips.  \n  \nTaxiTrips contains the following columns.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784212789541-kfozk6wx.png)  \n  \nYou need to create a query that shows the top three taxi companies based on the total miles traveled.  \n  \nHow should you complete the T-SQL statement?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "TOP (3) giới hạn kết quả ở ba hàng. Công ty phải là biểu thức GROUP BY vì đây là cột được chọn không tổng hợp; SUM(tripDistance) tính tổng số dặm cho mỗi công ty. Việc sắp xếp tổng hợp đó theo thứ tự giảm dần sẽ đặt các công ty có tổng số dặm lớn nhất lên đầu tiên.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Hoạt động Tra cứu là lựa chọn chính xác để thực thi quy trình được lưu trữ trong warehouse và hiển thị các giá trị được trả về cho các hoạt động xuôi dòng. Biến nối thêm sửa đổi các biến đường dẫn thay vì thực hiện truy vấn; Sao chép dữ liệu truyền dữ liệu giữa các nguồn; KQL dành cho truy vấn dữ liệu nhưng không cung cấp cơ chế chuyển đầu ra tương tự. Tra cứu là hoạt động tiêu chuẩn cho trường hợp sử dụng này trong Fabric Data Factory.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-86",
    "questionNumber": 86,
    "text": "You have a Fabric warehouse containing a table named Sales.Orders. Sales.Orders has the following columns.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784205241043-fvml5mv3.png)  \n  \nYou need to write a T-SQL query that returns the following columns.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784205243993-5adfopu6.png)  \n  \nHow should you complete the code?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "DATETRUNC với phần ngày của tháng trả về ngày đầu vào bị cắt bớt về đầu tháng của nó. DATENAME với phần ngày trong tuần trả về tên văn bản ngày trong tuần cho ngày đó.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "A pipeline Copy activity"
      },
      {
        "key": "B",
        "text": "A pipeline Dataflow activity"
      },
      {
        "key": "C",
        "text": "A pipeline Stored procedure activity"
      },
      {
        "key": "D",
        "text": "A schedule"
      ...
      {
        "key": "E",
        "text": "A Spark job definition"
      },
      {
        "key": "F",
        "text": "An Invoke pipeline activity"
      }
    ],
    "choices": [
      {
    ...
    "correctAnswers": [
      "orchestration_pipeline=D",
      "bronze_layer=F",
      "silver_layer=B",
      "gold_layer=C"
    ],
    "explanation": "Một quy trình Fabric được lên lịch cung cấp trình kích hoạt hàng ngày. Hoạt động quy trình Gọi sẽ điều phối các quy trình Đồng hiện có, trong khi các hoạt động phụ thuộc thành công có thể sắp xếp các bước Đồng, Bạc và Vàng. Hoạt động Dataflow chạy Dataflow Gen2 cho Silver layer và hoạt động Thủ tục được lưu trữ thực thi các thủ tục được lưu trữ warehouse cho Gold layer.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-89",
    "questionNumber": 89,
    "text": "You have a Fabric tenant containing a lakehouse. You use a Fabric notebook to save a large DataFrame with the specified code.  \n  \nFor each statement, select **Yes** if it is true; otherwise, select **No**.",
    "questionType": "statement_matrix",
    "statements": [
      {
        "id": "1",
        "text": "The results will form a hierarchy of folders for each partition key.",
        "correctAnswer": "Yes"
      },
      {
        "id": "2",
        "text": "The resulting file partitions can be read in parallel across multiple nodes.",
        "correctAnswer": "Yes"
      },
      {
        "id": "3",
        "text": "The resulting file partitions will use file compression.",
        "correctAnswer": "Yes"
      }
    ],
    "options": [
    ...
    "explanation": "Việc ghi Parquet được phân vùng sẽ tạo các cấp thư mục cho các giá trị phân vùng `year`, `month` và `day`. Spark lưu trữ kết quả đầu ra dưới dạng tệp phần Parquet, cho phép đọc song song phân tán. Tính năng nén sàn được bật theo mặc định trong Spark (thường là Snappy trừ khi bị ghi đè).",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [],
    "correctAnswers": [],
    "explanation": "Phép nối bên trong là đủ vì mọi khách hàng đều có mối quan hệ khóa ngoại không rỗng với chính xác một khu vực bán hàng, do đó, phép nối bên ngoài không thể thêm các hàng khách hàng bắt buộc và thực hiện công việc nối ngoài không cần thiết. Bảng `CustomerAddress` liên kết khách hàng với một địa chỉ thông qua `CustomerID` và khóa ngoại `AddressID` của nó phải khớp với `Address.AddressID`. Việc lọc theo `Main Office` sẽ để lại một địa chỉ bắt buộc cho mỗi khách hàng. Các phép nối SQL Server/Fabric sử dụng một biến vị ngữ nối để liên kết khóa ngoại với khóa liên kết của nó.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "correctAnswers": [
      "function_namespace=G",
      "function_name=B",
      "enable_folding_option=A"
    ],
    "explanation": "Value.NativeQuery thực thi câu lệnh SQL được cung cấp dựa trên cơ sở dữ liệu. Việc chuyển một bản ghi tùy chọn có EnableFolding được đặt thành true cho phép các phép biến đổi có thể gập tiếp theo được đưa trở lại cơ sở dữ liệu nguồn, do đó SQL Server sẽ xử lý chúng.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Quy trình triển khai kết hợp các mục hiện có trong không gian làm việc đích với các mục mới được triển khai từ không gian làm việc nguồn. Các mục có tên trùng khớp sẽ được ghép nối (cập nhật), trong khi các mục không khớp trong mục tiêu sẽ được giữ lại. Kết quả bao gồm tất cả các mục từ DEV cộng với tất cả các mục đã có trong TEST, được hợp nhất theo tên phù hợp. Điều này cung cấp hành vi triển khai tích lũy.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-93",
    "questionNumber": 93,
    "text": "You have a Fabric workspace named Workspace1 that includes a warehouse named Warehouse1 and a lakehouse named Lakehouse1. Warehouse1 has a table named Table1. Lakehouse1 has a Delta table named Table2.  \n  \nYou need to persist data from Table1 into Table2. The solution must use a low-code interface.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Use a notebook to read the data from Table2 and insert the data into Table1."
      },
      {
        "key": "B",
        "text": "Use a notebook to read the data from Table1 and insert the data into Table2."
      },
      {
        "key": "C",
        "text": "Use a Dataflow Gen2 to read the data from Table1 and insert the data into Table2."
      },
      {
        "key": "D",
        "text": "Use stored procedure to read the data from Table2 and insert the data into Table1."
      }
    ],
    "correctAnswers": [
      "C"
    ],
    "explanation": "Dataflow Gen2 là giao diện nhập và chuyển đổi dữ liệu mã thấp, có thể sử dụng dữ liệu Fabric Warehouse làm nguồn và ghi vào Bảng Fabric Lakehouse làm đích. Các bảng Lakehouse sử dụng Delta Lake theo mặc định, do đó, nó hỗ trợ lưu giữ dữ liệu Table1 vào Table2.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "Enable Git integration for Workspace1."
      },
      {
        "key": "B",
        "text": "Save Model1 in Power BI Desktop as a PBIT file."
      },
      {
        "key": "C",
        "text": "Enable users to edit data models in the Power BI service."
      },
      {
        "key": "D",
        "text": "Save Model1 in Power BI Desktop as a PBIP file."
      }
    ],
    "correctAnswers": [
      "A",
    ...
    "explanation": "Tích hợp Git (A) cho phép kiểm soát phiên bản, cho phép đảo ngược về các phiên bản trước và nhận dạng khác biệt. Định dạng PBIP (D) lưu trữ định nghĩa mô hình dưới dạng tệp JSON có thể chỉnh sửa, tương thích với Visual Studio Code. Các tệp PBIT là các mẫu; Chỉnh sửa dịch vụ Power BI không sử dụng VS Code.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-95",
    "questionNumber": 95,
    "text": "You are creating a report and a semantic model in Microsoft Power BI Desktop.  \n  \nThe Value measure has the expression shown in the following exhibit.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784206738796-xnmy8mvl.png)  \n  \nUse the drop-down menus to choose the answer that completes each statement using the information in the graphic.",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Chuỗi định dạng động kiểm soát có điều kiện cách hiển thị số đo mô hình trong khi vẫn giữ nguyên kiểu dữ liệu số của nó. Chuỗi định dạng phần trăm áp dụng cho Tỷ suất lợi nhuận gộp % và chuỗi định dạng `#,##` áp dụng cho # Khách hàng và nhánh mặc định, tạo ra định dạng số nguyên trong những trường hợp đó.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-96",
    "questionNumber": 96,
    "text": "![Question Image](https://cdn.examcademy.com/images/questions/1784206606477-45cujf5e.png)  \n  \nFor each of the following statements, select Yes if the statement is true. Otherwise, select No.",
    "questionType": "statement_matrix",
    "statements": [
      {
        "id": "1",
        "text": "definition.pbir is in the PBIR-Legacy format.",
        "correctAnswer": "Yes"
      },
      {
        "id": "2",
        "text": "The semantic model referenced by definition.pbir is located in the Power BI service.",
        "correctAnswer": "No"
      },
      {
        "id": "3",
        "text": "When the related report is opened, Power BI Desktop will open the semantic model in full edit mode.",
        "correctAnswer": "Yes"
      }
    ],
    "options": [
    ...
    "explanation": "Phiên bản 1.0 yêu cầu PBIR-Legacy. Tham chiếu tập dữ liệu `byPath` xác định thư mục mô hình ngữ nghĩa cục bộ tương đối, không phải kết nối dịch vụ Power BI; Power BI Desktop mở mô hình ngữ nghĩa được tham chiếu bởi `byPath` ở chế độ chỉnh sửa đầy đủ.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-97",
    "questionNumber": 97,
    "text": "You have a Fabric workspace that uses the default Spark starter pool and runtime version 1.2.  \n  \nYou plan to read a CSV file named Sales_raw.csv in a lakehouse, select columns, and save the data as a Delta table to the managed area of the lakehouse. Sales_raw.csv contains 12 columns.  \n  \nYou have the following code.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784205116247-oy1igppz.png)  \n  \nFor each of the following statements, select Yes if the statement is true. Otherwise, select No.",
    "questionType": "statement_matrix",
    "statements": [
      {
        "id": "1",
      ...
      {
        "id": "2",
        "text": "Removing the partition will reduce the execution time of the query.",
        "correctAnswer": "No"
      },
      {
        "id": "3",
  ...
  },
  {
    "id": "dp600-98",
    "questionNumber": 98,
    "text": "You have this T-SQL statement.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784206615208-zyrfv3jk.png)  \n  \nFor each of the following statements, select Yes if the statement is true. Otherwise, select No.",
    "questionType": "statement_matrix",
    "statements": [
      {
        "id": "1",
        "text": "The statement returns Region values when a Sales item has a RefundStatus of Refunded.",
        "correctAnswer": "Yes"
      },
      {
        "id": "2",
        "text": "The statement only returns TransactionDate values that occurred during the current year.",
        "correctAnswer": "Yes"
      },
      {
        "id": "3",
        "text": "The TotalRevenue calculation aggregates SalesAmount values that have a RefundStatus of Refunded.",
        "correctAnswer": "No"
      }
    ],
    "options": [
    ...
    "explanation": "`Region` được chọn và nhóm, trong khi mệnh đề WHERE chỉ lọc cho năm hiện tại chứ không lọc theo trạng thái hoàn tiền. Vị từ năm hạn chế các hàng được xử lý trong năm hiện tại. Biểu thức CASE chỉ cung cấp `SalesAmount` cho các hàng có `RefundStatus` không phải là `Refunded`; các hàng được hoàn lại thêm số 0 vào `SUM`.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "B",
        "text": "a pipeline that contains a KQL activity"
      },
      {
        "key": "C",
        "text": "a Spark notebook"
      },
      {
        "key": "D",
        "text": "a dataflow"
    ...
    "explanation": "Yêu cầu nêu rõ 'bất cứ khi nào có thể, các kỹ sư dữ liệu sẽ sử dụng các công cụ mã thấp để nhập dữ liệu.' Luồng dữ liệu là giải pháp mã nguồn ngắn cho phép tải dữ liệu mà không cần chuyển đổi vào kho lưu trữ dữ liệu. Mặc dù máy tính xách tay Spark cung cấp nhiều quyền kiểm soát hơn nhưng chúng yêu cầu phát triển mã. Luồng dữ liệu trực tiếp đáp ứng cả yêu cầu mã thấp và khả năng tải dữ liệu mà không cần chuyển đổi.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-101",
    "questionNumber": 101,
    "text": "You have a Fabric tenant that contains a workspace named Workspace1 and a user named User1. Workspace1 contains a warehouse named DW1.  \n  \nYou share DW1 with User1 and assign User1 the default permissions for DW1.  \n  \nWhat can User1 do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Build reports by using the default dataset."
      },
      {
        "key": "B",
        "text": "Read data from the tables in DW1."
      },
      {
        "key": "C",
        "text": "Connect to DW1 via the Azure SQL Analytics endpoint."
      },
      {
        "key": "D",
        "text": "Read the underlying Parquet files from OneLake."
      }
    ],
    "correctAnswers": [
      "C"
    ],
    "explanation": "Khi warehouse được chia sẻ với các quyền bổ sung no được chọn, người nhận chỉ nhận được quyền Đọc mặc định, tương đương với CONNECT trong SQL Server và cho phép họ kết nối với điểm cuối phân tích SQL — quyền này không cho phép họ truy vấn các bảng/chế độ xem, xây dựng báo cáo trên mô hình ngữ nghĩa mặc định hoặc đọc các tệp OneLake cơ bản, vì những tệp đó yêu cầu ReadData, Quyền Xây dựng hoặc Đọc tất cả phải được cấp rõ ràng.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-103",
    "questionNumber": 103,
    "text": "You have a Fabric workspace named Workspace1 that is assigned to a newly created Fabric capacity named Capacity1.  \n  \nYou create a semantic model named Model1 and deploy Model1 to Workspace1.  \n  \nYou need to publish changes to Model1 directly from Tabular Editor.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "For Workspace1, enable Git integration."
      },
      {
        "key": "B",
        "text": "For Model1, enable external sharing."
      },
      {
        "key": "C",
        "text": "For Workspace1, create a managed private endpoint."
      },
      {
        "key": "D",
        "text": "For Capacity1, set XMLA Endpoint to Read Write."
      }
    ],
    "correctAnswers": [
      "D"
    ],
    "explanation": "Trình soạn thảo dạng bảng yêu cầu quyền truy cập đọc-ghi XMLA để xuất bản các thay đổi siêu dữ liệu đối với mô hình ngữ nghĩa. Việc đặt Điểm cuối XMLA thành Đọc, ghi trên Dung lượng1 sẽ cho phép Trình soạn thảo dạng bảng và các công cụ bên ngoài khác thực hiện các thao tác ghi như triển khai các thay đổi lược đồ, tạo vai trò hoặc xuất bản các định nghĩa mô hình. Tích hợp Git trực giao với các yêu cầu về công cụ XMLA.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-104",
    "questionNumber": 104,
    "text": "You have a data warehouse containing a table named `Stage.Customers`. It stores every customer-record update from a customer relationship management (CRM) system, and a customer can have multiple updates.  \n  \nYou need a T-SQL query that returns the customer ID, name, postal code, and last-updated time from the most recent row for each customer ID.  \n  \nHow should you complete the code?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "`ROW_NUMBER()` đánh số hàng riêng biệt cho mỗi `CustomerID`. Với `LastUpdated DESC`, hàng được cập nhật gần đây nhất nhận được hàng số 1; `WHERE X = 1` giữ hàng đó cho mọi khách hàng.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "Create a shortcut in the Files section."
      },
      {
        "key": "B",
        "text": "Use the Parquet format"
      },
      {
        "key": "C",
        "text": "Use the CSV format."
      },
      {
        "key": "D",
        "text": "Create a shortcut in the Tables section."
      },
      {
        "key": "E",
        "text": "Use the delta format."
      }
    ],
    "correctAnswers": [
      "D",
  ...
  },
  {
    ...
    "explanation": "Microsoft Fabric warehouse là loại lưu trữ dữ liệu hỗ trợ nguyên bản các truy vấn T-SQL, hoạt động giao dịch nhiều bảng và che giấu dữ liệu động. Lakehouse hỗ trợ Spark và SQL hạn chế; Cơ sở dữ liệu KQL chỉ có truy vấn; mô hình ngữ nghĩa chỉ dành cho phân tích/báo cáo.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Hoạt động Tra cứu là lựa chọn thích hợp để thực thi quy trình được lưu trữ trong warehouse và cung cấp các giá trị trả về cho các hoạt động quy trình xuôi dòng. Nhận siêu dữ liệu lấy thuộc tính đối tượng; Sao chép dữ liệu chuyển dữ liệu giữa các nguồn nhưng không dễ dàng hiển thị đầu ra; Biến nối thêm sửa đổi các biến đường ống. Chỉ Tra cứu được thiết kế để thực hiện các truy vấn/thủ tục và hiển thị kết quả cho các hoạt động tiếp theo.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-109",
    "questionNumber": 109,
    "text": "You have a Fabric tenant that contains a workspace named Workspace1. Workspace1 contains a single semantic model that has two Microsoft Power BI reports.  \n  \nYou have a Microsoft 365 subscription that contains a data loss prevention (DLP) policy named DLP1.  \n  \nYou need to apply DLP1 to the items in Workspace1.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
      ...
      {
        "key": "B",
        "text": "Apply a certified endorsement to the semantic model."
      },
      {
        "key": "C",
        "text": "Apply sensitivity labels to the semantic model and reports."
      },
      {
        "key": "D",
        "text": "Apply a master data endorsement to the semantic model."
      }
    ],
    "correctAnswers": [
      "C"
    ],
    "explanation": "Chính sách ngăn chặn mất dữ liệu (DLP) trong Microsoft 365 được thực thi thông qua nhãn nhạy cảm. Bạn xác định chính sách DLP bằng cách chỉ định các điều kiện dựa trên nhãn nhạy cảm và loại thông tin nhạy cảm. Việc áp dụng nhãn nhạy cảm cho các mô hình và báo cáo ngữ nghĩa cho phép đánh giá và thực thi chính sách DLP đối với các mục đó. Xác nhận và danh tính không gian làm việc giải quyết các mối quan tâm quản trị khác nhau.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "View the Query Timings tab."
      },
      {
        "key": "B",
        "text": "From Performance analyzer, capture a recording."
      },
      {
        "key": "C",
        "text": "Sort the Duration (ms) column in descending order."
      },
      {
        "key": "D",
        "text": "Enable Query Timings and Server Timings. Run the query."
      },
      {
        "key": "E",
        "text": "Sort the Duration (ms) column in descending order by DAX query time."
      },
      {
        "key": "F",
        "text": "Copy the first query to DAX Studio."
      },
      {
        "key": "G",
        "text": "View the Server Timings tab."
      }
    ],
    "choices": [
      {
    ...
    "explanation": "Trình phân tích hiệu suất Power BI ghi lại các hoạt động tải hình ảnh và bao gồm thời lượng truy vấn DAX cho mỗi hình ảnh; sắp xếp theo khoảng thời gian đó sẽ xác định truy vấn DAX chậm nhất. Thời gian máy chủ DAX Studio báo cáo tổng thời gian xử lý của máy chủ và chia thành thời gian Công cụ công thức (FE) và Công cụ lưu trữ (SE), cho phép so sánh công cụ cần thiết.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Tệp cache.abf là bộ đệm nhị phân chứa các giá trị dữ liệu thực tế được lưu trong bộ đệm từ mô hình ngữ nghĩa. Nó có thể rất lớn và chứa các ảnh chụp nhanh dữ liệu không được lưu trữ trong kiểm soát phiên bản. Các tùy chọn khác (unappliedChanges.json, localSettings.json, model.bim) chứa siêu dữ liệu hoặc tệp cấu hình cần thiết cho cấu trúc dự án và phải được giữ nguyên trong kho lưu trữ.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-112",
    "questionNumber": 112,
    "text": "You are designing a Fabric semantic model called Model1 for a financial analytics workspace. Model1 contains a DAX measure named Measure1 that returns total sales.  \n  \nYou have a table named Currency that includes a column named Format. The Format column specifies currency format strings for each record as follows: $#, ##0.00, €#, ##0.00, OR ¥#,##0.00.  \n  \nYou have a report that uses the Currency column to determine which symbol and format string to show. In the report, Measure1 must display two decimal places and the applicable currency symbol based on the value selected in the Currency column.  \n  \nYou create the following DAX formula.  \n  \n`FORMAT = SELECTEDVALUE( ‘Currency’ [Format])`  \n  \nYou need to ensure that Measure displays correctly in visuals. The solution must minimize duplicated logic.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Create a dynamic format string for Measure1 that references the FORMAT measure."
      },
      {
        "key": "B",
        "text": "For Model1, set the data category of Measure1 to Country/Region."
      },
      {
        "key": "C",
        "text": "For Model1, set the format type of Measure1 to Currency."
      },
      {
        "key": "D",
        "text": "Copy the DAX expression from the Format column and paste the expression into the format string expression of Measure1."
      }
    ],
    "correctAnswers": [
      "A"
    ],
    "explanation": "Chuỗi định dạng động cho phép thước đo mô hình vẫn ở dạng số trong khi định dạng được hiển thị của nó thay đổi theo ngữ cảnh bộ lọc. Việc đặt chuỗi định dạng động của Số đo1 để tham chiếu số đo `FORMAT` sử dụng giá trị `Currency[Format]` đã chọn, tạo ra ký hiệu tiền tệ thích hợp và định dạng hai thập phân mà không trùng lặp biểu thức `SELECTEDVALUE`. [Create dynamic format strings for measures](https://learn.microsoft.com/en-us/power-bi/create-reports/desktop-dynamic-format-strings)",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "spark.sql(\"SELECT * FROM Lakehouse1.Tables.ResearchProduct\")"
      },
      {
        "key": "B",
        "text": "spark.read.format(\"delta\").load(\"Tables/productline1/ResearchProduct\")"
  ...
  },
  {
    ...
    "explanation": "Thứ nguyên thay đổi chậm Loại 2 sẽ giữ lại các giá trị lịch sử bằng cách tạo phiên bản mới của bản ghi thứ nguyên. Thứ nguyên thay đổi chậm Loại 1 sẽ ghi đè giá trị thuộc tính hiện có và không giữ lại lịch sử.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-117",
    "questionNumber": 117,
    "text": "A semantic model contains the following tables:  \n  \n- Sales  \n- Product  \n- Location  \n  \nYou are creating a DAX measure named Measure1 to calculate the percentage of all sales for a selected product. Measure1 uses the following DAX formula.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784226204305-tz2xln9f.png)  \n  \nFor each of the following statements, select Yes if the statement is true. Otherwise, select No.",
    "questionType": "statement_matrix",
    "statements": [
      {
        "id": "1",
        "text": "Measure1 will return an error if there are no sales for all products.",
        "correctAnswer": "No"
      },
      {
        "id": "2",
        "text": "Measure1 will return a decimal value that represents the ratio of the current product’s total sales to the total sales across all products.",
        "correctAnswer": "Yes"
      },
      {
        "id": "3",
        "text": "The denominator of Measure1 will be calculated by using the modified filter context created by the REMOVEFILTERS ( 'Product' ) DAX function.",
        "correctAnswer": "Yes"
      }
    ],
    "options": [
    ...
    "explanation": "DIVIDE xử lý mẫu số 0 hoặc BLANK bằng cách trả về BLANK khi kết quả thay thế no được chỉ định, do đó nó không trả về lỗi. Tử số giữ lại bộ lọc sản phẩm hiện tại, trong khi CALCULATE đánh giá mẫu số sau khi REMOVEFILTERS xóa các bộ lọc khỏi bảng Sản phẩm; điều này tạo ra doanh số bán hàng của sản phẩm đã chọn dưới dạng tỷ lệ doanh số bán hàng trên các sản phẩm.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Hoạt động Tra cứu được thiết kế đặc biệt để thực hiện các truy vấn hoặc thủ tục được lưu trữ dựa trên nguồn dữ liệu và truy xuất kết quả cho các hoạt động tiếp theo để sử dụng. Công tắc được sử dụng để phân nhánh logic, KQL truy xuất dữ liệu nhưng không dễ dàng hiển thị đầu ra cho các hoạt động xuôi dòng và Biến nối thêm sửa đổi các biến đường ống. Tra cứu là hoạt động tiêu chuẩn để thực thi các thủ tục được lưu trữ và cung cấp đầu ra cho các hoạt động tiếp theo trong một đường ống.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "Filter the query where the version date value equals the max version date value."
      },
      {
        "key": "B",
        "text": "Remove the max version date column."
      },
      {
        "key": "C",
        "text": "Expand the All Rows detail column."
      },
      {
        "key": "D",
        "text": "Group by CustomerID and calculate the max version date per customer ID."
      },
      {
        "key": "E",
        "text": "Remove duplicates based on CustomerID."
      },
      {
        "key": "F",
        "text": "Group by CustomerID, use the All Rows operation, and calculate the max version date per customer ID."
      }
    ],
    "choices": [
      {
    ...
    "explanation": "Việc nhóm theo ID khách hàng với cả Tất cả các hàng và Ngày phiên bản tối đa sẽ bảo toàn từng bản ghi gốc và tạo giá trị so sánh cho mỗi khách hàng. Việc mở rộng Tất cả các hàng sẽ khôi phục các hàng chi tiết, sau đó việc lọc VersionDate đến mức tối đa của nhóm chỉ giữ lại bản ghi mới nhất. Việc xóa cột ngày tối đa của trình trợ giúp sẽ ngăn không cho nó được tải vào mô hình ngữ nghĩa.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Hàm Table.Profile trong Power Query trả về số liệu thống kê cột toàn diện bao gồm số lượng, số trung bình, số null, số lượng khác biệt, độ lệch chuẩn, giá trị tối thiểu và tối đa. Đây là hàm M tiêu chuẩn được thiết kế để phân tích các cột trong bảng. Table.schema chỉ trả về siêu dữ liệu, Table.view không phải là một hàm tiêu chuẩn và Table.FuzzyGroup dành cho các hoạt động nhóm mờ.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Vai trò Cộng tác viên có thể tạo và sửa đổi nội dung trong không gian làm việc Fabric, bao gồm bảng thông tin, mô hình ngữ nghĩa và báo cáo. Nó cấp các khả năng soạn thảo và xuất bản cần thiết mà không cần có quyền chia sẻ bổ sung của Thành viên hoặc quyền quản lý không gian làm việc của Quản trị viên.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "D",
        "text": "the Microsoft Power BI service"
      },
      {
        "key": "E",
        "text": "Microsoft SQL Server Management Studio (SSMS)"
    ...
    "explanation": "Các phân vùng bảng mô hình ngữ nghĩa có thể được quản lý thông qua điểm cuối XMLA bằng các công cụ hỗ trợ siêu dữ liệu mô hình dạng bảng và tập lệnh TMSL. Tabular Editor và SQL Server Management Studio (SSMS) hỗ trợ việc quản lý phân vùng này; Power BI Desktop và dịch vụ Power BI không trực tiếp hiển thị hoặc quản lý các phân vùng bảng mô hình ngữ nghĩa.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "statements": [
      {
        "id": "1",
        "text": "Dimension.GetDirectReports is a scalar T-SQL function.",
        "correctAnswer": "No"
      },
      {
        "id": "2",
        "text": "The Dimension.GetDirectReports function will run only once when the query runs.",
        "correctAnswer": "No"
      },
      {
        "id": "3",
        "text": "The output rows will include at least one row for each row in the Dimension.Employee table.",
        "correctAnswer": "Yes"
      }
    ],
    "options": [
    ...
    "explanation": "Dimension.GetDirectReports được sử dụng làm nguồn hàng với APPLY, do đó, đây là hàm có giá trị bảng chứ không phải hàm vô hướng. Đối số của nó xuất phát từ mỗi hàng nhân viên hiện tại, tạo ra mối tương quan ỨNG DỤNG trên mỗi hàng bên ngoài thay vì thực thi một hàm trên toàn truy vấn. OUTER APPLY giữ lại mọi hàng nhân viên bên trái; khi các hàng báo cáo trực tiếp no được trả về, các cột gdr là NULL, giữ lại ít nhất một hàng đầu ra cho nhân viên đó.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-124",
    "questionNumber": 124,
    "text": "You have an Azure SQL database named DB1 and a Fabric workspace named Workspace1. Workspace1 contains a lakehouse named LH1 and a Dataflow Gen2 named Dataflow1. Dataflow1 has a query named Query1 that loads data from DB1, transforms the data, and then filters it.  \n  \nYou discover that Query1 loads all data before it applies the transformations.  \n  \nYou need to make sure that Query1 uses query folding.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Remove unused columns from Query1."
      },
      {
        "key": "B",
        "text": "Enable incremental refresh for Query1."
      },
      {
        "key": "C",
        "text": "Replace DB1 with a Microsoft SQL Server database."
      },
      {
        "key": "D",
        "text": "Move the filter steps before the transformation steps in Query1."
      }
    ],
    "correctAnswers": [
      "D"
    ],
    "explanation": "Việc gấp truy vấn sẽ đẩy các hoạt động Power Query được hỗ trợ vào hệ thống nguồn. Việc áp dụng sớm các bộ lọc sẽ cho phép dịch bộ lọc sang truy vấn Azure SQL, do đó, chỉ những hàng bắt buộc mới được truy xuất trước các lần chuyển đổi tiếp theo. Microsoft khuyên bạn nên lọc sớm và thường xuyên để tối ưu hóa việc gấp truy vấn Dataflow Gen2.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "statements": [
      {
        "id": "1",
        "text": "A replica of dbo.FactSales is created in the test schema by copying the metadata only.",
        "correctAnswer": "Yes"
      },
      {
        "id": "2",
        "text": "Additional schema changes to dbo.FactSales will also apply to test.FactSales.",
        "correctAnswer": "No"
      },
      {
        "id": "3",
        "text": "Additional data changes to dbo.FactSales will also apply to test.FactSales.",
        "correctAnswer": "No"
      }
    ],
    "options": [
    ...
    "explanation": "Bản sao bảng Fabric Warehouse là bản sao không sao chép: chỉ siêu dữ liệu được sao chép, trong khi bản sao tham chiếu các tệp dữ liệu cơ bản hiện có. Bản sao độc lập với nguồn của nó, do đó các thay đổi lược đồ DDL sau này và các thay đổi dữ liệu DML đối với nguồn sẽ không truyền tới bảng được sao chép.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-126",
    "questionNumber": 126,
    "text": "You have a Fabric tenant that contains a semantic model named Model1. Model1 uses Import mode. Model1 contains a table named Orders. Orders has 100 million rows and the following fields.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1783709928530-rmypyify.png)  \n  \nYou need to reduce the memory used by Model1 and the time it takes to refresh the model.  \n\nWhich two actions should you perform? Each correct answer presents part of the solution.  \n\nNOTE: Each correct answer is worth one point.",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Split OrderDateTime into separate date and time columns."
      },
      {
        "key": "B",
        "text": "Replace TotalQuantity with a calculated column."
      },
      {
        "key": "C",
        "text": "Convert Quantity into the Text data type."
      },
      {
        "key": "D",
        "text": "Replace TotalSalesAmount with a measure."
      }
    ],
    "correctAnswers": [
      "A",
  ...
  },
  {
    ...
    "options": [],
    "correctAnswers": [],
    "explanation": "CALCULATE thay đổi bối cảnh bộ lọc, trong khi SELECTEDMEASURE() là trình giữ chỗ nhóm tính toán cho bất kỳ thước đo nào hiện được đánh giá. DATESMTD trả về ngày từ đầu tháng hiện tại đến ngày đã chọn, tạo ra kết quả MTD.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-129",
    "questionNumber": 129,
    "text": "Solution: You modify the measure to use the `USEROBJECTID()` function.  \n  \nDoes this achieve the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "`USEROBJECTID()` trả về ID đối tượng Microsoft Entra của người dùng hiện tại thay vì tên chính của người dùng (UPN). `USERPRINCIPALNAME()` là hàm DAX trả về UPN của người dùng.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-130",
    "questionNumber": 130,
    "text": "Solution: You modify the measure to use the `USERPRINCIPALNAME()` function.  \n  \nDoes this achieve the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Hàm DAX `USERPRINCIPALNAME()` trả về tên chính của người dùng (UPN) tại thời điểm kết nối, do đó thước đo sử dụng nó sẽ trả về UPN của người dùng.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-131",
    "questionNumber": 131,
    "text": "Solution: Create a role in the model.  \n  \nDoes this achieve the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Vai trò mô hình ngữ nghĩa cung cấp bối cảnh bảo mật cấp hàng cần thiết để đánh giá RLS động. Trong dịch vụ Fabric, `USERNAME()` trả về tên chính của người dùng đã đăng nhập (UPN) trong ngữ cảnh đó.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-132",
    "questionNumber": 132,
    "text": "Solution: Add user objects to the list of objects synchronized by Microsoft Entra Connect.  \n  \nDoes this accomplish the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "`USERPRINCIPALNAME()` trả về UPN của người dùng đã đăng nhập tại thời điểm kết nối và là hàm DAX rõ ràng để lấy giá trị đó. Việc thay đổi tập hợp đối tượng người dùng được đồng bộ hóa bởi Microsoft Entra Connect không làm thay đổi đánh giá chức năng nhận dạng của mô hình ngữ nghĩa, do đó, nó không đảm bảo rằng thước đo trả về UPN.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "statements": [
      {
        "id": "1",
        "text": "The code embeds an existing Power BI report.",
        "correctAnswer": "No"
      },
      {
        "id": "2",
        "text": "The code creates a Power BI report.",
        "correctAnswer": "Yes"
      },
      {
        "id": "3",
        "text": "The code displays a summary of the DateFrame.",
        "correctAnswer": "Yes"
      }
    ],
    "options": [
    ...
    "explanation": "`QuickVisualize` tạo và hiển thị báo cáo nhanh Power BI mới từ cấu hình DataFrame được cung cấp. Việc nhúng báo cáo hiện có yêu cầu mã định danh báo cáo và lớp `Report`. Hình ảnh được tạo sẽ hiển thị bản tóm tắt dữ liệu DataFrame trong sổ ghi chép.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "spark.read.format(“delta”).load(“Files/ResearchProduct”)"
      },
      {
        "key": "B",
        "text": "spark.sql(“SELECT * FROM Lakehouse1.ResearchProduct ”)"
  ...
  },
  {
    "id": "dp600-136",
    "questionNumber": 136,
    "text": "You have a Fabric warehouse containing a table named `SalesOrderDetail`. `SalesOrderDetail` has three columns named `OrderQty`, `ProductID`, and `SalesOrderlD`. `SalesOrderDetail` has one row for every combination of `SalesOrderlD` and `ProductID`.  \n  \nYou need to calculate the proportion of each sales order’s total quantity that each product represents within that sales order.  \n  \nWhich T-SQL statement should you run?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "![](https://cdn.examcademy.com/images/questions/1785601571652-jexzdjm6.png)"
      },
      {
        "key": "B",
        "text": "![](https://cdn.examcademy.com/images/questions/1785601573845-zy23fp5y.png)"
      },
      {
        "key": "C",
        "text": "![](https://cdn.examcademy.com/images/questions/1785601576061-nf610zmp.png)"
      },
      {
        "key": "D",
        "text": "![](https://cdn.examcademy.com/images/questions/1785601578177-vjngn35o.png)"
      }
    ],
    "correctAnswers": [
      "D"
    ],
    "explanation": "`SUM(OrderQty) OVER (PARTITION BY SalesOrderID)` tính toán tổng số lượng riêng cho từng đơn đặt hàng và no `ORDER BY` có nghĩa là cửa sổ bao gồm mọi hàng theo thứ tự đó. Chia `OrderQty` của mỗi hàng sản phẩm cho tổng số mỗi đơn hàng và nhân với 100 sẽ trả về phần trăm của đơn đặt hàng.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-139",
    "questionNumber": 139,
    "text": "You have a Microsoft Entra tenant named contoso.com and an external user named [email protected].  \n  \nYou have a Fabric workspace named Workspace1 that contains a semantic model named Model1 and a report named Report1.  \n  \n[email protected] has access to Report1.  \n  \nYou enable read-write access on the XML for Analysis (XMLA) endpoint to provide advanced semantic modeling by using DAX Studio.  \n  \nYou need to give [email protected] a URL that enables connectivity by using DAX Studio.  \n  \nHow should you complete the URL?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Máy khách điểm cuối XMLA kết nối với không gian làm việc bằng URL ở định dạng đối tượng thuê/không gian làm việc. Khách B2B truy cập vào không gian làm việc trong một đối tượng thuê khác phải chỉ định tên của đối tượng thuê tài nguyên đó trong URL. Do đó, điểm cuối sử dụng `contoso.com` và `Workspace1`; tên báo cáo hoặc mô hình ngữ nghĩa không phải là một phần của URL này.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-140",
    "questionNumber": 140,
    "text": "You have a Fabric workspace containing a warehouse named DW1. DW1 includes the following tables and columns.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784206736566-rpn6toz2.png)  \n  \nYou need to summarize order quantities by year and product. The solution must include the yearly total of order quantities for all products on each row.  \n  \nHow should you complete the T-SQL statement?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "YEAR trích xuất năm nhóm từ ModifiedDate. ROLLUP với năm đầu tiên và tên sản phẩm thứ hai trả về các hàng chi tiết năm/sản phẩm cộng với một hàng tổng phụ mỗi năm trong đó Tên sản phẩm là NULL và SUM(OrderQty) bao gồm mọi sản phẩm trong năm đó.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-141",
    "questionNumber": 141,
    "text": "You have a Microsoft Power BI semantic model that includes a table named Date. Date contains the following data.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784226204860-822k3ov1.png)  \n  \nYou need to ensure that visuals using the Date table display in chronological order while minimizing administrative effort.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Sort the Month Number column by Column."
      },
      {
        "key": "B",
        "text": "Sort the visuals by using the Sort ascending option on Fiscal Month."
      },
      {
        "key": "C",
        "text": "Sort the Fiscal Month column by Column."
      },
      {
        "key": "D",
        "text": "Sort the Date table by Column."
      }
    ],
    "correctAnswers": [
      "C"
    ],
    "explanation": "Đặt cột Tháng tài chính để sắp xếp theo cột Số tháng. Các giá trị tháng bằng số cung cấp thứ tự thời gian cho tên tháng văn bản và cài đặt sắp xếp ở cấp độ mô hình áp dụng cho mọi hình ảnh sử dụng Tháng tài chính. Tài liệu Microsoft Learn sử dụng cột số tháng để sắp xếp tên tháng theo trình tự thời gian.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-142",
    "questionNumber": 142,
    "text": "You have a Fabric tenant that contains two lakehouses. You are building a dataflow that combines data from the lakehouses. The applied steps for one query in the dataflow are shown in the following exhibit.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1785752056168-fhto1y2c.png)",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Bước không gấp làm cho các phép biến đổi phụ thuộc còn lại được đánh giá bên ngoài nguồn dữ liệu. Viết hoa mỗi từ là một phép chuyển đổi không gấp, do đó, chỉ phần trước được gấp và bước tùy chỉnh Đã thêm sau mới thực thi trong công cụ Microsoft Power Query.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-143",
    "questionNumber": 143,
    "text": "You have a Fabric tenant that contains a lakehouse named Lakehouse1. Lakehouse1 contains a subfolder named Subfolder1 that contains CSV files.  \n\nYou need to convert the CSV files into the delta format that has V-Order optimization enabled.  \n\nWhat should you do from Lakehouse explorer?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Use the Load to Tables feature."
      },
      {
        "key": "B",
        "text": "Create a new shortcut in the Files section."
      },
      {
        "key": "C",
        "text": "Create a new shortcut in the Tables section."
      },
      {
        "key": "D",
        "text": "Use the Optimize feature."
      }
    ],
    "correctAnswers": [
      "A"
    ],
    "explanation": "Tính năng 'Tải vào bảng' trong Lakehouse explorer tự động chuyển đổi tệp CSV sang định dạng Delta Lake với tính năng tối ưu hóa V-Order được bật theo mặc định. Khi sử dụng Tải vào bảng, hệ thống sẽ tạo các bảng Delta được tối ưu hóa với V-Order, giúp cải thiện hiệu suất truy vấn. Tính năng Tối ưu hóa áp dụng cho các bảng hiện có và các phím tắt không thực hiện chuyển đổi định dạng mong muốn.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Hoạt động Tra cứu là lựa chọn thích hợp để thực thi một quy trình được lưu trữ và cung cấp kết quả của nó cho các hoạt động xuôi dòng trong quy trình Data Factory. Nó có thể thực thi các truy vấn hoặc thủ tục được lưu trữ và trả về kết quả (giá trị đơn hoặc mảng) mà các hoạt động xuôi dòng như Sao chép, ForEach hoặc các hoạt động luồng điều khiển khác có thể sử dụng. Biến chuyển đổi và nối thêm phục vụ các mục đích luồng điều khiển khác nhau.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-145",
    "questionNumber": 145,
    "text": "You have a Fabric tenant that contains a workspace named Workspace1. Workspace1 contains a lakehouse named Lakehouse1 and a warehouse named Warehouse1.  \n  \nYou need to create a new table in Warehouse1 named POSCustomers by querying the customer table in Lakehouse1.  \n  \nHow should you complete the T-SQL statement?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Fabric Warehouse sử dụng TẠO BẢNG NHƯ CHỌN (CTAS) để tạo và điền vào bảng từ truy vấn CHỌN. Warehouse có thể truy vấn bảng Lakehouse trong cùng một không gian làm việc bằng cách sử dụng tên ba phần của nó, `lakehouse1.dbo.customer`; `dbo.Customer` sẽ phân giải trong Warehouse hiện tại.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-146",
    "questionNumber": 146,
    "text": "You have a Fabric tenant that uses a Microsoft Power BI Premium capacity.  \n\nYou need to enable scale-out for a semantic model.  \n\nWhat should you do first?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "At the semantic model level, set Large dataset storage format to Off."
      },
      {
        "key": "B",
        "text": "At the tenant level, set Create and use Metrics to Enabled."
      },
      {
        "key": "C",
        "text": "At the semantic model level, set Large dataset storage format to On."
      },
      {
        "key": "D",
        "text": "At the tenant level, set Data Activator to Enabled."
      }
    ],
    "correctAnswers": [
      "C"
    ],
    "explanation": "Kích hoạt định dạng lưu trữ tập dữ liệu lớn ở cấp mô hình ngữ nghĩa là bước tiên quyết đầu tiên để mở rộng quy mô trong Power BI Premium. Định dạng lưu trữ này cho phép mô hình sử dụng các tính năng dung lượng cao cấp bao gồm các bản sao cho các tình huống có tính tương tranh cao. Các tùy chọn khác (tắt định dạng lưu trữ, số liệu và Trình kích hoạt dữ liệu) sẽ tắt chức năng hoặc giải quyết các khả năng không liên quan.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-148",
    "questionNumber": 148,
    "text": "You have a Fabric tenant that contains a complex semantic model. The model is based on a star schema and contains many tables, including a fact table named Sales.  \n\nYou need to create a diagram of the model. The diagram must contain only the Sales table and related tables.  \n\nWhat should you use from Microsoft Power BI Desktop?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Chế độ xem Mô hình trong Máy tính để bàn Power BI được sử dụng để tạo sơ đồ của các mô hình ngữ nghĩa, trực quan hóa các mối quan hệ bảng và phân tích các lược đồ sao phức tạp. Nó cho phép bạn xem và sửa đổi cấu trúc mô hình, bao gồm lọc để chỉ hiển thị bảng Bán hàng và các bảng thứ nguyên liên quan của nó. Chế độ xem dữ liệu và chế độ xem truy vấn DAX phục vụ các mục đích khác nhau (kiểm tra dữ liệu và viết truy vấn), trong khi danh mục dữ liệu là thuộc tính cột chứ không phải công cụ trực quan hóa.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-152",
    "questionNumber": 152,
    "text": "Solution: You use the following PySpark expression:  \n  \n```python  \ndf.explain()  \n```  \n  \nDoes this satisfy the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "`DataFrame.explain()` in các kế hoạch truy vấn logic và vật lý để gỡ lỗi thay vì tính toán thống kê dữ liệu. `DataFrame.describe()` tính toán số lượng, giá trị trung bình, độ lệch chuẩn, mức tối thiểu và tối đa cho tất cả các cột số và chuỗi khi các cột no được chỉ định.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "`DataFrame.show()` in các hàng đầu tiên của DataFrame để kiểm tra; nó không tính toán độ lệch tối thiểu, tối đa, trung bình hoặc tiêu chuẩn cho các cột của nó. Cần phải tổng hợp thống kê hoặc một thao tác tóm tắt để tạo ra các giá trị đó.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-154",
    "questionNumber": 154,
    "text": "Solution: You use this PySpark expression:  \n  \n```python  \ndf.summary()  \n```  \n  \nDoes this achieve the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "PySpark `DataFrame.summary()` tính toán số liệu thống kê cho tất cả các cột số và chuỗi theo mặc định. Đầu ra mặc định của nó bao gồm giá trị trung bình, độ lệch chuẩn, giá trị tối thiểu và tối đa, do đó nó đáp ứng yêu cầu. Đối với các cột chuỗi, số liệu thống kê không áp dụng được, chẳng hạn như giá trị trung bình và độ lệch chuẩn, sẽ được trả về là null.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-155",
    "questionNumber": 155,
    "text": "Solution: Use the following PySpark expression:  \n  \n```python  \ndf.explain().show()  \n```  \n  \nDoes this satisfy the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "`DataFrame.explain()` đưa ra các kế hoạch thực thi vật lý và logic của DataFrame để gỡ lỗi; nó không tính toán số liệu thống kê cột. PySpark `DataFrame.describe()` tính toán số lượng, giá trị trung bình, độ lệch chuẩn, mức tối thiểu và tối đa cho tất cả các cột số và chuỗi khi các cột no được chỉ định.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "PySpark `DataFrame.describe()` tạo ra số liệu thống kê về số lượng, giá trị trung bình, độ lệch chuẩn, tối thiểu và tối đa. Khi các cột no được chỉ định, nó sẽ tính toán các thống kê mô tả này cho mọi cột số hoặc chuỗi trong DataFrame.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "C",
        "text": "CREATE TABLE AS CLONE OF"
      },
      {
        "key": "D",
        "text": "CREATE MATERIALIZED VIEW AS SELECT"
      }
    ],
    "correctAnswers": [
      "B"
    ],
    "explanation": "TẠO BẢNG NHƯ CHỌN (CTAS) là hoạt động tối ưu cho kịch bản này. Nó tạo một bảng mới trực tiếp từ kết quả truy vấn—bao gồm cả các phép nối—và tự động suy ra các loại cột từ bảng nguồn, đảm bảo khớp loại mà không cần các bước bổ sung. CTAS giảm thiểu các hoạt động bằng cách kết hợp việc tạo bảng, tải dữ liệu và định nghĩa lược đồ trong một câu lệnh duy nhất.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-158",
    "questionNumber": 158,
    "text": "You plan to deploy Microsoft Power BI items by using Fabric deployment pipelines. You have a deployment pipeline that contains three stages named Development, Test, and Production. A workspace is assigned to each stage.  \n\nYou need to provide Power BI developers with access to the pipeline. The solution must meet the following requirements:  \n\nEnsure that the developers can deploy items to the workspaces for Development and Test.  \n\nPrevent the developers from deploying items to the workspace for Production.  \n\nFollow the principle of least privilege.  \n\nWhich three levels of access should you assign to the developers? Each correct answer presents part of the solution.  \n\nNOTE: Each correct answer is worth one point.",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Build permission to the production semantic models"
      },
      {
        "key": "B",
        "text": "Admin access to the deployment pipeline"
      },
      {
        "key": "C",
        "text": "Viewer access to the Development and Test workspaces"
      },
      {
        "key": "D",
        "text": "Viewer access to the Production workspace"
      },
      {
        "key": "E",
        "text": "Contributor access to the Development and Test workspaces"
      },
      {
        "key": "F",
        "text": "Contributor access to the Production workspace"
      }
    ],
    "correctAnswers": [
      "B",
  ...
  },
  {
    "id": "dp600-159",
    "questionNumber": 159,
    "text": "You have a Fabric workspace named Workspace1 that contains a semantic model and a report named Report1. Workspace1 is connected to a Git repository named Git1.  \n  \nYou have a deployment pipeline with three stages named Development, Test, and Production.  \n  \nYou need to publish Report1 to the Production stage.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Run a Git commit."
      },
      {
        "key": "B",
        "text": "Run a full deployment."
      },
      {
        "key": "C",
        "text": "Sync Workspace1 with Git1."
      },
      {
        "key": "D",
        "text": "Run a backward deployment."
      }
    ],
    "correctAnswers": [
      "B"
    ],
    "explanation": "Quy trình triển khai kết cấu thúc đẩy nội dung không gian làm việc qua các giai đoạn phát triển, thử nghiệm và sản xuất. Triển khai đầy đủ sẽ triển khai nội dung đến giai đoạn mục tiêu. Các hoạt động đồng bộ hóa và cam kết Git quản lý việc kiểm soát phiên bản thay vì quảng bá quy trình và việc triển khai ngược sẽ chuyển nội dung từ giai đoạn sau sang giai đoạn trước đó.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-160",
    "questionNumber": 160,
    "text": "You have a Fabric workspace named Workspace1 that includes a lakehouse named Lakehouse1 and a user named User1.  \n  \nYou need to ensure that User1 can read all data in Lakehouse1. The solution must adhere to the principle of least privilege.  \n  \nWhich two actions should you take? Each correct answer represents part of the solution.  \n  \nNOTE: Each correct selection is worth one point.",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Assign the Contributor role to User1."
      },
      {
        "key": "B",
        "text": "Select Read all Apache Spark."
      },
      {
        "key": "C",
        "text": "Assign the Viewer role to User1."
      },
      {
        "key": "D",
        "text": "Share Lakehouse1 by using item permissions."
      },
      {
        "key": "E",
        "text": "Assign the Member role to User1."
      }
    ],
    "correctAnswers": [
      "B",
  ...
  },
  {
    "id": "dp600-161",
    "questionNumber": 161,
    "text": "You have a Fabric tenant that contains a lakehouse named LH1.  \n  \nYou need to deploy a new semantic model. The solution must meet these requirements:  \n  \n- Support complex calculated columns that include aggregate functions, calculated tables, and Multidimensional Expressions (MDX) user hierarchies.  \n- Minimize page rendering times.  \n  \nHow should you configure the model?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Import mode hỗ trợ bộ tính năng mô hình ngữ nghĩa đầy đủ cần thiết cho các cột được tính toán phức tạp, bảng được tính toán và phân cấp người dùng MDX. Việc bật bộ nhớ đệm truy vấn có thể giảm thời gian hiển thị trang báo cáo bằng cách cung cấp các kết quả truy vấn lặp lại từ bộ nhớ đệm.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-164",
    "questionNumber": 164,
    "text": "You have a Fabric tenant that contains the semantic model shown in this exhibit.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1785752210280-o4beerhf.png)",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "**Hành vi Direct Lake** của mô hình được đặt thành Chỉ Direct Lake, vô hiệu hóa hoàn toàn dự phòng thành DirectQuery: mọi truy vấn đều được trả lời ở chế độ Direct Lake và dữ liệu không thể tải sẽ trả về lỗi thay vì chuyển đổi âm thầm. **Vai trò (0)** nghĩa là tồn tại các vai trò mô hình ngữ nghĩa no, do đó, cả bảo mật cấp hàng và cấp đối tượng đều không được xác định.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-165",
    "questionNumber": 165,
    "text": "You have a Fabric tenant containing a data warehouse named DW1. DW1 includes a table named DimCustomer, with the fields shown here.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1784206194971-cthlihyn.png)  \n  \nYou need to identify duplicate email addresses in DimCustomer, returning no more than 1,000 records.  \n  \nWhich four T-SQL statements should be run in sequence?",
    "questionType": "matching_drag_drop",
    "statements": [
      {
        "id": "1",
    ...
    "options": [
      {
        "key": "A",
        "text": "SELECT TOP(1000) CustomerAltKey, COUNT(*)"
      },
      {
        "key": "B",
        "text": "GROUP BY CustomerAltKey"
      },
      {
        "key": "C",
        "text": "FROM DimCustomer"
      },
      {
        "key": "D",
        "text": "SELECT CustomerAltKey, COUNT(*)"
      },
      {
        "key": "E",
        "text": "LIMIT 1000"
    ...
    "explanation": "Các giá trị email trùng lặp được xác định bằng cách nhóm trên CustomerAltKey và chỉ giữ lại các nhóm có số lượng vượt quá một. T-SQL sử dụng mệnh đề HAVING cho các bộ lọc tổng hợp và TOP (1000) giới hạn kết quả ở tối đa 1.000 hàng.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-168",
    "questionNumber": 168,
    "text": "You have a Fabric tenant that contains a workspace named Workspace1. Workspace1 includes a lakehouse named LH1 and a warehouse named DW1. LH1 has a table named signindata in the dbo schema.  \n  \nYou need to create a stored procedure in DW1 that deduplicates the data in the signindata table.  \n  \nHow should you complete the T-SQL statement?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "BEGIN và END phân định nội dung thủ tục được lưu trữ. DISTINCT chỉ trả về các kết hợp duy nhất của PersonID, FirstName và LastName, do đó loại bỏ các hàng kết quả trùng lặp. GROUP BY sẽ yêu cầu một danh sách nhóm, trong khi TOP (100) PERCENT WITH TIES không loại bỏ các hàng trùng lặp.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-169",
    "questionNumber": 169,
    "text": "You have a Microsoft Power BI semantic model that contains measures. The measures use multiple CALCULATE functions and a FILTER function.  \n  \nYou are evaluating the performance of the measures.  \n  \nIn which use case will replacing the FILTER function with the KEEPFILTERS function reduce execution time?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "when the FILTER function uses a nested calculate function"
      },
      {
        "key": "B",
        "text": "when the FILTER function references a measure"
      },
      {
        "key": "C",
        "text": "when the FILTER function references columns from multiple tables"
      },
      {
        "key": "D",
        "text": "when the FILTER function references a column from a single table that uses Import mode"
      }
    ],
    "correctAnswers": [
      "D"
    ],
    "explanation": "Biểu thức Boolean (được KEEPFILTERS bao bọc) chỉ có thể thay thế hàm LỌC khi nó tham chiếu đến một cột từ một bảng duy nhất, không tham chiếu một thước đo và không yêu cầu TÍNH TOÁN lồng nhau — các hạn chế loại trừ các tùy chọn A, B và C. Khi các điều kiện đó được đáp ứng trên một cột từ bảng Chế độ nhập, công cụ có thể lọc trực tiếp kho lưu trữ cột trong bộ nhớ thay vì cụ thể hóa bảng trung gian, đây là nơi mang lại hiệu suất.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "a shared access signature (SAS) token and the branch name of Repo1"
      },
      {
        "key": "B",
        "text": "a personal access token (PAT) and the URL of Repo1"
      },
      {
        "key": "C",
        "text": "an access key and the branch name of Repo1"
      },
      {
        "key": "D",
        "text": "an access key and the URL of Repo1"
      }
    ],
    "correctAnswers": [
      "B"
    ],
    "explanation": "Fabric kết nối với GitHub bằng cách sử dụng mã thông báo truy cập cá nhân GitHub (PAT) để xác thực và URL kho lưu trữ để xác định kho lưu trữ. Mã thông báo SAS và khóa truy cập không phải là phương thức xác thực GitHub.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-171",
    "questionNumber": 171,
    "text": "You have a Fabric tenant containing a warehouse named Warehouse1. Warehouse1 contains three schemas named schemaA, schemaB, and schemaC.  \n  \nYou need to ensure that a user named User1 can truncate tables in schemaA only. How should you complete the T-SQL statement?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "BẢNG TRUNCATE yêu cầu quyền THAY ĐỔI trên bảng. Việc cấp ALTER trên SCHEMA::schemaA sẽ áp dụng quyền đó cho các bảng trong lược đồA, trong khi lược đồB và lược đồC nhận được sự cấp phép đó của no.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "Set the autoCompact table setting."
      },
      {
        "key": "B",
        "text": "Set the optimizeWrite table setting."
      },
      {
        "key": "C",
        "text": "Run the VACUUM command on a schedule."
      },
      {
        "key": "D",
        "text": "Set the autoCompact SparkSession setting."
      },
      {
        "key": "E",
        "text": "Run the OPTIMIZE command on a schedule."
      },
      {
        "key": "F",
        "text": "Set the parallelDelete SparkSession setting."
      }
    ],
    "choices": [
      {
    ...
    "explanation": "VACUUM xóa vĩnh viễn các tệp dữ liệu Delta được tham chiếu no lâu hơn và đã vượt qua ngưỡng lưu giữ. OPTIMIZE nén các tệp nhỏ thành các tệp lớn hơn để giảm phân mảnh và cải thiện hiệu suất đọc; việc nhập định kỳ đảm bảo chạy cả hai lệnh bảo trì theo lịch trình.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Miền mặc định chỉ định các không gian làm việc đủ điều kiện cho miền Fabric; nó không gán vai trò không gian làm việc. Mặc dù các thành viên nhóm được chỉ định có thể trở thành người đóng góp miền cho các không gian làm việc được chỉ định thông qua cơ chế miền mặc định, nhưng người đóng góp miền không giống như vai trò Người đóng góp hoặc Người xem của không gian làm việc. Do đó, cả User2 và User3 đều không nhận được vai trò không gian làm việc trong Workspace3 và User3 đều không nhận được vai trò Người đóng góp no trong Workspace1.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-174",
    "questionNumber": 174,
    "text": "Solution: Run the following Spark SQL statement:  \n  \n```sql  \nDESCRIBE HISTORY customer -  \n```  \n  \nDoes this achieve the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
  ...
  },
  {
    "id": "dp600-175",
    "questionNumber": 175,
    "text": "Solution: You run the following Spark SQL statement:  \n  \n```sql  \nREFRESH TABLE customer  \n```  \n  \nDoes this satisfy the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "`REFRESH TABLE` vô hiệu hóa dữ liệu và siêu dữ liệu được lưu trong bộ nhớ đệm để các truy vấn tiếp theo sử dụng trạng thái bảng hiện tại. Nó không cung cấp lịch sử nhiệm vụ bảo trì hoặc cho biết liệu các hoạt động bảo trì có được thực hiện trên bảng Delta hay không.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-177",
    "questionNumber": 177,
    "text": "Solution: You execute the following Spark SQL statement:  \n  \n```sql  \nDESCRIBE DETAIL customer -  \n```  \n  \nDoes this achieve the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "`DESCRIBE DETAIL` trả về thông tin lưu trữ và siêu dữ liệu Delta cấp bảng hiện tại, chứ không phải lịch sử hoạt động và bảo trì-giao dịch của bảng. Cần có `DESCRIBE HISTORY` để xác định xem các hoạt động bảo trì, chẳng hạn như `OPTIMIZE` hoặc `VACUUM`, có được thực hiện hay không.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "C",
        "text": "The data type of the column used to partition the data has changed."
      },
      {
        "key": "D",
        "text": "Only refresh complete days is selected."
    ...
    "explanation": "Việc làm mới tăng dần phụ thuộc vào việc gấp truy vấn để đẩy các bộ lọc phân vùng trở lại nguồn để chỉ truy xuất các phạm vi ngày cần thiết. Khi việc gấp không xảy ra, công cụ mashup phải kéo toàn bộ bảng vào bộ nhớ và lọc chúng cục bộ, điều này làm tăng mức tiêu thụ CPU và bộ nhớ, đồng thời có thể làm cạn kiệt giới hạn tài nguyên của dung lượng F64 trong quá trình làm mới, đặc biệt là với 30 tệp đang được xử lý.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-180",
    "questionNumber": 180,
    "text": "You have a Fabric tenant containing a workspace named Workspace1. Workspace1 includes a warehouse named DW1, which contains two tables: Employees and Sales. All users have read access to DW1.  \n  \nYou need to implement access controls that meet these requirements:  \n  \n- For the Sales table, ensure users can view only sales data from their own region.  \n- For the Employees table, restrict all Personally Identifiable Information (PII).  \n- Preserve access to unrestricted data for all users.  \n  \nWhat should you use for each table?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Bảo mật cấp hàng lọc các hàng trong bảng theo khu vực được phép của người dùng truy vấn, do đó, nó giới hạn các bản ghi Bán hàng theo khu vực. Bảo mật cấp cột hạn chế quyền truy cập vào các cột PII được chỉ định trong khi vẫn giữ quyền truy cập vào các cột không bị hạn chế của bảng Nhân viên. Các quyền về mục và không gian làm việc kiểm soát quyền truy cập rộng hơn và không thể cung cấp các hạn chế dành riêng cho hàng và cột này.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "D",
        "text": "Update the data in Table1."
      }
    ],
    "correctAnswers": [
      "A"
    ],
    "explanation": "Điểm cuối phân tích SQL của lakehouse hoạt động ở chế độ chỉ đọc và chỉ có thể truy cập các bảng được quản lý. Bảng1 (Bảng Delta qua phím tắt) và Bảng2 (bảng bên ngoài qua Spark) không hiển thị hoặc không thể đọc được thông qua điểm cuối SQL. Table3, là một bảng được quản lý, có thể được đọc qua điểm cuối SQL. Không được phép cập nhật, chèn và ghi qua SQL.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "D",
        "text": "the access key ID"
      },
      {
        "key": "E",
        "text": "the certificate thumbprint"
      }
    ],
    "correctAnswers": [
      "B",
    ...
    "explanation": "Xác thực AWS S3 cho phím tắt OneLake yêu cầu ID khóa truy cập (D) và Khóa truy cập bí mật (B). Mã thông báo SAS được sử dụng để xác thực lưu trữ Azure; 'ID truy cập' không phải là thuật ngữ thông tin xác thực AWS tiêu chuẩn; dấu vân tay chứng chỉ được sử dụng cho các phương pháp xác thực khác. Hai giá trị này tạo thành bộ thông tin xác thực hoàn chỉnh cần thiết để xác thực với bộ chứa S3.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-185",
    "questionNumber": 185,
    "text": "You have a Fabric workspace named Workspace1 that contains an eventstream named Eventstream1.  \n  \nEventstream1 reads data from an Azure event hub named Eventhub1.  \n  \nEventhub1 contains the following columns.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1783713072188-9swfoyew.png)  \n  \nYou need to add a continuous percentile calculation to the Payload column. The solution must minimize development effort.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Add a KQL queryset to Workspace1."
      },
      {
        "key": "B",
        "text": "Add a Group by transformation to Eventstream1."
      },
      {
        "key": "C",
        "text": "Add a Manage fields transformation to Eventstream1."
      },
      {
        "key": "D",
        "text": "Add an Aggregate transformation to Eventstream1."
      }
    ],
    "correctAnswers": [
      "D"
    ],
    "explanation": "Chuyển đổi tổng hợp trong luồng sự kiện Fabric cung cấp các hàm phân vị tích hợp để truyền dữ liệu với cấu hình tối thiểu. Bộ truy vấn KQL yêu cầu mã tùy chỉnh; Nhóm theo không tính phần trăm; Quản lý các trường chỉ xử lý việc lựa chọn cột.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Biểu thức CASE được tìm kiếm sẽ đánh giá các mệnh đề WHEN của nó theo thứ tự, trả về kết quả được liên kết với điều kiện đúng đầu tiên, sử dụng ELSE khi không khớp và kết thúc bằng END. Do đó, điều kiện giá bằng 0 được xử lý trước điều kiện dưới 50; giá từ 50 đến 249.999. nhận kết quả Dưới $250; và 250 trở lên nhận được $250+.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [],
    "correctAnswers": [],
    "explanation": "Viewer là vai trò không gian làm việc có ít đặc quyền nhất, cấp quyền truy cập đọc thông qua kho và điểm cuối phân tích SQL, đáp ứng yêu cầu điểm cuối SQL cho bảng, kho và dữ liệu hiển thị lối tắt lakehouse. Quyền truy cập Lakehouse Explorer yêu cầu vai trò có thể truy cập trực tiếp vào dữ liệu lakehouse; Contributor cung cấp khả năng đó, trong khi Viewer bị giới hạn ở khả năng đọc bảng thông qua điểm cuối phân tích SQL.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "FULL OUTER JOIN trả về tất cả các hàng từ cả hai bảng, các hàng khớp với điều kiện nối được đáp ứng và bao gồm các hàng chưa khớp từ cả hai phía. Các phép nối bên trong chỉ trả về các hàng khớp; các phép nối ngoài bên trái và bên phải bao gồm tất cả các hàng từ một bảng và khớp với bảng kia; chống tham gia loại trừ các trận đấu. Toàn bộ bên ngoài là loại kết nối duy nhất đáp ứng được yêu cầu.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-191",
    "questionNumber": 191,
    "text": "You have a Fabric workspace named Workspace1 and an Azure SQL database.  \n  \nYou plan to create a dataflow that will read data from the database, and then transform the data by performing an inner join.  \n  \nYou need to ignore spaces in the values when performing the inner join. The solution must minimize development effort.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Append the queries by using fuzzy matching."
      },
      {
        "key": "B",
        "text": "Merge the queries by using fuzzy matching."
      },
      {
        "key": "C",
        "text": "Append the queries by using a lookup table."
      },
      {
        "key": "D",
        "text": "Merge the queries by using a lookup table."
      }
    ],
    "correctAnswers": [
      "B"
    ],
    "explanation": "Việc hợp nhất các truy vấn bằng cách sử dụng kết hợp mờ là cách tiếp cận chính xác để thực hiện phép nối bên trong trong khi bỏ qua khoảng trắng trong các giá trị. Kết hợp mờ xử lý những khác biệt nhỏ như khoảng trắng thừa mà không yêu cầu xử lý trước dữ liệu thủ công. 'Hợp nhất' là thao tác nối (không giống như 'Nối' là thao tác kết hợp) và việc so khớp mờ giảm thiểu nỗ lực phát triển bằng cách loại bỏ nhu cầu chuyển đổi cắt xén/dọn dẹp riêng biệt.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-193",
    "questionNumber": 193,
    "text": "You have a Fabric semantic model named Model1 that includes a table named Sales.  \n  \nYou need to enable incremental refresh for the Sales table.  \n  \nWhat should you do first?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Move Model1 to Premium Per User (PPU) workspace."
      },
      {
        "key": "B",
        "text": "Create parameters in Power Query."
      },
      {
        "key": "C",
        "text": "From Settings, set Large semantic model storage format to On."
      },
      {
        "key": "D",
        "text": "Automate the data preparation by using Dataflow Gen2."
      }
    ],
    "correctAnswers": [
      "B"
    ],
    "explanation": "Làm mới tăng dần yêu cầu các tham số Ngày/Giờ Power Query có tên `RangeStart` và `RangeEnd` để xác định cửa sổ làm mới. Truy vấn Bán hàng phải sử dụng các tham số này trong bộ lọc dựa trên ngày trước khi có thể đặt cấu hình chính sách làm mới gia tăng.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "Refresh Model1 in the test stage."
      },
      {
        "key": "B",
        "text": "Run Pipeline1 from the development stage to the test stage."
      },
      {
        "key": "C",
        "text": "Refresh Model1 in the development stage."
      },
      {
        "key": "D",
        "text": "Run Pipeline1 from the test stage to the production stage."
      },
      {
        "key": "E",
        "text": "Refresh Model1 in the production stage."
      }
    ],
    "choices": [
      {
    ...
    "explanation": "Quy trình triển khai vải chỉ triển khai nội dung giữa các giai đoạn liền kề, do đó, mô hình ngữ nghĩa đã sửa đổi phải được thúc đẩy từ giai đoạn phát triển sang thử nghiệm, sau đó từ thử nghiệm sang sản xuất. Việc triển khai sao chép siêu dữ liệu của mô hình ngữ nghĩa thay vì dữ liệu ở chế độ Nhập; làm mới dữ liệu tải mô hình ngữ nghĩa sản xuất cho mô hình đã triển khai. Việc làm mới quá trình phát triển hoặc thử nghiệm sẽ không làm thay đổi có sẵn trong quá trình sản xuất.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "C",
        "text": "Assign the Admin role to yourself."
      },
      {
        "key": "D",
        "text": "Assign the Contributor role to each finance department user."
      }
    ],
    "correctAnswers": [
      "A",
    ...
    "explanation": "Để đáp ứng các yêu cầu, hãy thực hiện hai hành động: (A) Chỉ định vai trò Cộng tác viên cho Nhóm1 để cấp cho tất cả người dùng bộ phận tài chính quyền tạo và chỉnh sửa một cách hiệu quả—tư cách thành viên nhóm giảm thiểu chi phí quản trị. (B) Tạo danh tính không gian làm việc để thiết lập managed identity cho Workspace1, cho phép xác thực an toàn đối với storage1 mà không cần lưu trữ thông tin xác thực. Bạn tự động trở thành quản trị viên không gian làm việc khi tạo, vì vậy option C là không cần thiết.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-198",
    "questionNumber": 198,
    "text": "Solution: You replace line 4 with the following code:  \n  \n```DAX  \nNOT ISEMPTY ( CALCULATETABLE ( 'Order Item ' ) )  \n```  \n  \nDoes this achieve the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "`CALCULATETABLE` đánh giá `'Order Item '` trong ngữ cảnh bộ lọc hiện tại và `ISEMPTY` kiểm tra xem bảng kết quả có các hàng no hay không. Do đó, `NOT ISEMPTY(.)` đúng chính xác khi khách hàng hiện tại có ít nhất một hàng mục đơn hàng—cùng điều kiện với `COUNTROWS(.) > 0`. Bởi vì điều này chỉ yêu cầu kiểm tra sự tồn tại thay vì tính toán số hàng đầy đủ nên nó có thể giảm thời gian thực hiện truy vấn.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "`FILTER` đánh giá điều kiện Boolean của nó cho mỗi hàng trong bảng đầu vào. Vì `COUNTROWS('Order Item')` không thể âm nên điều kiện `>= 0` bao gồm mọi khách hàng, kể cả những khách hàng không có mặt hàng đặt hàng, trong khi vẫn giữ lại đánh giá `CALCULATE`/`COUNTROWS` cho mỗi khách hàng. Vì vậy, nó không loại bỏ được mẫu vòng lặp đắt tiền hoặc mang lại sự cải thiện hiệu suất cần thiết. Microsoft khuyến nghị các đối số bộ lọc Boolean nếu có thể vì các biểu thức bảng được trả về bởi `FILTER` được đánh giá theo từng hàng.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-200",
    "questionNumber": 200,
    "text": "Solution: Replace line 4 with the following code:  \n  \n```DAX  \nISEMPTY ( RELATEDTABLE ( 'Order Item' ) )  \n```  \n  \nDoes this satisfy the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "`COUNTROWS('Order Item') > 0` giữ lại những khách hàng có ít nhất một hàng mục đơn hàng liên quan. `RELATEDTABLE('Order Item')` trả về các hàng liên quan trong ngữ cảnh hiện tại, trong khi `ISEMPTY` chỉ trả về `TRUE` khi bảng đó có các hàng no. Do đó, việc thay thế sẽ đảo ngược kết quả lọc và không duy trì hành vi truy vấn được yêu cầu; một bài kiểm tra tương đương về mặt ngữ nghĩa sẽ cần `NOT ISEMPTY(.)`.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "`COUNTROWS` trả về số hàng không âm (hoặc BLANK khi tồn tại các hàng no). Do đó, `CALCULATE(COUNTROWS('Order Item')) < 0` không bao giờ đúng và sự phủ định của nó thừa nhận mọi khách hàng thay vì hạn chế kết quả đối với những khách hàng có một hoặc nhiều mặt hàng đặt hàng. Việc thay thế không tương đương với bộ lọc được yêu cầu và không đáp ứng được mục tiêu.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-202",
    "questionNumber": 202,
    "text": "You have a Fabric tenant that contains a workspace named Workspace1. Workspace1 uses Pro license mode and contains a semantic model named Model1.  \n  \nYou need to ensure that Model1 supports XMLA connections.  \n  \nWhich setting should modify?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Users can edit data models in the Power BI service"
      },
      {
        "key": "B",
        "text": "Enforce strict access control for all data connection types"
      },
      {
        "key": "C",
        "text": "Enable Cache for Shortcuts"
      },
      {
        "key": "D",
        "text": "License mode"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "the SQL analytics endpoint settings"
      },
      {
        "key": "B",
        "text": "the semantic model settings"
      },
      {
        "key": "C",
        "text": "the workspace settings"
      },
      {
        "key": "D",
        "text": "the Lakehouse1 settings"
      }
    ],
    "correctAnswers": [
      "A"
    ],
    "explanation": "Mô hình ngữ nghĩa Power BI mặc định mà Fabric tạo cho lakehouse được giữ đồng bộ hóa thông qua cài đặt hiển thị trên điểm cuối phân tích SQL (Cài đặt > Mô hình ngữ nghĩa Power BI mặc định > \"Đồng bộ hóa mô hình ngữ nghĩa Power BI mặc định\"); việc tắt tính năng này sẽ ngăn các bảng lakehouse mới được thêm tự động vào mô hình mặc định đó. Cài đặt riêng của mô hình ngữ nghĩa không kiểm soát hành vi tự động đồng bộ hóa của bảng này.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "C",
        "text": "spark.sql(“SELECT * FROM Lakehouse1.productline1.ResearchProduct”)"
      },
      {
        "key": "D",
        "text": "spark.read.format(“delta”).load(“Tables/productline1/ResearchProduct”)"
  ...
  },
  {
    "id": "dp600-207",
    "questionNumber": 207,
    "text": "You have a Fabric tenant containing a workspace named Workspace1. Workspace1 includes a data pipeline named Pipeline1 and a lakehouse named Lakehouse1.  \n  \nYou take the following actions:  \n  \n- Create a workspace named Workspace2.  \n- Create a deployment pipeline named DeployPipeline1 to deploy items from Workspace1 to Workspace2.  \n- Add a folder named Folder1 to Workspace1.  \n- Move Lakehouse1 into Folder1.  \n- Run DeployPipeline1.  \n  \nWhat structure will Workspace2 have after DeployPipeline1 completes?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "\\Folder1\\Pipeline1\\Folder1\\Lakehouse1"
      },
      {
        "key": "B",
        "text": "\\Pipeline1\\Lakehouse1"
      },
      {
        "key": "C",
        "text": "\\Pipeline1\\Folder1\\Lakehouse1"
      },
      {
        "key": "D",
        "text": "\\Folder1\\Lakehouse1"
      }
    ],
    "correctAnswers": [
      "C"
    ],
    "explanation": "Quy trình triển khai Microsoft Fabric sao chép các mục nguồn đã chọn vào giai đoạn đích và tự động áp dụng hệ thống phân cấp thư mục của các mục đã triển khai. Do đó, Pipeline1 vẫn ở gốc không gian làm việc và Lakehouse1 được tạo trong Thư mục1.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-208",
    "questionNumber": 208,
    "text": "You have a Fabric workspace named Workspace1 and an Azure Data Lake Storage Gen2 account named storage1. Workspace1 contains a lakehouse named Lakehouse1.  \n  \nYou need to create a shortcut to storage1 in Lakehouse1.  \n  \nWhich connection and endpoint should you specify?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Phím tắt ADLS Gen2 trong Fabric lakehouse phải sử dụng điểm cuối DFS của tài khoản lưu trữ. Do đó, điểm cuối bắt buộc là `dfs` và URL điểm cuối sử dụng giao thức `https`.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-210",
    "questionNumber": 210,
    "text": "You create a semantic model by using Microsoft Power BI Desktop. The model contains one security role named SalesRegionManager and the following tables:  \n  \n- Sales  \n- SalesRegion  \n- SalesAddress  \n  \nYou need to modify the model so that users assigned to the SalesRegionManager role cannot view the column named Address in SalesAddress.  \n  \nWhich three actions should you perform, in sequence?",
    "questionType": "matching_drag_drop",
    "statements": [
      {
        "id": "step1",
    ...
    "options": [
      {
        "key": "A",
        "text": "Open the model in Power BI Desktop."
      },
      {
        "key": "B",
        "text": "Open the model in Tabular Editor."
      },
      {
        "key": "C",
        "text": "Select the Address column in SalesAddress."
      },
      {
        "key": "D",
        "text": "Set the Hidden property to True."
      },
      {
        "key": "E",
        "text": "Set Object Level Security to Default for SalesRegionManager."
      },
      {
        "key": "F",
        "text": "Set Object Level Security to None for SalesRegionManager."
      }
    ],
    "choices": [
      {
    ...
    "explanation": "Bảo mật cấp đối tượng có vai trò cụ thể và phải từ chối cột dành cho SalesRegionManager. Trong Trình soạn thảo dạng bảng, việc gán Bảo mật cấp đối tượng thành Không cho SalesAddress[Địa chỉ] sẽ ngăn các thành viên của vai trò đó nhìn thấy hoặc truy vấn cột. Thuộc tính Ẩn là cài đặt bản trình bày, không phải là ranh giới bảo mật.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-211",
    "questionNumber": 211,
    "text": "You have a Fabric tenant that contains a lakehouse named Lakehouse1. Lakehouse1 includes a Delta table with eight columns.  \n  \nYou receive new data containing those same eight columns plus two additional columns.  \n  \nYou create a Spark DataFrame, assign it to the variable `df`, and it contains the new data.  \n  \nYou need to add the new data to the Delta table while meeting these requirements:  \n  \n- Keep every existing row.  \n- Ensure all new data is added to the table.  \n  \nHow should you complete the code?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "`append` bảo toàn các hàng trong bảng Delta hiện có trong khi chèn các hàng DataFrame. Vì dữ liệu đến giới thiệu hai cột mới nên việc bật `mergeSchema` sẽ phát triển lược đồ bảng Delta để có thể ghi các cột đó. `overwriteSchema` áp dụng cho các thao tác thay thế/ghi đè, không áp dụng cho thao tác nối thêm này.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-214",
    "questionNumber": 214,
    "text": "You have a Fabric workspace named Workspace1 that uses the Premium Per User (PPU) license mode and contains a semantic model named Model1.  \n  \nLarge semantic model storage format is selected for Model1.  \n  \nYou need to make sure that tables imported into Model1 are automatically written as Delta tables in OneLake.  \n  \nWhat should you do for Model1 and Workspace1?",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Tích hợp OneLake xuất các bảng mô hình ngữ nghĩa đã nhập sang các bảng Delta trong OneLake và được bật trong cài đặt mô hình ngữ nghĩa. Nó yêu cầu không gian làm việc sử dụng dung lượng Power BI Premium hoặc Microsoft Fabric được hỗ trợ; Premium Per User rõ ràng không được hỗ trợ. Bộ nhớ đệm truy vấn, mở rộng quy mô truy vấn, nhận dạng không gian làm việc và mã thông báo SAS do người dùng ủy quyền không cho phép khả năng xuất mô hình ngữ nghĩa này.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-215",
    "questionNumber": 215,
    "text": "You have a Fabric tenant containing a workspace named Workspace1 and a user named DBUser. Workspace1 includes a lakehouse named Lakehouse1. DBUser does **not** have tenant access.  \n  \nYou grant DBUser access to Lakehouse1 as shown.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1785752444674-4rn349u9.png)",
    "questionType": "multiple_choice",
    "options": [],
    "correctAnswers": [],
    "explanation": "Quyền Đọc tất cả Apache Spark cấp quyền truy cập vào dữ liệu lakehouse thông qua API Apache Spark và OneLake. Trình thám hiểm tệp OneLake sử dụng quyền truy cập OneLake. Quyền truy cập điểm cuối phân tích SQL thông qua các công cụ T-SQL như SSMS yêu cầu quyền Đọc tất cả dữ liệu điểm cuối SQL riêng biệt, quyền này không được cấp.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "explanation": "Người đóng góp cho phép tạo và sửa đổi nội dung và dữ liệu của không gian làm việc mà không được phép thêm thành viên. Quản trị viên là vai trò quản lý cài đặt không gian làm việc. Thành viên cho phép ghi dữ liệu và thêm thành viên hoặc người dùng có quyền thấp hơn nhưng không cho phép cập nhật hoặc xóa không gian làm việc.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    "id": "dp600-218",
    "questionNumber": 218,
    "text": "You have a Fabric warehouse that contains a table named Table1. Table1 contains three columns named SalesAmount, ProductCategory, and TransactionDate.  \n  \nYou need to create a Microsoft Power BI query that will calculate the total sales amount of each product category for transactions that occurred during the last quarter.  \n  \nWhich two actions should you perform in the visual query editor? Each correct answer presents part of the solution.  \n  \nNOTE: Each correct selection is worth one point.",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "For the TransactionDate column, select Remove duplicates."
      },
      {
        "key": "B",
        "text": "For the TransactionDate column, select Keep top rows and set Number of rows to 90."
      },
      {
        "key": "C",
        "text": "For the TransactionDate column, select Filter rows and set the value to last quarter."
      },
      {
        "key": "D",
        "text": "For the ProductCategory column, select Group by and sum the SalesAmount column."
      },
      {
        "key": "E",
        "text": "For the SalesAmount column, select Transformation number column - Standard, select Add, and then set the value to 90."
      }
    ],
    "correctAnswers": [
      "C",
  ...
  },
  {
    "id": "dp600-219",
    "questionNumber": 219,
    "text": "You have a Fabric workspace named Workspace1 that contains a dataflow named Dataflow1. Dataflow1 returns 500 rows of data.  \n  \nYou need to identify the min and max values for each column in the query results.  \n  \nWhich three Data view options should you select? Each correct answer presents part of the solution.  \n  \nNOTE: Each correct answer is worth one point.",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
  ...
  },
  {
    "id": "dp600-221",
    "questionNumber": 221,
    "text": "You have a Fabric tenant that contains a semantic model. The model uses Direct Lake mode.  \n\nYou suspect that some DAX queries load unnecessary columns into memory.  \n\nYou need to identify the frequently used columns that are loaded into memory.  \n\nWhat are two ways to achieve the goal? Each correct answer presents a complete solution.  \n\nNOTE: Each correct answer is worth one point.",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
        "text": "Use the Analyze in Excel feature."
      },
      {
        "key": "B",
        "text": "Use the Vertipaq Analyzer tool."
      },
      {
        "key": "C",
        "text": "Query the $System.DISCOVER_STORAGE_TABLE_COLUMN_SEGMENTS dynamic management view (DMV)."
      },
      {
        "key": "D",
        "text": "Query the DISCOVER_MEMORYGRANT dynamic management view (DMV)."
      }
    ],
    "correctAnswers": [
      "B",
    ...
    "explanation": "Trình phân tích Vertipaq (B) cung cấp phân tích chi tiết về mức sử dụng bộ nhớ và lưu trữ ở cấp độ cột, cho biết cột nào tiêu thụ nhiều tài nguyên nhất. $System.DISCOVER_STORAGE_TABLE_COLUMN_SEGMENTS DMV (C) trả về siêu dữ liệu phân đoạn cột tiết lộ các mẫu lưu trữ và các cột được truy cập thường xuyên. Phân tích trong Excel chỉ cung cấp khả năng khám phá dữ liệu tương tác và DISCOVER_MEMORYGRANT theo dõi việc cấp bộ nhớ truy vấn chứ không theo dõi mức sử dụng bộ nhớ ở cấp độ cột.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
  ...
  },
  {
    ...
    "options": [],
    "correctAnswers": [],
    "explanation": "ReadAll cấp quyền truy cập dữ liệu trong OneLake thông qua vai trò DefaultReader, cho phép truy cập dữ liệu Spark. ReadData cấp quyền truy cập thông qua điểm cuối phân tích SQL mà không cấp quyền truy cập dữ liệu OneLake/Spark. Do đó, ReadAll là bắt buộc đối với tất cả dữ liệu Spark, trong khi ReadData là quyền có đặc quyền thấp nhất đối với quyền truy cập chỉ dành cho điểm cuối SQL.",
    "category": "General",
    "tags": [
      "DP-600",
      "General"
