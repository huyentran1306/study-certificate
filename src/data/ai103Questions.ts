...
export const ai103Questions: Question[] = [
  ...
  },
  {
    ...
    "statements": [
      ...
      {
        "id": "2",
        "text": "To enable users to provide contextual grounding during chats, use the:",
        "correctAnswer": "F",
        "choiceKeys": [
          "D",
          "E",
  ...
  },
  {
    ...
    "statements": [
      ...
      {
        "id": "2",
        "text": "If the evaluation results are NOT met, configure the workflow to:",
        "correctAnswer": "F",
        "choiceKeys": [
          "D",
          "E",
  ...
  },
  {
    ...
    "explanation": "Khi bạn gọi API REST Lời nói thành văn bản cho giọng nói tùy chỉnh, bạn đặt thuộc tính dự án thành ID của dự án giọng nói tùy chỉnh — GUID xuất hiện trong URL fine-tuning trong cổng Microsoft Foundry (ví dụ: 00001111-aaaa-2222-bbbb-3333cccc4444). Tài liệu của Microsoft cảnh báo rõ ràng rằng ID dự án giọng nói tùy chỉnh này KHÔNG giống với ID dự án Microsoft Foundry, do đó, việc cung cấp \"ID dự án\" chung (ID dự án Foundry) là nguyên nhân tạo ra lỗi \"ID dự án không hợp lệ\" được mô tả và thay vào đó, bạn phải sử dụng ID dự án giọng nói tùy chỉnh. URL dự án và URL điểm cuối giọng nói tùy chỉnh là các liên kết tự/tham chiếu được trả về trong phản hồi API chứ không phải giá trị bạn chỉ định cho thuộc tính dự án, do đó, cả URL dự án và URL điểm cuối đều không chính xác.\n\n**Tài liệu tham khảo:**\n[Get the project ID for the REST API](https://learn.microsoft.com/en-us/azure/ai-services/speech-service/how-to-custom-speech-create-project)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 7",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/7-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-8",
    "questionNumber": 8,
    "text": "You have a Microsoft Foundry project containing a customer support agent that is grounded in internal documentation.  \n  \nFollowing a recent update, users report the following issues:  \n  \n- Some answers are not supported by the retrieved documents.  \n- A small number of responses are flagged for policy violations.  \n  \nYou need to evaluate each issue. Which observability signal should you use for each one? An observability signal can be used once, more than once, or not at all.",
    "questionType": "matching_drag_drop",
    "statements": [
      {
        "id": "1",
        "text": "Unsupported responses:",
        "correctAnswer": "A"
      },
      {
        "id": "2",
  ...
  },
  {
    ...
    "explanation": "Trong Power Fx, IsBlank() kiểm tra xem giá trị có trống hay không; gói nó trong Not() - Not(IsBlank(Local.Var01)) - chỉ đánh giá thành true khi biến cục bộ thực sự giữ một giá trị, đây là bộ bảo vệ if/else chính xác để xác nhận rằng Var01 có chứa một giá trị. IsEmpty() là một hàm định hướng bảng và không phải là hàm kiểm tra trống chính xác cho biến vô hướng. Để tham chiếu biến cục bộ của quy trình làm việc bên trong biểu thức Power Fx, bạn phải sử dụng Local. tiền tố phạm vi, do đó biểu thức Gửi tin nhắn trả về phản hồi bằng chữ in hoa là {Upper(Local.Var01)}; Upper(Var01) bỏ qua tiền tố phạm vi được yêu cầu và không giải quyết biến được lưu trữ.\n\n**Tài liệu tham khảo:**\n[Build a workflow in Microsoft Foundry (Preview)](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/workflow)",
    "category": "Implement text analysis solutions",
    "tags": [
      "AI-103",
      "Implement text analysis solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 9",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/9-implement-text-analysis-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-10",
    "questionNumber": 10,
    "text": "You have a Microsoft Foundry project with a customer support agent built using the Foundry Agent Service. The agent uploads user-provided screenshots to Azure Storage via a ticketing tool and receives back a blob URL for further reasoning.  \n  \nYou need to apply image moderation during agent runs so that harmful content is never returned, with Azure AI Content Safety accessing the images through the blob URL. The solution must follow the principle of least privilege.  \n  \nWhat should you configure for Content Safety?",
    "questionType": "matching_dropdown",
    "statements": [
      {
        "id": "1",
  ...
  },
  {
    ...
    "explanation": "Trình phân tích bố cục dựng sẵn sẽ trích xuất các thành phần nội dung và bố cục — từ, đoạn văn, bảng và cấu trúc phần — trong khi vẫn giữ nguyên bố cục tài liệu, đồng thời nó cũng phát hiện và giải mã mã vạch, bao gồm cả mã QR, như một phần đầu ra của nó; nó chạy như một bộ phân tích dựa trên bố cục/OCR và không yêu cầu triển khai mô hình ngôn ngữ. chế độ đọc dựng sẵn chỉ thực hiện trích xuất văn bản OCR, không có cấu trúc bảng hoặc bố cục, đồng thời-documentFieldSchema dựng sẵn và tìm kiếm tài liệu dựng sẵn không phải là trình phân tích trích xuất bố cục và mã vạch.\n\n**Tài liệu tham khảo:**\n[Azure Content Understanding in Foundry Tools - analyzer reference](https://learn.microsoft.com/en-us/azure/ai-services/content-understanding/concepts/analyzer-reference) · [Document layout analysis - Document Intelligence](https://learn.microsoft.com/en-us/azure/ai-services/document-intelligence/prebuilt/layout?view=doc-intel-4.0.0)",
    "category": "Implement information extraction solutions",
    "tags": [
      "AI-103",
      "Implement information extraction solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 15",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/15-implement-information-extraction-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-16",
    "questionNumber": 16,
    "text": "You are deploying a support agent that lets users upload photos.  \n  \nYou need to automatically classify the uploaded images for harmful content. The solution must block content according to severity levels.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
  ...
  },
  {
    ...
    "explanation": "Lỗi được báo cáo là các điều khoản quy định bắt buộc đã có trong nội dung được truy xuất nhưng bị loại khỏi bản tóm tắt được tạo - vấn đề về lựa chọn nội dung/độ trung thực, không phải giới hạn độ dài đầu ra. Việc tăng max_tokens chỉ làm tăng mức trần về số lượng mã thông báo mà mô hình được phép tạo; nó không hướng dẫn hoặc buộc mô hình phải đưa vào các mệnh đề cụ thể mà nó hiện đang chọn bỏ qua, do đó, nó không khắc phục được thiếu sót một cách đáng tin cậy và không đáp ứng được mục tiêu cải thiện tính hoàn thiện.",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 17",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/17-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-18",
    "questionNumber": 18,
    "text": "Solution: You add a reflection pass that regenerates the response if the required clauses are missing.  \n  \nDoes this solution meet the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Việc thêm thẻ phản ánh sẽ trực tiếp đóng vòng lặp giữa phát hiện và sửa lỗi: quy trình kiểm tra bản tóm tắt đã tạo để tìm các điều khoản quy định bắt buộc và nếu thiếu bất kỳ điều khoản nào, sẽ kích hoạt quá trình tái tạo trước khi phản hồi được trả về. Bởi vì mẫu này cố gắng tạo lại một cách rõ ràng cho đến khi đưa vào nội dung bị thiếu nên nó trực tiếp giải quyết lỗi về tính đầy đủ được báo cáo và đáp ứng mục tiêu.\n\n**Tài liệu tham khảo:**\n[Agent Evaluators for Generative AI - Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/concepts/evaluation-evaluators/agent-evaluators)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 18",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/18-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-19",
    "questionNumber": 19,
    "text": "Solution: You increase the value of the `temperature` parameter.  \n  \nDoes this solution meet the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Tham số nhiệt độ kiểm soát tính ngẫu nhiên của việc lấy mẫu mã thông báo; nó có cơ chế no để đảm bảo rằng các mệnh đề bắt buộc cụ thể từ nội dung truy xuất được chọn và đưa vào đầu ra. Nhiệt độ tăng làm cho kết quả đầu ra khó dự đoán hơn và, nếu có, sẽ làm tăng nguy cơ bỏ sót hoặc thay đổi nội dung được yêu cầu thay vì đảm bảo đưa nội dung đó vào, do đó nó không đáp ứng được mục tiêu cải thiện tính hoàn chỉnh.",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 19",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/19-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-20",
    "questionNumber": 20,
    "text": "Solution: You run an evaluation flow that scores responses for completeness and blocks any response that falls below a defined threshold.  \n  \nDoes this solution meet the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
  ...
  },
  {
    ...
    "explanation": "Prompt Shields là khả năng An toàn nội dung Azure AI được tích hợp vào Microsoft Foundry giúp phát hiện và chặn cả các cuộc tấn công trực tiếp theo lời nhắc của người dùng và \"tấn công tài liệu\" gián tiếp — các hướng dẫn ẩn được nhúng trong nội dung của bên thứ ba như tài liệu, hình ảnh, email hoặc trang web cố gắng chiếm quyền điều khiển phiên mô hình hoặc tác nhân. Vì trang sản phẩm là các tệp PDF bên ngoài có thể chứa hình ảnh có văn bản nhúng nên việc bật Prompt Shields sẽ bảo vệ tác nhân khỏi hành động theo các hướng dẫn độc hại ẩn trong văn bản nhúng đó, đây là yêu cầu cụ thể mà nó đáp ứng. Thay vào đó, tính năng Phát hiện PII xác định và biên tập lại dữ liệu cá nhân ở dạng văn bản và không giải quyết các cuộc tấn công chèn lệnh, trong khi tính năng lọc nội dung tự làm hại bản thân và bạo lực giải quyết các danh mục nội dung có hại thay vì hướng dẫn được đưa vào.\n\n**Tài liệu tham khảo:**\n[Prompt Shields in Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/openai/concepts/content-filter-prompt-shields)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 24",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/24-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-25",
    "questionNumber": 25,
    "text": "You need to recommend a solution for assessing the responses that Agent1 generates when it relies on the product information stored in storage1, and the solution must satisfy the technical requirements.  \n  \nWhat should you include in the recommendation?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Yêu cầu kỹ thuật nêu rõ rằng các phản hồi được xây dựng từ nội dung trang sản phẩm phải phù hợp, đầy đủ và chính xác. Bộ đánh giá Thế hệ truy xuất-tăng cường truy xuất (RAG) của Microsoft Foundry là danh mục đánh giá tích hợp được xây dựng có mục đích cho các tình huống có căn cứ, dựa trên truy xuất và kết hợp chất lượng truy xuất, độ chính xác thực tế so với nguồn được truy xuất), mức độ liên quan và số liệu về tính đầy đủ của phản hồi — trực tiếp bao gồm cả ba phẩm chất mà yêu cầu yêu cầu. Trình đánh giá căn cứ độc lập chỉ chấm điểm độ chính xác/trung thực về mặt thực tế đối với bối cảnh được truy xuất và bản thân nó không cho điểm mức độ liên quan hoặc tính đầy đủ, do đó, nó sẽ không tự mình xác thực đầy đủ yêu cầu đã nêu.\n\n**Tài liệu tham khảo:**\n- [Retrieval-Augmented Generation (RAG) Evaluators for Generative AI - Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/concepts/evaluation-evaluators/rag-evaluators)\n- [Built-in Evaluators Reference - Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/concepts/built-in-evaluators)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 25",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/25-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-26",
    "questionNumber": 26,
    "text": "You need to configure Agent1 so that it answers customer questions only about Contoso products, in line with the business requirements.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Hạn chế phạm vi chủ đề của tổng đài viên — hướng dẫn họ từ chối hoặc chuyển hướng các câu hỏi bên ngoài miền sản phẩm đã xác định — là một quy tắc hành vi lâu dài và thông báo hệ thống là cơ chế xác định vai trò, ranh giới và các ràng buộc không thể thương lượng của tổng đài viên trong mỗi lượt trò chuyện. Các ví dụ ngắn gọn chủ yếu định hình kiểu và định dạng đầu ra thay vì thực thi ranh giới phạm vi cứng một cách đáng tin cậy, đồng thời lấy mẫu top-p và tham số nhiệt độ chỉ kiểm soát tính ngẫu nhiên/đa dạng đầu ra chứ không kiểm soát chủ đề nào mà tác nhân được phép thảo luận.\n\n**Tài liệu tham khảo:**\n[System message design for Azure OpenAI - Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/openai/concepts/advanced-prompt-engineering)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 26",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/26-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-27",
    "questionNumber": 27,
    "text": "You need to recommend an invoice review solution that addresses the issue reported by the finance department.  \n  \nWhat should you include in the recommendation?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Hóa đơn nhà cung cấp của bộ phận tài chính đi kèm với bảng, biểu tượng và bố cục rất đa dạng, đồng thời phải được xác minh theo các điều khoản hợp đồng với nhà cung cấp và thay đổi theo kế hoạch đòi hỏi giải pháp đánh giá cả bố cục trực quan và nội dung văn bản của hóa đơn. Hướng dẫn riêng của Microsoft về việc lựa chọn giữa Hiểu nội dung và Document Intelligence đặt hóa đơn với các mẫu có độ biến đổi cao, không nhất quán trong kịch bản \"tài liệu bán cấu trúc có độ biến thiên cao\", trong đó Microsoft đề xuất trình phân tích Hiểu nội dung vì nó tổng quát hóa trên các biến thể mẫu và bố cục mà không gắn nhãn và có thể suy luận về nội dung được trích xuất, bao gồm các giá trị tham chiếu chéo (chẳng hạn như đối với các điều khoản hợp đồng) — một khả năng lý luận mà các mô hình trích xuất trường có cấu trúc của Document Intelligence không có cung cấp. Thay vào đó, mô hình hóa đơn dựng sẵn của Document Intelligence được đề xuất cho các biểu mẫu một mẫu, được tiêu chuẩn hóa, không phù hợp với yêu cầu xác minh nhiều tài liệu, bố cục đa dạng được mô tả ở đây; hoàn thành trò chuyện và Phân tích hình ảnh không cung cấp khả năng trích xuất trường có cấu trúc tài liệu cũng như lý luận tài liệu nhận biết bố cục.\n\n**Tài liệu tham khảo:**\n- [Choose the right Azure AI tool for document processing](https://learn.microsoft.com/en-us/azure/ai-services/content-understanding/choosing-right-ai-tool)",
    "category": "Implement information extraction solutions",
    "tags": [
      "AI-103",
      "Implement information extraction solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 27",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/27-implement-information-extraction-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-28",
    "questionNumber": 28,
    "text": "You need to configure an indexing pipeline for Agent1 so that it can retrieve the relevant product information from storage1. The solution must satisfy the technical requirement.  \n  \nWhich two built-in skills should you use? Each correct answer presents part of the solution.  \n  \nNOTE: Each correct selection is worth one point.",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Yêu cầu kỹ thuật yêu cầu một quy trình lập chỉ mục hỗ trợ ngữ nghĩa và vector search trên các trang sản phẩm PDF. Trong bộ kỹ năng Azure AI Search, kỹ năng Tách văn bản chia văn bản tài liệu được trích xuất thành các đoạn có kích thước phù hợp để xử lý tiếp theo và kỹ năng Nhúng Azure OpenAI chuyển đổi từng đoạn thành một vectơ được ghi vào trường vectơ trong chỉ mục. Cùng với nhau, hai kỹ năng tích hợp này tạo ra nội dung được vector hóa theo khối cần thiết cho chỉ mục ngữ nghĩa/vector search; Nhận dạng thực thể, Hợp nhất, Phát hiện ngôn ngữ và Trích xuất cụm từ khóa là các kỹ năng làm giàu không tạo ra các khối hoặc vectơ cần thiết để xây dựng chỉ mục.\n\n**Tài liệu tham khảo:**\n[Text Split skill - Azure AI Search](https://learn.microsoft.com/en-us/azure/search/cognitive-search-skill-textsplit) · [Azure OpenAI Embedding skill - Azure AI Search](https://learn.microsoft.com/en-us/azure/search/cognitive-search-skill-azure-openai-embedding)",
    "category": "Implement information extraction solutions",
    "tags": [
      "AI-103",
      "Implement information extraction solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 28",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/28-implement-information-extraction-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-29",
    "questionNumber": 29,
    "text": "You need to recommend a solution that supports the planned changes and technical requirements so that Agent1 can use the product information stored in storage1.  \n  \nWhat should you include in the recommendation?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Azure AI Search là dịch vụ truy xuất triển khai quy trình lập chỉ mục được mô tả trong các yêu cầu kỹ thuật: nó nhập các trang sản phẩm PDF, phân đoạn và vector hóa chúng thông qua một bộ kỹ năng, đồng thời hiển thị chỉ mục hỗ trợ ngữ nghĩa/vectơ mà Agent1 có thể truy vấn dưới dạng dữ liệu grounding để trả lời các câu hỏi về sản phẩm bằng ngôn ngữ tự nhiên. Azure Translator chỉ thực hiện dịch ngôn ngữ, Grounding với Tìm kiếm Bing truy xuất nội dung web công khai thay vì tài liệu riêng tư trong bộ lưu trữ1 và Azure Document Intelligence trích xuất nội dung tài liệu nhưng không tự cung cấp khả năng lập chỉ mục hoặc truy xuất.\n\n**Tài liệu tham khảo:**\n[What's new in Azure AI Search / Integrated vectorization](https://learn.microsoft.com/en-us/azure/search/vector-search-integrated-vectorization) · [Retrieval Augmented Generation (RAG) overview - Azure AI Search](https://learn.microsoft.com/en-us/azure/search/retrieval-augmented-generation-overview)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 29",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/29-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-30",
    "questionNumber": 30,
    "text": "You have a Microsoft Foundry project containing an internal Q&A agent.  \n  \nUsers report the following issues when they ask the agent questions:  \n  \n- An increasing number of \"No relevant information found\" responses.  \n- Periodic HTTP 429 rate limit exceeded errors during peak hours.  \n  \nYou need to determine whether each issue results from model unavailability, resource limits, or inference failures. What should you do?",
    "questionType": "matching_dropdown",
    "statements": [
      {
        "id": "1",
        "text": "Metrics to enable:",
        "correctAnswer": "A",
        "choiceKeys": [
          "A",
          "B",
      ...
      {
        "id": "2",
        "text": "Diagnostic log to collect:",
        "correctAnswer": "G",
        "choiceKeys": [
          "E",
          "F",
  ...
  },
  {
    ...
    "explanation": "Việc xác định một kết nối Azure AI Search duy nhất ở cấp Project1 cho phép mọi ứng dụng khách tham chiếu cùng một cấu hình tìm kiếm được quản lý tập trung thay vì sao chép cài đặt chỉ mục và điểm cuối cho mỗi ứng dụng. Các kết nối dự án Microsoft Foundry hỗ trợ xác thực Microsoft Entra ID (dựa trên mã thông báo, không cần khóa), do đó, các khóa API no cần được cấp hoặc xoay vòng, đáp ứng các yêu cầu về cấu hình dùng chung, no-key-based-auth và chi phí quản trị thấp cùng một lúc. Xây dựng kết nối HTTP tùy chỉnh cho mỗi ứng dụng hoặc yêu cầu mỗi ứng dụng gọi trực tiếp Azure AI Search (có hoặc không có managed identity riêng), cấu hình trùng lặp trên các ứng dụng và tăng nỗ lực quản trị liên tục.\n\n**Tài liệu tham khảo:**\n[Add a new connection to your project - Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/how-to/connections-add) · [Connect an Azure AI Search index to Foundry agents](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/tools/ai-search)",
    "category": "Plan and manage an Azure AI solution",
    "tags": [
      "AI-103",
      "Plan and manage an Azure AI solution"
    ],
    "sourceTitle": "Examcademy AI-103 Question 34",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/34-plan-and-manage-an-azure-ai-solution",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-35",
    "questionNumber": 35,
    "text": "You have an Azure Speech in Foundry Tools resource that hosts a custom speech-to-text model deployed to a custom endpoint, and an agent uses that endpoint for real-time speech recognition.  \n  \nThe custom speech-to-text model is nearing its expiration date.  \n  \nWhat is the expected behavior once the model expires?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
  ...
  },
  {
    ...
    "explanation": "Theo dõi trong các bản ghi Microsoft Foundry, đối với mỗi lần chạy tác nhân riêng lẻ, một chuỗi các khoảng thời gian được sắp xếp theo thứ tự bao gồm các cuộc gọi LLM, lệnh gọi công cụ và thời lượng của chúng, cho phép bạn theo dõi chính xác những gì đã xảy ra trong một lần chạy để chẩn đoán cả mức tăng đột biến về độ trễ và các trường hợp trong đó kết quả công cụ chính xác vẫn tạo ra phản hồi sai. Việc sử dụng mã thông báo, bảng thông tin giám sát và số liệu an toàn là các tín hiệu tổng hợp được thu thập qua nhiều lần chạy và không hiển thị trình tự lệnh gọi mỗi lần chạy cần thiết cho loại kiểm tra nguyên nhân gốc rễ này.\n\n**Tài liệu tham khảo:**\n[Trace and Observe AI Agents in Microsoft Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/agents/concepts/tracing)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 36",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/36-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-37",
    "questionNumber": 37,
    "text": "You have a Microsoft Foundry project that ingests scanned PDF invoices stored in Azure Blob Storage. Each invoice contains printed line items and uses a table-based layout.  \n  \nThe extracted results are stored as structured JSON and used as grounding data for an agent in a Retrieval Augmented Generation (RAG) solution.  \n  \nYou need to create a single analyzer that meets the following requirements:  \n  \n- Extracts the invoice number, invoice date, vendor name, and total amount across varying templates  \n- Returns confidence scores so that results with confidence below 0.80 can be routed for supervisor review  \n  \nWhat should you use?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
  ...
  },
  {
    ...
    "explanation": "Việc thêm \"tool_choice\": \"bắt buộc\" vào tải trọng chạy sẽ buộc Foundry Agent Service gọi một công cụ có sẵn trong mỗi lần chạy thay vì cho phép mô hình phản hồi trực tiếp mà không cần gọi, điều này giải quyết hành vi bỏ qua công cụ không liên tục của tác nhân phân loại vé; giá trị tự động mặc định cho phép mô hình bỏ qua các cuộc gọi công cụ, đây là điều kiện chính xác được báo cáo.\n\n**Tài liệu tham khảo:**\n[Tool best practices for Microsoft Foundry Agent Service](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/tool-best-practice)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 40",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/40-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-41",
    "questionNumber": 41,
    "text": "You have a Microsoft Foundry project that contains a high-traffic agent. Following a recent update, operational costs rise significantly, even though monitoring confirms that the volume of user traffic to the agent has stayed the same.  \n  \nYou suspect that changes to the request or response characteristics are behind the increase, and you need to determine whether the added cost comes from the model input size, the model output size, or expanded tool usage.  \n  \nWhich observability capability should you use?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "sourceTitle": "Examcademy AI-103 Question 41",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/41-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-42",
  ...
  },
  {
    ...
    "explanation": "Inpainting dựa trên mặt nạ cho phép bạn hạn chế chỉnh sửa ở một vùng cụ thể bằng cách chỉ cung cấp mặt nạ trên biểu tượng, do đó, chỉ các pixel bên trong vùng đó được tạo lại trong khi phần còn lại của hình ảnh được giữ nguyên. Việc tăng cường độ hướng dẫn lời nhắc, chỉnh sửa lời nhắc hoặc thay đổi hạt giống ngẫu nhiên đều khiến mô hình tái tạo hình ảnh trên diện rộng (hoặc tạo ra một hình ảnh khác hoàn toàn), với no đảm bảo rằng chỉ logo bị ảnh hưởng và phần còn lại của bố cục được giữ nguyên.\n\n**Tài liệu tham khảo:**\n[How to use image generation models from OpenAI - Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/openai/how-to/dall-e)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 44",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/44-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-45",
    "questionNumber": 45,
    "text": "You have a Microsoft Foundry project that contains a model deployment, and an application calls that deployment by using the Azure OpenAI v1 API together with DefaultAzureCredential.  \n  \nDevelopers at your company receive HTTP 403 errors when they send inference requests, even after they run `az login`.  \n  \nYou need to ensure that the developers can perform model inference, and the solution must follow the principle of least privilege.  \n  \nWhich role-based access control (RBAC) role should you assign to the developers?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
  ...
  },
  {
    ...
    "explanation": "Prompt Shields dành cho Lời nhắc của Người dùng được thiết kế để phát hiện các nỗ lực bẻ khóa trực tiếp mà người dùng nhập vào cuộc trò chuyện; nó không kiểm tra nội dung của bên thứ ba, chẳng hạn như văn bản được trích xuất từ ​​hình ảnh được tải lên, vì vậy nó không thể nắm bắt được các hướng dẫn ẩn bên trong hình ảnh. Nó cũng thực hiện kiểm duyệt nội dung hình ảnh no. Vì rủi ro đã nêu bao gồm cả nội dung hình ảnh không an toàn và prompt injection gián tiếp (kiểu tài liệu) được chứa bên trong văn bản hình ảnh, nên chỉ riêng tấm chắn nhắc nhở người dùng sẽ không giải quyết được cả hai vấn đề.\n\n**Tài liệu tham khảo:**\n[Prompt Shields in Azure AI Content Safety](https://learn.microsoft.com/en-us/azure/ai-services/content-safety/concepts/jailbreak-detection)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 52",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/52-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-53",
    "questionNumber": 53,
    "text": "Proposed solution: Configure image moderation to block unsafe content before the images are processed.  \n  \nDoes this solution meet the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Kiểm duyệt hình ảnh An toàn nội dung Azure AI sẽ sàng lọc nội dung trực quan theo các danh mục gây hại như bạo lực, nội dung khiêu dâm, tự làm hại bản thân và thù hận, nhằm giải quyết một nửa rủi ro về hình ảnh không an toàn. Nó không phân tích bất kỳ văn bản nào được trích xuất từ ​​hình ảnh cho các hướng dẫn được nhúng, do đó, nội dung nhắc nhở ẩn được truyền qua OCR/trích xuất văn bản vẫn đến được mô hình mà không được giảm thiểu, khiến mục tiêu chỉ đạt được một phần.\n\n**Tài liệu tham khảo:**\n[Harm categories in Azure AI Content Safety](https://learn.microsoft.com/en-us/azure/ai-services/content-safety/concepts/harm-categories) · [Quickstart: Analyze image content - Azure AI Content Safety](https://learn.microsoft.com/en-us/azure/ai-services/content-safety/quickstart-image)",
    "category": "Implement computer vision solutions",
    "tags": [
      "AI-103",
      "Implement computer vision solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 53",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/53-implement-computer-vision-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-54",
    "questionNumber": 54,
    "text": "Proposed solution: Configure a prompt shield for documents.  \n  \nDoes this solution meet the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Prompt Shields dành cho Tài liệu kiểm tra nội dung mà mô hình không nhận được trực tiếp từ người dùng — chẳng hạn như văn bản được trích xuất từ ​​hình ảnh đã tải lên — đối với các hướng dẫn chèn lời nhắc gián tiếp, được nhúng, nhằm giải quyết một nửa rủi ro về hướng dẫn ẩn. Tuy nhiên, nó thực hiện kiểm duyệt nội dung hình ảnh no, do đó, nó không phát hiện hoặc chặn nội dung hình ảnh không an toàn (bạo lực, tục tĩu hoặc không phù hợp), khiến một nửa rủi ro đã nêu không được giải quyết.\n\n**Tài liệu tham khảo:**\n[Prompt Shields in Azure AI Content Safety](https://learn.microsoft.com/en-us/azure/ai-services/content-safety/concepts/jailbreak-detection) · [Quickstart: Analyze image content - Azure AI Content Safety](https://learn.microsoft.com/en-us/azure/ai-services/content-safety/quickstart-image)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 54",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/54-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-55",
    "questionNumber": 55,
    "text": "Proposed solution: Configure protected material detection.  \n  \nDoes this solution meet the goal?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Tính năng phát hiện tài liệu được bảo vệ quét đầu ra do AI tạo để tìm nội dung đã biết có bản quyền hoặc được cấp phép của bên thứ ba, chẳng hạn như lời bài hát, bài viết hoặc mã nguồn công cộng, do đó, đầu ra không sao chép nguyên văn. Nó có vai trò no trong việc sàng lọc các hình ảnh được tải lên để tìm nội dung không an toàn và vai trò no trong việc phát hiện các hướng dẫn ẩn bên trong văn bản hình ảnh, do đó, nó không giải quyết được một phần rủi ro đã nêu.\n\n**Tài liệu tham khảo:**\n[Protected material detection in Azure AI Content Safety](https://learn.microsoft.com/en-us/azure/ai-services/content-safety/concepts/protected-material)",
    "category": "Implement text analysis solutions",
    "tags": [
      "AI-103",
      "Implement text analysis solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 55",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/55-implement-text-analysis-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-56",
    "questionNumber": 56,
    "text": "You have a Microsoft Foundry project containing an agent named PaymentAgent. PaymentAgent has a function tool that issues customer refunds through an external API. You are authoring a workflow in YAML and need the workflow to pause for human approval, proceeding to the refund step only once approval has been granted.  \n  \nHow should you complete the workflow definition?",
    "questionType": "matching_dropdown",
    "statements": [
      {
        "id": "approval_type",
    ...
    "explanation": "Mẫu quy trình làm việc con người trong vòng lặp của Microsoft Foundry sử dụng bước Đặt câu hỏi để tạm dừng thực thi và chờ phản hồi của một người trước khi tiếp tục, đây là cơ chế được sử dụng để hoàn lại tiền khi con người phê duyệt; bước trò chuyện cơ bản (gửi tin nhắn) không chờ đầu vào và bước chuyển đổi dữ liệu chỉ đặt hoặc phân tích một biến. Điều kiện của bước hoàn tiền tiếp theo phải kiểm tra giá trị mà bước phê duyệt nắm bắt, vì vậy điều kiện: phê duyệt == \"được phê duyệt\" chỉ tiếp tục khi con người chấp thuận yêu cầu một cách rõ ràng; việc kiểm tra đề xuất_refund.output!= null chỉ xác nhận kết quả đầu ra được tạo ra từ đề xuất ban đầu (không phải ai đã phê duyệt nó) và một sự thật đúng nghĩa sẽ thực hiện hoàn tiền vô điều kiện, đánh bại cổng phê duyệt.\n\n**Tài liệu tham khảo:**\n[Build a workflow in Microsoft Foundry (Preview)](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/workflow)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 56",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/56-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-57",
  ...
  },
  {
    ...
    "explanation": "Inpainting dựa trên mặt nạ là chế độ chỉnh sửa hình ảnh tích hợp được thiết kế để hạn chế chỉnh sửa ở một vùng cụ thể: bạn cung cấp hình ảnh gốc cùng với mặt nạ đánh dấu chính xác những pixel nào có thể thay đổi và mô hình chỉ tạo lại nội dung bên trong vùng được che trong khi để mọi thứ bên ngoài nó — bao gồm cả ánh sáng và phong cách xung quanh — không bị ảnh hưởng. image_variation và text_to_image tái tạo rộng rãi mà không có bất kỳ ràng buộc mặt nạ nào và image_to_image ở cường độ cao sẽ tái tạo toàn bộ hình ảnh thay vì một vùng giới hạn.\n\n**Tài liệu tham khảo:**\n[How to use image generation models from OpenAI - Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/openai/how-to/dall-e)",
    "category": "Implement computer vision solutions",
    "tags": [
      "AI-103",
      "Implement computer vision solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 61",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/61-implement-computer-vision-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-62",
    "questionNumber": 62,
    "text": "You have a Microsoft Foundry project that serves a high-volume chat application. Most of the requests are simple FAQs, but some require advanced reasoning.  \n  \nYou need to reduce cost and latency for the common queries without degrading the quality of responses to the complex questions.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
  ...
  },
  {
    ...
    "explanation": "Lời nói trong thời gian thực thành văn bản liên tục chuyển đổi âm thanh trực tuyến thành văn bản với độ trễ thấp khi người dùng nói, trong khi văn bản thành giọng nói tổng hợp phản hồi văn bản của tác nhân thành âm thanh; được sử dụng cùng nhau, việc ghép nối này hỗ trợ động lực đàm thoại luân phiên, có độ trễ thấp mà kịch bản yêu cầu, bao gồm cả việc tổng đài viên bắt đầu phản hồi trước khi người dùng nói xong. Quá trình sao chép hàng loạt các tệp được ghi không đồng bộ và không thể hỗ trợ chuyển lượt trực tiếp, mô hình nhúng mã hóa dữ liệu để tương tự/truy xuất thay vì thực hiện sao chép hoặc tổng hợp và bản dịch giọng nói sẽ thay đổi ngôn ngữ nói thay vì cho phép tạo phản hồi bằng giọng nói.\n\n**Tài liệu tham khảo:**\n[What is real-time speech to text?](https://learn.microsoft.com/en-us/azure/ai-services/speech-service/speech-to-text) · [What is text to speech?](https://learn.microsoft.com/en-us/azure/ai-services/speech-service/text-to-speech)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 63",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/63-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-64",
    "questionNumber": 64,
    "text": "You have a Microsoft Foundry project containing an agent.  \n  \nThe agent uses tools to retrieve internal content and call external APIs, and it is currently configured to let the model decide when to invoke those tools.  \n  \nYou need to publish the agent for a compliance workflow that meets these requirements:  \n  \n- Every workflow run must perform a retrieval step before a response is generated.  \n- Tool calls must authenticate using the published agent's own identity.  \n- Tool access must use an identity that is isolated from other project resources.  \n- Tool access must support audit tracing.  \n  \nWhat should you configure?",
    "questionType": "matching_dropdown",
    "statements": [
      {
        "id": "1",
        "text": "Set tool_choice to:",
        "correctAnswer": "C",
        "choiceKeys": [
          "A",
          "B",
      ...
      {
        "id": "2",
        "text": "Configure the tool to authenticate by:",
        "correctAnswer": "F",
        "choiceKeys": [
          "D",
          "E",
  ...
  },
  {
    ...
    "explanation": "Kết nối dự án Microsoft Foundry lưu trữ chi tiết xác thực như khóa API hoặc điểm cuối một lần ở cấp dự án và bất kỳ tác nhân hoặc công cụ nào trong dự án đó đều có thể tham chiếu cùng một kết nối thay vì mỗi tác nhân giữ một bản sao riêng biệt của thông tin xác thực Azure AI Search. Do đó, việc thêm kết nối vào tài nguyên Azure AI Search là cơ chế tập trung việc lưu trữ và quản lý thông tin xác thực, đồng thời giúp kết nối này có thể tái sử dụng được trên mọi tác nhân trong Project1. Kích hoạt RBAC và vô hiệu hóa quyền truy cập dựa trên khóa là các bước tăng cường bổ sung tốt nhưng bản thân chúng không tập trung vào việc quản lý thông tin xác thực và private endpoint được quản lý giải quyết kết nối cấp mạng với tài nguyên chứ không phải cách các tác nhân lấy hoặc chia sẻ thông tin xác thực.\n\n**Tài liệu tham khảo:**\n[Add a new connection to your project - Microsoft Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/connections-add)",
    "category": "Plan and manage an Azure AI solution",
    "tags": [
      "AI-103",
      "Plan and manage an Azure AI solution"
    ],
    "sourceTitle": "Examcademy AI-103 Question 65",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/65-plan-and-manage-an-azure-ai-solution",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-66",
    "questionNumber": 66,
    "text": "Contoso needs the marketing department to be able to generate videos using the model deployed to Project2. Complete the Python code shown by selecting the correct method for each dropdown.",
    "questionType": "matching_dropdown",
    "statements": [
      {
        "id": "b1",
  ...
  },
  {
    ...
    "explanation": "Yêu cầu kinh doanh nêu rõ rằng Tác nhân1 phải giữ lại bối cảnh cuộc trò chuyện và gợi lại thông tin liên quan từ các lần tương tác trước đó để mang lại trải nghiệm được cá nhân hóa trong các cuộc trò chuyện trong tương lai. Khả năng này được cung cấp bởi tính năng bộ nhớ của tổng đài viên trong Microsoft Foundry Agent Service, cho phép tổng đài viên duy trì trạng thái và thu hồi thông tin chi tiết từ các phiên trước đó với người dùng, cho phép tính liên tục và cá nhân hóa trong các tương tác. Các nguồn kiến ​​thức (chẳng hạn như bảng sản phẩm được lập chỉ mục) cung cấp dữ liệu grounding để trả lời các câu hỏi về miền, các biện pháp bảo vệ thực thi các chính sách nội dung và an toàn cũng như các công cụ cho phép tác nhân gọi các chức năng hoặc dịch vụ bên ngoài — không có công cụ nào trong số này trực tiếp giải quyết việc lưu giữ và thu hồi lịch sử hội thoại để cá nhân hóa.\n\n**Tài liệu tham khảo:**\n[Agent memory - Azure AI Foundry Agent Service](https://learn.microsoft.com/en-us/azure/ai-services/agents/concepts/memory)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 67",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/67-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.358Z"
  },
  {
    "id": "ai103-68",
    "questionNumber": 68,
    "text": "You need to ensure that Agent1Dev Team can access Agent1. The solution must meet the security and compliance requirements.  \n  \nHow should you complete the Python code?",
    "questionType": "matching_dropdown",
    "statements": [
      {
        "id": "cred",
  ...
  },
  {
    ...
    "statements": [
      ...
      {
        "id": "b2",
        "text": "To measure whether responses contain sensitive or proprietary information:",
        "correctAnswer": "G",
        "choiceKeys": [
          "E",
          "F",
  ...
  },
  {
    ...
    "explanation": "Microsoft Foundry cung cấp khả năng theo dõi tác nhân/ứng dụng tích hợp sẵn dựa trên OpenTelemetry, nắm bắt mọi bước của yêu cầu dưới dạng các khoảng tương quan — bao gồm cả lệnh gọi mô hình thông qua API phản hồi và bất kỳ lệnh gọi công cụ nào được thực hiện thông qua kết nối Foundry, chẳng hạn như Azure AI Content Safety. Khi tính năng theo dõi ứng dụng được bật trong dự án (thường bằng cách kết nối tài nguyên Application Insights), Foundry sẽ tự động thiết lập công cụ và liên kết các bước này thành một dấu vết đầu cuối duy nhất có thể xem được trong chế độ xem Dấu vết của cổng Foundry, mang lại khả năng hiển thị đầu vào, đầu ra, độ trễ và lỗi ở từng giai đoạn của quy trình làm việc. Việc chỉ bật ghi nhật ký trong SDK máy khách An toàn nội dung sẽ tách biệt lệnh gọi đó và không tương quan với lệnh gọi đó với yêu cầu mô hình, Foundry Local áp dụng cho việc thực thi mô hình cục bộ thay vì quy trình làm việc được lưu trữ trên đám mây này và việc chỉ định tuyến các yêu cầu thông qua điểm cuối Azure OpenAI không tự nó tạo ra bất kỳ dấu vết hoặc khả năng hiển thị nào trong các bước của quy trình làm việc.\n\n**Tài liệu tham khảo:**\n- [Set Up Tracing for AI Agents in Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/observability/how-to/trace-agent-setup)\n- [Agent tracing in Microsoft Foundry (preview) - Concepts](https://learn.microsoft.com/en-us/azure/foundry/observability/concepts/trace-agent-concept)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 78",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/78-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-79",
    "questionNumber": 79,
    "text": "You have a Microsoft Foundry project containing an agent named Agent1.  \n  \nThe agent runs successfully, but the Foundry Control Plane does not show values for:  \n  \n- Error rates  \n- Runs  \n- Token usage  \n  \nAdditionally, the Traces tab is empty.  \n  \nYou need to ensure that the Foundry Control Plane displays the appropriate values for Agent1.  \n  \nWhat should you do?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Bảng thông tin giám sát và tab Dấu vết của Foundry Control Plane phụ thuộc vào dữ liệu OpenTelemetry được gửi tới tài nguyên Azure Monitor Application Insights được kết nối với tài nguyên lưu trữ của tác nhân. Nếu không bật Application Insights, các tác nhân sẽ thiếu số liệu tình trạng, theo dõi chi phí/mã thông báo và dấu vết chi tiết, điều này giải thích tỷ lệ lỗi bị thiếu, số lần chạy, mức sử dụng mã thông báo và tab Dấu vết trống. Việc kích hoạt và kết nối Application Insights cho Agent1 cho phép phép đo từ xa này (tên hoạt động, thời lượng, lệnh gọi mô hình, lệnh gọi công cụ, cách sử dụng mã thông báo) để đưa vào các chế độ xem Mặt phẳng điều khiển trong vòng vài phút sau khi thực thi tác nhân.\n\n**Tài liệu tham khảo:**\n[Monitor agents with the Agent Monitoring Dashboard - Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/observability/how-to/how-to-monitor-agents-dashboard) · [Monitor AI agent fleet health and performance - Microsoft Foundry Control Plane](https://learn.microsoft.com/en-us/azure/foundry/control-plane/monitoring-across-fleet)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 79",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/79-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-80",
  ...
  },
  {
    ...
    "explanation": "Vector search trong Azure AI Search lập chỉ mục nội dung dưới dạng các phần nhúng có chiều cao nắm bắt ý nghĩa ngữ nghĩa thay vì văn bản chính xác. Điều này cho phép các truy vấn được diễn đạt khác với tài liệu nguồn vẫn khớp với nội dung có liên quan dựa trên sự tương đồng về khái niệm/ngữ nghĩa, điều này rất cần thiết cho các tình huống RAG trong đó các câu hỏi của người dùng có thể không sử dụng cùng thuật ngữ như hướng dẫn sử dụng sản phẩm cơ bản. Xếp hạng ngữ nghĩa chỉ xếp hạng lại các kết quả từ từ khóa ban đầu hoặc tìm kiếm kết hợp và bản thân nó không tạo ra các phần nhúng cần thiết để so khớp độ tương tự; người đề xuất cung cấp chức năng tự động hoàn thành; và máy phân tích xử lý văn bản để tìm kiếm từ vựng (từ khóa), chứ không phải để hiểu ngữ nghĩa.\n\n**Tài liệu tham khảo:**\n[Vector search in Azure AI Search](https://learn.microsoft.com/en-us/azure/search/vector-search-overview) · [Retrieval Augmented Generation (RAG) in Azure AI Search](https://learn.microsoft.com/en-us/azure/search/retrieval-augmented-generation-overview)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 81",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/81-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-82",
    "questionNumber": 82,
    "text": "You have a Microsoft Foundry agent that grounds its responses using an Azure Search index. The index includes:  \n  \n- Searchable text fields for product names and product codes  \n- A vector field that stores embeddings for product descriptions  \n  \nYou need to ensure that users can query the index using:  \n  \n- Exact product names or codes  \n- Natural language descriptions of the products  \n  \nWhat should you configure?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Tìm kiếm kết hợp trong Azure AI Search kết hợp tìm kiếm toàn văn bản (từ khóa) truyền thống với vector search trong một yêu cầu truy vấn duy nhất. Điều này cho phép giải quyết các truy vấn khớp chính xác đối với các trường văn bản (như tên và mã sản phẩm) thông qua tìm kiếm từ khóa, trong khi các truy vấn ngôn ngữ tự nhiên được giải quyết thông qua tìm kiếm tương tự vectơ đối với trường nhúng, với các kết quả được hợp nhất và xếp hạng cùng nhau. Chỉ sử dụng vector search sẽ làm suy giảm khả năng truy xuất tên/mã khớp chính xác và việc chỉ sử dụng tìm kiếm từ khóa hoặc ngữ nghĩa sẽ không tận dụng được việc nhúng vectơ để khớp mô tả ngôn ngữ tự nhiên.\n\n**Tài liệu tham khảo:**\n[Hybrid search - Azure AI Search](https://learn.microsoft.com/en-us/azure/search/hybrid-search-overview)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 82",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/82-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-83",
    "questionNumber": 83,
    "text": "You have an Azure AI Search indexer that ingests PDF policy manuals.  \n  \nClient applications must display page-level citations that include bounding polygons for both text and images.  \n  \nYou need to add a single built-in multimodal content extraction skill to the Azure AI Search skillset. The solution must meet the following requirements:  \n  \n- Provide text and image location metadata.  \n- Extract tables that span multiple pages.  \n  \nWhat should you add?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
  ...
  },
  {
    ...
    "explanation": "Vì hóa đơn chỉ tồn tại dưới dạng hình ảnh được quét nên có lớp văn bản có thể trích xuất no để người lập chỉ mục sử dụng trực tiếp. Kỹ năng Nhận dạng Ký tự Quang học (OCR) tích hợp trong Azure AI Search đọc văn bản in và viết tay từ nội dung hình ảnh trong quá trình làm giàu và văn bản được trích xuất sau đó có thể được chiếu vào các trường chỉ mục có thể tìm kiếm, cho phép tìm kiếm toàn văn bản trên dữ liệu hóa đơn. Tách văn bản chỉ tách các đoạn văn bản đã được trích xuất, Dịch văn bản chuyển đổi văn bản hiện có giữa các ngôn ngữ và Phân tích hình ảnh tạo ra thẻ hình ảnh/chú thích/mô tả hình ảnh thay vì trích xuất nội dung văn bản thực tế cần thiết để tìm kiếm các trường hóa đơn.\n\n**Tài liệu tham khảo:**\n[OCR Skill - Azure AI Search | Microsoft Learn](https://learn.microsoft.com/en-us/azure/search/cognitive-search-skill-ocr) · [Extract Text from Images by Using AI Enrichment - Azure AI Search | Microsoft Learn](https://learn.microsoft.com/en-us/azure/search/cognitive-search-concept-image-scenarios)",
    "category": "Implement computer vision solutions",
    "tags": [
      "AI-103",
      "Implement computer vision solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 84",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/84-implement-computer-vision-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-85",
    "questionNumber": 85,
    "text": "You have a Microsoft Foundry project that uses Azure Content Understanding in Foundry Tools to analyze marketing videos.  \n  \nVideo segmentation is enabled.  \n  \nYou need to configure an analyzer to output a generated JSON field that describes the color scheme of each video segment.  \n  \nHow should you configure the analyzer? Each value may be used once, more than once, or not at all.",
    "questionType": "matching_drag_drop",
    "statements": [
      {
        "id": "valuetype",
  ...
  },
  {
    ...
    "statements": [
      ...
      {
        "id": "auth",
        "text": "Key Vault authorization method:",
        "correctAnswer": "F",
        "choiceKeys": [
          "D",
          "E",
  ...
  },
  {
    ...
    "explanation": "Trong tính năng theo dõi tác nhân dựa trên OpenTelemetry của Microsoft Foundry, một dấu vết bao gồm các khoảng có thể được lồng vào nhau dưới dạng các khoảng cha/con, tạo thành một cây phân cấp phản ánh toàn bộ ngăn xếp lệnh gọi của một lần chạy tác nhân — bao gồm các lệnh gọi tác nhân phụ và lệnh gọi công cụ. Cấu trúc nhịp phân cấp này cho phép nắm bắt tất cả các hoạt động lồng nhau trong toàn bộ quá trình chạy tác nhân và được hiển thị dưới dạng cây/quỹ đạo phân cấp trong chế độ xem Khả năng quan sát > Dấu vết của cổng Foundry. Riêng biệt, mỗi khoảng lệnh gọi công cụ mang các thuộc tính (siêu dữ liệu) ghi lại các đối số gọi và kết quả trả về của công cụ, tuân theo các quy ước ngữ nghĩa OpenTelemetry cho các lệnh gọi công cụ, giúp dữ liệu này có thể truy vấn và kiểm tra được. Bộ lọc truy vấn KQL và chính sách lấy mẫu/dấu vết liên quan đến việc truy vấn phép đo từ xa được lưu trữ hoặc kiểm soát dấu vết nào được thu thập, chứ không liên quan đến việc nắm bắt cấu trúc của các hoạt động lồng nhau hoặc ghi lại đầu vào/đầu ra của lệnh gọi công cụ.\n\n**Tài liệu tham khảo:**\n- [Agent tracing in Microsoft Foundry (preview) - Concepts](https://learn.microsoft.com/en-us/azure/foundry/observability/concepts/trace-agent-concept)\n- [Configure tracing for AI agent frameworks - Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/observability/how-to/trace-agent-framework)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 93",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/93-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-94",
    "questionNumber": 94,
    "text": "You have a Microsoft Foundry project that contains an agent. The agent uses threads and file uploads, and it calls an Azure OpenAI model deployment.  \n  \nDuring load testing, calls intermittently fail and return an HTTP 429 rate limit exceeded error. Some user uploads fail and generate an HTTP 400 file size exceeded error.  \n  \nYou need to mitigate the errors and reduce call failures. The solution must remain within the service and model limits.  \n  \nWhat should you do to resolve each error? Drag the appropriate actions to the correct errors. Each action may be used once, more than once, or not at all.",
    "questionType": "matching_drag_drop",
    "statements": [
      {
        "id": "http429",
  ...
  },
  {
    ...
    "explanation": "Một mô hình nhúng được thiết kế để chuyển đổi văn bản (tài liệu và truy vấn) thành các biểu diễn vectơ số nhằm nắm bắt ý nghĩa ngữ nghĩa. Các vectơ này cho phép tìm kiếm dựa trên sự tương tự, chẳng hạn như vector search hoặc tạo tăng cường truy xuất (RAG), bằng cách cho phép hệ thống so sánh vectơ của truy vấn người dùng với vectơ của tài liệu được lập chỉ mục để tìm ra kết quả phù hợp nhất. Danh mục mô hình Azure AI Foundry (Microsoft Foundry) bao gồm các mô hình nhúng như text-embedding-ada-002 và các mô hình nhúng khác dành riêng cho mục đích này, khác với LLM hoặc SLM được tối ưu hóa cho việc tạo văn bản thay vì tạo ra các nội dung nhúng.\n\n**Tài liệu tham khảo:**\n[Embeddings - Azure OpenAI Service](https://learn.microsoft.com/en-us/azure/ai-services/openai/concepts/understand-embeddings) · [Model catalog and collections in Azure AI Foundry portal](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/model-catalog-overview)",
    "category": "Implement text analysis solutions",
    "tags": [
      "AI-103",
      "Implement text analysis solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 95",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/95-implement-text-analysis-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-96",
    ...
    "explanation": "Việc triển khai Serverless API (Mô hình dưới dạng dịch vụ) trong Azure AI Foundry được Microsoft lưu trữ và tính phí theo mức sử dụng thay vì được cung cấp trên các phiên bản VM chuyên dụng trong đăng ký của khách hàng, vì vậy chúng không được tính từ hạn mức vCPU của đăng ký. Chúng hiển thị điểm cuối API REST thời gian thực và được xác thực bằng khóa API (xác thực dựa trên khóa), đáp ứng tất cả các yêu cầu đã nêu. Ngược lại, triển khai vùng chứa tiêu chuẩn (điện toán được quản lý) và vùng chứa tự lưu trữ cung cấp các phiên bản VM chuyên dụng sử dụng hạn mức vCPU đăng ký và triển khai hàng loạt được thiết kế để xử lý không đồng bộ/ngoại tuyến thay vì lệnh gọi REST theo thời gian thực.\n\n**Tài liệu tham khảo:**\n[Deploy models as serverless API deployments - Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/deploy-models-serverless) · [Overview: Deploy models, flows, and web apps with Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/concepts/deployments-overview)",
    "category": "Plan and manage an Azure AI solution",
    "tags": [
      "AI-103",
      "Plan and manage an Azure AI solution"
    ],
    "sourceTitle": "Examcademy AI-103 Question 96",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/96-plan-and-manage-an-azure-ai-solution",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-97",
    "questionNumber": 97,
    "text": "You have a Microsoft Foundry project. You need to create a customer support agent that meets the following requirements:  \n  \n- Grounds responses only in company policy documents stored in curated repositories  \n- Retains customer preferences across separate chat sessions  \n  \nHow should you configure the agent? Select the appropriate options in the answer area.",
    "questionType": "matching_dropdown",
    "statements": [
      {
        "id": "grounding",
    ...
    "options": [
      {
        "key": "A",
        "text": "Configure revival from approved data sources."
      },
      {
        "key": "B",
  ...
  },
  {
    ...
    "explanation": "Việc triển khai mô hình Azure OpenAI như DALL-E yêu cầu tạo triển khai mô hình bên trong tài nguyên AI Azure OpenAI/Azure. Microsoft Foundry (trải nghiệm cổng thông tin hiện tại dành cho tài nguyên Azure AI/Azure OpenAI) là giao diện chính để tạo và triển khai các mô hình đó, đồng thời Azure CLI (sử dụng tiện ích mở rộng dịch vụ nhận thức, ví dụ: tạo tài khoản triển khai dịch vụ nhận thức az) cung cấp phương thức dòng lệnh/tự động hóa được hỗ trợ để tạo các hoạt động triển khai đó. Sự kết hợp này được ghi lại trong hướng dẫn chính thức của Microsoft về việc triển khai các mô hình trong Microsoft Foundry, trong khi các kết hợp công cụ khác được liệt kê (Azure ML Studio, Microsoft Graph API hoặc ghép nối Python/PowerShell SDK/lệnh ghép ngắn) không phải là cơ chế được hỗ trợ để triển khai mô hình DALL-E của Azure OpenAI.\n\n**Tài liệu tham khảo:**\n- [Deploy models using Azure CLI and Bicep - Microsoft Foundry | Microsoft Learn](https://learn.microsoft.com/en-us/azure/foundry/foundry-models/how-to/create-model-deployments)\n- [How to Use Image Generation Models from OpenAI - Microsoft Foundry | Microsoft Learn](https://learn.microsoft.com/en-us/azure/foundry/openai/how-to/dall-e)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 99",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/99-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-100",
    "questionNumber": 100,
    "text": "You are developing a test method to verify results retrieved from a call to the Azure Vision in Foundry Tools API. The call is used to analyze the existence of company logos in images, and it returns a collection of brands named brands. You have the following code segment:  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1785303416283-1vw0fjnu.png)  \n  \nFor each of the following statements, select Yes if the statement is true. Otherwise, select No.",
    "questionType": "statement_matrix",
    "statements": [
      {
        "id": "1",
    ...
    "explanation": "Trong phản hồi phát hiện thương hiệu Azure Vision (Phân tích hình ảnh), mỗi đối tượng thương hiệu được phát hiện bao gồm tên, điểm tin cậy và đối tượng hình chữ nhật có các thuộc tính x, y, w và h. Giá trị x và y biểu thị tọa độ của góc trên cùng bên trái của hộp giới hạn xung quanh logo, trong khi w và h biểu thị chiều rộng và chiều cao của hộp đó — chúng không biểu thị tọa độ của góc dưới cùng bên phải. Để tính góc dưới bên phải, người ta cần tính x + w và y + h, điều mà đoạn mã không thực hiện được; nó chỉ in trực tiếp hình chữ nhật.w và hình chữ nhật.h. Do đó, mã hiển thị chính xác từng tên thương hiệu được phát hiện khi độ tin cậy tối thiểu là 0,75 và hiển thị chính xác tọa độ góc trên cùng bên trái (x, y), nhưng không hiển thị tọa độ góc dưới cùng bên phải.\n\n**Tài liệu tham khảo:**\n[Brand detection - Azure Vision in Foundry Tools](https://learn.microsoft.com/en-us/azure/ai-services/computer-vision/concept-brand-detection)",
    "category": "Implement computer vision solutions",
    "tags": [
      "AI-103",
      "Implement computer vision solutions"
    ],
    "imageUrl": "https://cdn.examcademy.com/images/questions/1785303416283-1vw0fjnu.png",
    "sourceTitle": "Examcademy AI-103 Question 100",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/100-implement-computer-vision-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-101",
    "questionNumber": 101,
    "text": "You are creating a Microsoft Foundry project named Project1 that will contain an agent and use an Azure key vault named KV1. You need to configure a connection from Project1 to KV1. How should you complete the Bicep code?  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1785303415876-cm82wv7p.png)",
    "questionType": "matching_dropdown",
    "statements": [
      {
        "id": "category",
  ...
  },
  {
    ...
    "explanation": "Phần tử âm vị SSML cho phép bạn chỉ định cách phát âm chính xác của một từ bằng cách sử dụng bảng chữ cái phiên âm như IPA hoặc SAPI. Điều này trực tiếp giải quyết việc phát âm sai các thuật ngữ kỹ thuật cụ thể mà không tốn nhiều công sức vì bạn chỉ cần chú thích các từ có vấn đề trong mã đánh dấu SSML thay vì đào tạo lại mô hình. Ngược lại, nói như được dùng để diễn giải các loại nội dung (như ngày tháng hoặc số) thay vì sửa cách phát âm, ngữ điệu điều chỉnh cao độ/tốc độ/âm lượng thay vì phát âm, việc đào tạo giọng nói thần kinh tùy chỉnh yêu cầu nỗ lực thu thập dữ liệu và đào tạo mô hình đáng kể và Whisper là mô hình chuyển lời nói thành văn bản, không áp dụng cho vấn đề phát âm chuyển văn bản thành giọng nói.\n\n**Tài liệu tham khảo:**\n- [Pronunciation with Speech Synthesis Markup Language (SSML) - Speech service - Foundry Tools | Microsoft Learn](https://learn.microsoft.com/en-us/azure/ai-services/speech-service/speech-synthesis-markup-pronunciation)\n- [Phonetic sets for Speech Synthesis Markup Language (SSML) - Microsoft Learn](https://github.com/MicrosoftDocs/azure-ai-docs/blob/main/articles/ai-services/speech-service/speech-ssml-phonetic-sets.md)",
    "category": "Implement text analysis solutions",
    "tags": [
      "AI-103",
      "Implement text analysis solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 104",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/104-implement-text-analysis-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-105",
    "questionNumber": 105,
    "text": "You have an Azure subscription. You need to create a new resource that will generate fictional stories in response to user prompts. The solution must ensure that the resource uses a customer-managed key to protect data.  \n  \nHow should you complete the script?  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1785303417191-ibxgjlsc.png)",
    "questionType": "matching_dropdown",
    "statements": [
      {
        "id": "kind",
  ...
  },
  {
    ...
    "explanation": "Để phát hiện lỗi bằng Azure Custom Vision, trước tiên bạn tạo dự án Custom Vision, chỉ định loại dự án (Phân loại, vì bạn đang xác định xem một thành phần có bị lỗi hay không). Tiếp theo, bạn tải lên hình ảnh đại diện của các thành phần và gắn thẻ chúng (ví dụ: 'bị lỗi' hoặc 'tốt') để dịch vụ gắn nhãn dữ liệu đào tạo. Cuối cùng, bạn huấn luyện mô hình phân loại, mô hình này sử dụng các hình ảnh được gắn thẻ để tìm hiểu các đặc điểm hình ảnh giúp phân biệt các thành phần bị lỗi và không bị lỗi. Ở đây, việc đào tạo phát hiện đối tượng là không cần thiết vì mục tiêu là phân loại tình trạng chung của một thành phần chứ không phải để xác định và định vị nhiều đối tượng riêng biệt hoặc vùng khiếm khuyết trong mỗi hình ảnh.\n\n**Tài liệu tham khảo:**\n[Quickstart: Build an image classification model with the Custom Vision portal](https://learn.microsoft.com/en-us/azure/ai-services/custom-vision-service/getting-started-build-a-classifier) · [What is Custom Vision?](https://learn.microsoft.com/en-us/azure/ai-services/custom-vision-service/overview)",
    "category": "Implement computer vision solutions",
    "tags": [
      "AI-103",
      "Implement computer vision solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 106",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/106-implement-computer-vision-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-107",
    "questionNumber": 107,
    "text": "You are building a new sales system that will process user-generated video and text submitted through a public-facing website.  \n  \nYou plan to notify users that their data has been processed by the sales system.  \n  \nWhich responsible AI principle does this help satisfy?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
  ...
  },
  {
    ...
    "sourceTitle": "Examcademy AI-103 Question 109",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/109-plan-and-manage-an-azure-ai-solution",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-110",
    "questionNumber": 110,
    "text": "You have a web app that uses Azure AI Search.  \n  \nWhile reviewing activity, you notice greater than expected search query volumes and suspect that the query key has been compromised.  \n  \nYou need to prevent unauthorized access to the search endpoint while ensuring that users retain read-only access to the documents collection. The solution must minimize app downtime.  \n  \nWhich three actions should you perform, in sequence? Move the appropriate actions from the list into the answer area and arrange them in the correct order.",
    "questionType": "matching_drag_drop",
    "statements": [
      {
        "id": "1",
  ...
  },
  {
    ...
    "statements": [
      ...
      {
        "id": "approval_checkpoints",
        "text": "Approval checkpoints:",
        "correctAnswer": "F",
        "choiceKeys": [
          "D",
          "E",
    ...
    "correctAnswers": [
      "orchestration_pattern=A",
      "approval_checkpoints=F"
    ],
    "explanation": "Quy trình làm việc tuần tự của Foundry chuyển kết quả của từng tác nhân sang kết quả tiếp theo theo thứ tự xác định, giúp cho quy trình PolicyWriter-to-RiskReviewer có thể dự đoán được. Nút Hỏi câu hỏi chờ thông tin đầu vào của người dùng, do đó, nút này có thể đóng vai trò là điểm kiểm tra phê duyệt đối với các bản cập nhật có rủi ro cao trong khi các bản cập nhật có rủi ro thấp được tiến hành tự động.\n\n**Tài liệu tham khảo:**\n[Build a workflow in Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/agents/concepts/workflow)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 111",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/111-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-112",
    "questionNumber": 112,
    "text": "You have a Python application that redacts sensitive information before sending prompt text to a language model. The application contains the following code:  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1785303422561-llcsxkxd.png)  \n  \nFor each of the following statements, select Yes if the statement is true. Otherwise, select No.",
    "questionType": "statement_matrix",
    "statements": [
      {
        "id": "1",
  ...
  },
  {
    ...
    "statements": [
      ...
      {
        "id": "recall",
        "text": "The value for the number of true positives divided by the total number of true positives and false negatives is:",
        "correctAnswer": "B",
        "choiceKeys": [
          "A",
          "B",
    ...
    "explanation": "Độ chính xác được định nghĩa là TP/(TP+FP). Triển lãm cho thấy Độ chính xác = 100,0%, điều này chỉ có thể thực hiện được khi FP = 0, do đó tỷ lệ dương tính giả là 0%. Việc thu hồi được xác định là TP/(TP+FN) và biểu đồ hiển thị Tỷ lệ thu hồi = 25,0%, khớp chính xác với tỷ lệ được mô tả là dương tính thật chia cho tổng số dương tính thật và âm tính giả.\n\n**Tài liệu tham khảo:**\n[Evaluate and improve a model - Custom Vision](https://learn.microsoft.com/en-us/azure/ai-services/custom-vision-service/getting-started-improving-your-classifier)",
    "category": "Implement computer vision solutions",
    "tags": [
      "AI-103",
      "Implement computer vision solutions"
    ],
    "imageUrl": "https://cdn.examcademy.com/images/questions/1785304946291-8i612741.png",
    "sourceTitle": "Examcademy AI-103 Question 117",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/117-implement-computer-vision-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-118",
    "questionNumber": 118,
    "text": "You have a Microsoft Foundry project for a support ticket triage app that reads ticket text from a database.  \n  \nYou need to ensure that the app meets the following requirements:  \n  \n- Compares candidate models by quality, cost, and throughput  \n- Prevents hosting model weights in the Azure subscription  \n  \nWhat should you configure?",
    "questionType": "matching_dropdown",
    "statements": [
      {
        "id": "model_evaluation",
    ...
    "explanation": "Mô hình Microsoft Foundry xếp hạng các mô hình điểm chuẩn theo chất lượng, chi phí và thông lượng, cho phép so sánh mô hình ứng viên. Triển khai serverless cung cấp quyền truy cập API vào các mô hình do Microsoft lưu trữ và quản lý, thay vì triển khai trọng số mô hình để tính toán trong đăng ký Azure.\n\n**Tài liệu tham khảo:**\n[Model benchmarks and leaderboards in Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry/concepts/model-benchmarks) · [Microsoft Foundry Models overview](https://learn.microsoft.com/en-us/azure/foundry/concepts/foundry-models-overview)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 118",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/118-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-119",
    ...
    "correctAnswers": [
      "extract_text=C",
      "sentiment_analysis=E"
    ],
    "explanation": "Azure Document Intelligence trích xuất văn bản từ tài liệu PDF thông qua khả năng phân tích tài liệu và OCR. Ngôn ngữ Azure cung cấp phân tích cảm xúc cho văn bản, xác định cảm xúc tích cực, tiêu cực, trung tính và hỗn hợp.\n\n**Tài liệu tham khảo:**\n[Azure AI Document Intelligence documentation](https://learn.microsoft.com/en-us/azure/ai-services/document-intelligence/) · [Sentiment analysis and opinion mining](https://learn.microsoft.com/en-us/azure/ai-services/language-service/sentiment-opinion-mining/overview)",
    "category": "Implement information extraction solutions",
    "tags": [
      "AI-103",
      "Implement information extraction solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 119",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/119-implement-information-extraction-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-120",
    "questionNumber": 120,
    "text": "You are creating a Custom Vision model to deploy as part of an iOS app.  \n  \nYou have cat and dog images, and each image contains either a cat or a dog.  \n  \nYou need to use Azure Custom Vision to determine whether an image shows a cat or a dog.  \n  \nHow should you configure the project in the Azure Custom Vision portal?",
    "questionType": "matching_dropdown",
    "statements": [
      {
        "id": "project_types",
    ...
    "correctAnswers": [
      "project_types=A",
      "classification_types=C",
      "domains=H"
    ],
    "explanation": "Phân loại gán nhãn cho toàn bộ hình ảnh, phù hợp với hình ảnh chứa chính xác một con mèo hoặc một con chó. Trình phân loại nhiều lớp phù hợp khi mỗi hình ảnh có chính xác một thẻ. Miền chung nhỏ gọn nhằm mục đích xuất sang thiết bị di động và thiết bị biên, hỗ trợ triển khai trong ứng dụng iOS.\n\n**Tài liệu tham khảo:**\n[Microsoft Learn: Build a classifier with Custom Vision](https://learn.microsoft.com/en-us/azure/ai-services/custom-vision-service/getting-started-build-a-classifier) · [Microsoft Learn: Custom Vision domains](https://learn.microsoft.com/en-us/azure/ai-services/custom-vision-service/select-domain)",
    "category": "Implement computer vision solutions",
    "tags": [
      "AI-103",
      "Implement computer vision solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 120",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/120-implement-computer-vision-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-121",
    "questionNumber": 121,
    "text": "You are developing an Azure solution that will use Azure Language in Foundry Tools to process sensitive customer data.  \n  \nYou must ensure that only specified Azure processes can access the Language service while minimizing administrative effort.  \n  \nWhat should you include in the solution?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
  ...
  },
  {
    ...
    "explanation": "`tool_choice` là điều khiển cấp độ chạy xác định để yêu cầu lệnh gọi công cụ cụ thể. Setting it in `create_and_process()` to select `kbsearch` prevents the default automatic model decision from bypassing the knowledge-base tool, so responses are grounded in its results.\n\n**Tài liệu tham khảo:**\n[What are tools in Foundry Agent Service (classic)](https://learn.microsoft.com/en-za/azure/ai-foundry/agents/how-to/tools/overview?view=foundry-classic)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "imageUrl": "https://cdn.examcademy.com/images/questions/1786767511858-jnet4i48.png",
    "sourceTitle": "Examcademy AI-103 Question 122",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/122-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-123",
    ...
    "explanation": "GET /status xác thực khóa API khởi động mà không thực hiện truy vấn điểm cuối, vì vậy câu lệnh đầu tiên là sai. Nhà cung cấp ghi nhật ký No hoặc giá đỡ đầu ra được định cấu hình; ghi nhật ký đĩa yêu cầu cả cấu hình và giá trị đầu ra, vì vậy câu lệnh thứ hai là sai. Điểm cuối /swagger cung cấp tài liệu cho các điểm cuối vùng chứa, vì vậy câu lệnh thứ ba là đúng.\n\n**Tài liệu tham khảo:**\n[Install and run Docker containers for Sentiment Analysis - Microsoft Learn](https://learn.microsoft.com/en-us/azure/ai-services/language-service/sentiment-opinion-mining/how-to/use-containers) · [Configure containers - Language service - Microsoft Learn](https://learn.microsoft.com/en-us/azure/ai-services/language-service/concepts/configure-containers)",
    "category": "Implement text analysis solutions",
    "tags": [
      "AI-103",
      "Implement text analysis solutions"
    ],
    "imageUrl": "https://cdn.examcademy.com/images/questions/1786767512062-v1ye8uok.png",
    "sourceTitle": "Examcademy AI-103 Question 123",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/123-implement-text-analysis-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-124",
    "questionNumber": 124,
    "text": "You are developing an app that will give users definitions of common AI terms.  \n  \nYou create the following Python code.  \n  \n![Question Image](https://cdn.examcademy.com/images/questions/1786767513061-wlqjq4bh.png)  \n  \nFor each of the following statements, select Yes if the statement is true. Otherwise, select No.",
    "questionType": "statement_matrix",
    "statements": [
      {
        "id": "1",
  ...
  },
  {
    ...
    "explanation": "Các mô hình nhúng Azure OpenAI tạo ra các biểu diễn vectơ số của văn bản và độ tương tự khoảng cách hoặc cosin giữa các vectơ đó tương quan với độ tương tự về ngữ nghĩa của tài liệu nguồn. Điều này cung cấp khả năng so sánh tài liệu cần thiết mà không cần xây dựng mô hình biểu diễn tùy chỉnh.\n\n**Tài liệu tham khảo:**\n[Understand embeddings in Azure OpenAI in Microsoft Foundry Models](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/concepts/understand-embeddings)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 126",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/126-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-127",
    "questionNumber": 127,
    "text": "You are developing an app that will use the Azure Vision in Foundry Tools API to analyze an image.  \n  \nYou need to configure the request used by the app to determine whether an image is clipart or a line drawing.  \n  \nHow should you complete the request?",
    "questionType": "matching_dropdown",
    "statements": [
      {
        "id": "method",
    ...
    "explanation": "Hoạt động REST hình ảnh phân tích v3.2 được gọi bằng POST. Việc chọn tính năng hình ảnh ImageType sẽ trả về các phân loại clipart và đường vẽ.\n\n**Tài liệu tham khảo:**\n[Analyze Image - REST API (Computer Vision v3.2)](https://learn.microsoft.com/en-us/rest/api/computervision/analyze-image/analyze-image?view=rest-computervision-v3.2)",
    "category": "Implement computer vision solutions",
    "tags": [
      "AI-103",
      "Implement computer vision solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 127",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/127-implement-computer-vision-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-128",
    "questionNumber": 128,
    "text": "You are building an app that will use the Speech and Language APIs.  \n  \nYou need to provision resources for the app. The solution must ensure that each service is accessed through a single endpoint and credential.  \n  \nWhich resource type should you create?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Dịch vụ Microsoft Foundry là tài nguyên đa dịch vụ bao gồm cả Ngôn ngữ và Lời nói. Nó cho phép các dịch vụ đó sử dụng điểm cuối và thông tin xác thực được chia sẻ, không giống như các tài nguyên Ngôn ngữ hoặc Ngôn ngữ dành cho một dịch vụ. Microsoft liệt kê Ngôn ngữ và Lời nói trong số các dịch vụ đi kèm với tài nguyên Foundry.\n\n**Tài liệu tham khảo:**\n[Create a Foundry resource](https://learn.microsoft.com/en-us/azure/ai-services/multi-service-resource?tabs=speech)",
    "category": "Plan and manage an Azure AI solution",
    "tags": [
      "AI-103",
      "Plan and manage an Azure AI solution"
    ],
    "sourceTitle": "Examcademy AI-103 Question 128",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/128-plan-and-manage-an-azure-ai-solution",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-129",
    "questionNumber": 129,
    "text": "An Azure subscription contains a Microsoft Foundry Service resource named CSAccount1 and a virtual network named VNet1. CSAaccount1 is connected to VNet1.  \n  \nYou need to ensure that only specified resources can access CSAccount1. The solution must satisfy these requirements:  \n  \n- Prevent external access to CSAccount1.  \n- Minimize administrative effort.  \n  \nWhich two actions should you take? Each correct answer is part of the solution.  \n  \nNOTE: Each correct answer is worth one point.",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
  ...
  },
  {
    ...
    "explanation": "Azure Custom Vision tính toán và hiển thị độ chính xác cũng như thu hồi cho bộ phân loại hình ảnh đã được đào tạo. Độ chính xác đo lường tỷ lệ phân loại được dự đoán là chính xác, trong khi thu hồi đo tỷ lệ phân loại thực tế được xác định chính xác.\n\n**Tài liệu tham khảo:**\n[Quickstart: Build an image classification model with the Custom Vision portal](https://learn.microsoft.com/en-us/azure/ai-services/custom-vision-service/getting-started-build-a-classifier)",
    "category": "Implement computer vision solutions",
    "tags": [
      "AI-103",
      "Implement computer vision solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 130",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/130-implement-computer-vision-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-131",
    "questionNumber": 131,
    "text": "You are developing an app that will contain one million scanned magazine articles. Each article will be saved as an image file.  \n  \nYou need to configure the app to extract text from those images. The solution must minimize development effort.  \n  \nWhat should you include in the solution?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Hướng dẫn OCR của riêng Microsoft vạch ra ranh giới trực tiếp giữa loại đầu vào và dịch vụ được đề xuất: các hình ảnh chung, thực tế như nhãn, biển báo và áp phích nên sử dụng API Azure Vision Read OCR, trong khi các tài liệu kỹ thuật số và văn bản được quét như sách, bài viết và báo cáo nên sử dụng mô hình Document Intelligence Read, được xây dựng có mục đích và tối ưu hóa để tự động hóa quá trình xử lý tài liệu thông minh trên quy mô lớn với API không đồng bộ. Một triệu bài báo trên tạp chí được quét chính xác là kịch bản có quy mô tài liệu, nặng văn bản mà Document Intelligence nhắm đến và việc sử dụng mô hình Đọc dựng sẵn của nó chỉ yêu cầu gọi API được quản lý thay vì xây dựng logic quy trình OCR tùy chỉnh, giúp giảm thiểu nỗ lực phát triển so với các API hình ảnh cấp thấp hơn.\n\n**Tài liệu tham khảo:**\n- [OCR - Optical Character Recognition - Foundry Tools | Microsoft Learn](https://learn.microsoft.com/en-us/azure/ai-services/computer-vision/overview-ocr)\n- [Document Intelligence read model - Microsoft Learn](https://learn.microsoft.com/en-us/azure/ai-services/document-intelligence/prebuilt/read)",
    "category": "Implement computer vision solutions",
    "tags": [
      "AI-103",
      "Implement computer vision solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 131",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/131-implement-computer-vision-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-132",
    "questionNumber": 132,
    "text": "You are developing an app that scans confidential documents and uses the Azure Language in Foundry Tools service to analyze their contents.  \n  \nYou provision a Microsoft Foundry Service resource.  \n  \nEnsure that the app can make requests to the Azure Language in Foundry Tools service endpoint while confidential documents remain on-premises.  \n  \nWhich three actions should you perform, in sequence?",
    "questionType": "matching_drag_drop",
    "statements": [
      {
        "id": "1",
  ...
  },
  {
    ...
    "explanation": "Máy khách SDK Azure OpenAI cần điểm cuối tài nguyên Azure OpenAI và khóa API để xác thực khóa API. Yêu cầu cũng phải chỉ định tên triển khai Azure OpenAI; SDK sử dụng tên triển khai đó làm mã định danh mô hình, thay vì tên mô hình hoặc loại mô hình cơ bản.\n\n**Tài liệu tham khảo:**\n[How to use vision-enabled chat models - Microsoft Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/gpt-v-quickstart?pivots=rest-api&source=recommendations&tabs=image%2Ccommand-line)\n\n**Tài liệu tham khảo:**\n- [How to use vision-enabled chat models - Microsoft Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/gpt-v-quickstart?pivots=rest-api&source=recommendations&tabs=image%2Ccommand-line)",
    "category": "Implement generative AI and agentic solutions",
    "tags": [
      "AI-103",
      "Implement generative AI and agentic solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 133",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/133-implement-generative-ai-and-agentic-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-134",
    "questionNumber": 134,
    "text": "You are designing an Azure AI solution to detect defective products on a production line.  \n  \nYou have a real-time video feed and an image library of sample products that were manually approved or rejected.  \n  \nYou need to recommend a service that fulfills the following requirements:  \n  \n- Monitors the video feed and detects defective products.  \n- Can train a new model by using the image library.  \n- Minimizes development effort.  \n  \nWhat should you recommend?",
    "questionType": "multiple_choice",
    "options": [
      {
        "key": "A",
    ...
    "explanation": "Azure AI Custom Vision hỗ trợ đào tạo các mô hình phân loại hình ảnh và phát hiện đối tượng tùy chỉnh từ các hình ảnh được gắn nhãn, sau đó triển khai mô hình đã đào tạo để dự đoán. A production-line video feed can be evaluated by submitting frames to that custom model, while the managed training and prediction service minimizes implementation effort compared with building a model in Azure Machine Learning.\n\n**Tài liệu tham khảo:**\n[What is Custom Vision? - Foundry Tools | Microsoft Learn](https://learn.microsoft.com/en-us/azure/ai-services/custom-vision-service/overview) · [Quickstart: Build an object detector with the Custom Vision website - Foundry Tools | Microsoft Learn](https://learn.microsoft.com/en-us/azure/ai-services/custom-vision-service/get-started-build-detector)",
    "category": "Implement computer vision solutions",
    "tags": [
      "AI-103",
      "Implement computer vision solutions"
    ],
    "sourceTitle": "Examcademy AI-103 Question 134",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/134-implement-computer-vision-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  },
  {
    "id": "ai103-135",
    ...
    "explanation": "Liên kết thực thể xác định và phân biệt các thực thể và cung cấp URL cho mục nhập cơ sở kiến ​​thức, thường là Wikipedia; nó không phải là một hoạt động phát hiện ngôn ngữ tài liệu. Thực thể được liên kết có thể bao gồm ID tìm kiếm thực thể Bing nhưng `url` của nó là URL trang thực thể chứ không phải liên kết kết quả tìm kiếm Bing. Bộ sưu tập `matches` chứa mỗi lần xuất hiện của thực thể, với các giá trị độ lệch và độ dài xác định vị trí của nó trong tài liệu.\n\n**Tài liệu tham khảo:**\n[Entity linking quickstart — Microsoft Learn](https://learn.microsoft.com/en-us/azure/ai-services/language-service/entity-linking/quickstart) · [LinkedEntityMatch class — Azure SDK for Python](https://learn.microsoft.com/en-us/python/api/azure-ai-textanalytics/azure.ai.textanalytics.linkedentitymatch?view=azure-python)",
    "category": "Implement text analysis solutions",
    "tags": [
      "AI-103",
      "Implement text analysis solutions"
    ],
    "imageUrl": "https://cdn.examcademy.com/images/questions/1787531559190-u9sg14qy.png",
    "sourceTitle": "Examcademy AI-103 Question 135",
    "sourceUrl": "https://examcademy.com/exams/microsoft/ai-103/q/135-implement-text-analysis-solutions",
    "lastVerifiedAt": "2026-09-13T09:26:37.359Z"
  }
];
