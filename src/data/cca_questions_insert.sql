...
(
  ...
  'Architecture & Optimization', ARRAY['Prompt Caching', 'API Design', 'Optimization']::text[],
  '/assets/cca_q61.jpg'
) ON CONFLICT (id) DO NOTHING;
...
(
  ...
  'Model Context Protocol', ARRAY['MCP Architecture', 'JSON-RPC', 'Tool Invocation']::text[],
  '/assets/cca_q62.jpg'
) ON CONFLICT (id) DO NOTHING;
...
(
  ...
  'Agent Architecture', ARRAY['Multi-Agent', 'Orchestrator Pattern', 'Workflows']::text[],
  '/assets/cca_q63.jpg'
) ON CONFLICT (id) DO NOTHING;
...
(
  ...
  'Evaluation & Bias', ARRAY['Guardrails', 'AI Safety', 'Compliance']::text[],
  '/assets/cca_q64.jpg'
) ON CONFLICT (id) DO NOTHING;
...
(
  ...
  'Architecture & Optimization', ARRAY['RAG', 'Hybrid Search', 'Reranker', 'Claude Context']::text[],
  '/assets/cca_q65.jpg'
) ON CONFLICT (id) DO NOTHING;
